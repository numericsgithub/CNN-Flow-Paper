...
entity conv5_core9_rmcm_weightsconstant_memory is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv5_core9_rmcm_weightsconstant_memory;

architecture Behavioral of conv5_core9_rmcm_weightsconstant_memory is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of conv5_core9_rmcm_weightsconstant_memory : entity is "yes";

    signal rom_data_out_signal : std_logic_vector((XI_WIDTH * WORDS_PER_ADDR)-1 downto 0);

begin

    ROM_BLOCK: entity conv5_core9_rmcm_weightsconstant_memoryROM generic map
    (
        XI_WIDTH        	=> XI_WIDTH,
