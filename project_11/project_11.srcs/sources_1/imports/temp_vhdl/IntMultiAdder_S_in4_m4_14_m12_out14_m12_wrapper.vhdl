...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=950 name=entity_place_holder_name IntMultiAdder signedIn=True n=2 wIn=26 wOut=26

entity IntMultiAdder_S_in4_m4_14_m12_out14_m12_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(26-1 downto 0); --	sfix(14, -12)
        xi_2 : in std_logic_vector(26-1 downto 0); --	sfix(14, -12)
        yo  : out std_logic_vector(26-1 downto 0) --	sfix(14, -12)
    );
end IntMultiAdder_S_in4_m4_14_m12_out14_m12_wrapper;

architecture Behavioral of IntMultiAdder_S_in4_m4_14_m12_out14_m12_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_1_PL              is array(0 to 1) of std_logic_vector(26-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_2_PL              is array(0 to 1) of std_logic_vector(26-1 downto 0);
    type PIPELINE_TYPE_FOR_YO_PL                is array(0 to 1) of std_logic_vector(26-1 downto 0);
    ...
    signal yo_flopoco : std_logic_vector(26-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in4_m4_14_m12_out14_m12
        port map
        (
