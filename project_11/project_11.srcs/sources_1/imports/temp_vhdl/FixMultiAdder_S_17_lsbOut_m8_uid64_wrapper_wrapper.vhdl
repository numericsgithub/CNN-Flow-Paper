...
entity FixMultiAdder_S_17_lsbOut_m8_uid64_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_2 : in std_logic_vector(14-1 downto 0); --	sfix(6, -8)
        xi_3 : in std_logic_vector(15-1 downto 0); --	sfix(7, -8)
...
end FixMultiAdder_S_17_lsbOut_m8_uid64_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m8_uid64_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m8_uid64_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(19-1 downto 0); --	sfix(11, -8)
    signal xi_1_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(6, -8)
    signal xi_2_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(6, -8)
    signal xi_3_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(7, -8)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m8_uid64_wrapper
        generic map
        (
        ...
        (
            ...
            xi_2_reshaped, --	sfix(6, -8)
            xi_3_reshaped, --	sfix(7, -8)
