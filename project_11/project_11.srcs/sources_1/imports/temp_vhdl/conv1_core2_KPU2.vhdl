...
END conv1_core2_KPU2;

ARCHITECTURE structural OF conv1_core2_KPU2 IS

    -- All all_additional_output_int_bits are:         [0, 2, 1, 1, 1, 1, 1, 1, 1]
    -- All all_additional_output_int_bits_weights are: [[-11.0], [-9.0], [2.0], [-1.0], [-4.0], [-2.0], [-1.0], [-2.0], [0.0]]
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in1_m12_1_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU2_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_3: entity work.IntMultiAdder_S_inm1_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU2_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_4: entity work.IntMultiAdder_S_inm3_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU2_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_5: entity work.IntMultiAdder_S_inm1_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU2_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_6: entity work.IntMultiAdder_S_inm2_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU2_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_7: entity work.IntMultiAdder_S_inm3_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU2_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_inm2_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU2_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    last_stage: entity work.IntMultiAdder_S_in1_m12_3_m12_out3_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core2_KPU2_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
