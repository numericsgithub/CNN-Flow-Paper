...
entity IntMultiAdder_S_in3_m10_6_m10_out7_m10_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in3_m10_6_m10_out7_m10_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in3_m10_6_m10_out7_m10_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in3_m10_6_m10_out7_m10_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(17-1 downto 0); --	sfix(7, -10)
    signal xi_1_reshaped :  std_logic_vector(16-1 downto 0); --	sfix(6, -10)
    signal xi_2_reshaped :  std_logic_vector(16-1 downto 0); --	sfix(6, -10)
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in3_m10_6_m10_out7_m10_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(6, -10)
            xi_2_reshaped, --	sfix(6, -10)
            yo_signal
        );
