...
END conv1_core1_KPU19;

ARCHITECTURE structural OF conv1_core1_KPU19 IS

    -- All all_additional_output_int_bits are:         [0, 2, 4, 4, 5, 5, 5, 4, 4]
    -- All all_additional_output_int_bits_weights are: [[-31.0], [-35.0], [-35.0], [-44.0], [-46.0], [-35.0], [-36.0], [-36.0], [-24.0]]
    ...
    -- Unreshaped Adder would be: sfix(3, -12) + sfix(2, -12) = sfix(4, -12)
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in3_m12_2_m12_out4_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU19_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_2_input_xi, adder_2_input_sum, small_undelayed_out_2);
	adder_2_output <= small_delayed_in_2;

    line_adder_3: entity work.IntMultiAdder_S_in3_m12_4_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU19_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_4: entity work.IntMultiAdder_S_in3_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU19_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_5: entity work.IntMultiAdder_S_in3_m12_6_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU19_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_6: entity work.IntMultiAdder_S_in3_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU19_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_7: entity work.IntMultiAdder_S_in3_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU19_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_in3_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU19_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    last_stage: entity work.IntMultiAdder_S_in2_m12_7_m12_out7_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core1_KPU19_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
