...
entity IntMultiAdder_S_in5_m10_5_m10_out5_m10_wrapper is
    generic
    (
    ...
    Port (
        ...
        yo  : out std_logic_vector(15-1 downto 0) --	sfix(5, -10)
    );
end IntMultiAdder_S_in5_m10_5_m10_out5_m10_wrapper;

architecture Behavioral of IntMultiAdder_S_in5_m10_5_m10_out5_m10_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in5_m10_5_m10_out5_m10
        port map
        (
            clk, rst, 
            yo_flopoco , 
