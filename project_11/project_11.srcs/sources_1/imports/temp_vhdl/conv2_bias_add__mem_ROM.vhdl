...
entity conv2_bias_add_constant_memoryROM is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv2_bias_add_constant_memoryROM;

architecture Behavioral of conv2_bias_add_constant_memoryROM is
	...
	constant data_ROM : ROM_TYPE := (
	    ...
	    0 => w(-19,7,9,-7,27,16,8,-41),
	    1 => w(-14,-13,-15,67,39,-9,-4,35),
	    2 => w(1,96,14,8,-12,75,-16,27),
	    3 => w(9,30,108,-15,44,10,-15,68)
        );
