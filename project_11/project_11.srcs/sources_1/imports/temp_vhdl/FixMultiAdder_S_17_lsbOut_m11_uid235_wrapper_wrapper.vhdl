...
entity FixMultiAdder_S_17_lsbOut_m11_uid235_wrapper_wrapper is
    generic
    (
...
end FixMultiAdder_S_17_lsbOut_m11_uid235_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m11_uid235_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m11_uid235_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(19-1 downto 0); --	sfix(8, -11)
    signal xi_1_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(2, -11)
    signal xi_2_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    ...
    signal xi_6_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(2, -11)
    ...
    signal xi_9_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(2, -11)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m11_uid235_wrapper
        generic map
        (
