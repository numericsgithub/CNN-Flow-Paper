...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=950 name=entity_place_holder_name IntMultiAdder signedIn=True n=2 wIn=20 wOut=21

entity IntMultiAdder_S_in1_m15_5_m15_out6_m15_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(20-1 downto 0); --	sfix(5, -15)
        xi_2 : in std_logic_vector(20-1 downto 0); --	sfix(5, -15)
        yo  : out std_logic_vector(21-1 downto 0) --	sfix(6, -15)
    );
end IntMultiAdder_S_in1_m15_5_m15_out6_m15_wrapper;

architecture Behavioral of IntMultiAdder_S_in1_m15_5_m15_out6_m15_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_1_PL              is array(0 to 1) of std_logic_vector(20-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_2_PL              is array(0 to 1) of std_logic_vector(20-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in1_m15_5_m15_out6_m15
        port map
        (
            clk, rst, 
            yo_flopoco , 
