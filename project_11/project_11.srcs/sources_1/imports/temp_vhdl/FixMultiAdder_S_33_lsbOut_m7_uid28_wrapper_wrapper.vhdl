...
entity FixMultiAdder_S_33_lsbOut_m7_uid28_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_33 : in std_logic_vector(18-1 downto 0); --	sfix(11, -7)
        yo : out std_logic_vector(18-1 downto 0) --	sfix(11, -7)
    );
end FixMultiAdder_S_33_lsbOut_m7_uid28_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid28_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m7_uid28_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(18-1 downto 0); --	sfix(11, -7)
    ...
    signal xi_16_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(8, -7)
    signal xi_17_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    signal xi_18_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    signal xi_19_reshaped :  std_logic_vector(9-1 downto 0); --	sfix(2, -7)
    ...
    signal xi_30_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    ...
    signal xi_33_reshaped :  std_logic_vector(18-1 downto 0); --	sfix(11, -7)
    ...
    subtype DEBUG_TYPE is std_logic_vector(22 downto 0);
    constant allowed_min : integer := -131072;
    constant allowed_max : integer := 131071;
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m7_uid28_wrapper
        generic map
        (
        ...
        (
            ...
            xi_16_reshaped, --	sfix(8, -7)
            xi_17_reshaped, --	sfix(4, -7)
            xi_18_reshaped, --	sfix(3, -7)
            xi_19_reshaped, --	sfix(2, -7)
            ...
            xi_30_reshaped, --	sfix(4, -7)
            xi_31_reshaped, --	sfix(1, -7)
            xi_32_reshaped, --	sfix(6, -7)
            xi_33_reshaped, --	sfix(11, -7)
            yo_signal
        );
