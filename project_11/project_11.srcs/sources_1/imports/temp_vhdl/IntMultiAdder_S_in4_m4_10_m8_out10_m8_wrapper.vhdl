...
entity IntMultiAdder_S_in4_m4_10_m8_out10_m8_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(18-1 downto 0); --	sfix(10, -8)
        xi_2 : in std_logic_vector(18-1 downto 0); --	sfix(10, -8)
        yo  : out std_logic_vector(18-1 downto 0) --	sfix(10, -8)
    );
end IntMultiAdder_S_in4_m4_10_m8_out10_m8_wrapper;

architecture Behavioral of IntMultiAdder_S_in4_m4_10_m8_out10_m8_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in4_m4_10_m8_out10_m8
        port map
        (
            clk, rst, 
            yo_flopoco , 
