...
END conv6_core8_KPU1;

ARCHITECTURE structural OF conv6_core8_KPU1 IS

    -- All all_additional_output_int_bits are:         [0, 2, 4, 4, 4, 3, 3, 3, 3]
    -- All all_additional_output_int_bits_weights are: [[-7.0, -5.0, -1.0, 7.0, 21.0, -5.0, 3.0, 7.0, -7.0, -17.0, 9.0, -2.0, -4.0, -5.0, -7.0, 37.0], [-10.0, 2.0, -32.0, -48.0, 71.0, -14.0, -13.0, 20.0, -9.0, -10.0, 9.0, 0.0, -6.0, -7.0, 23.0, 98.0], [5.0, 5.0, 2.0, 28.0, -8.0, -2.0, 4.0, -3.0, -8.0, -9.0, -5.0, 6.0, 5.0, -1.0, -21.0, 1.0], [-5.0, -5.0, 1.0, -33.0, -27.0, -7.0, -17.0, -5.0, -11.0, 17.0, 29.0, -3.0, -5.0, -23.0, -45.0, -55.0], [-5.0, -5.0, 39.0, -73.0, -38.0, 63.0, 53.0, 20.0, 35.0, 20.0, 0.0, -12.0, -2.0, -6.0, 24.0, -71.0], [2.0, 38.0, 0.0, 65.0, -17.0, -21.0, -20.0, -1.0, 4.0, -8.0, -21.0, 3.0, -9.0, 5.0, 36.0, -24.0], [0.0, -4.0, -1.0, 4.0, -13.0, -7.0, 0.0, -21.0, -8.0, 12.0, -4.0, -1.0, 2.0, -1.0, 8.0, 10.0], [-2.0, -11.0, -6.0, 8.0, 3.0, 11.0, -1.0, -14.0, 5.0, 14.0, -16.0, -2.0, -3.0, 2.0, -17.0, 6.0], [3.0, -5.0, -2.0, 45.0, 2.0, -9.0, -2.0, -7.0, 2.0, -8.0, 7.0, 2.0, 1.0, 3.0, 0.0, 13.0]]
    ...
    -- Unreshaped Adder would be: sfix(5, -8) + sfix(8, -8) = sfix(10, -8)
    -- Reshaped Adder would be:   sfix(8, -8) + sfix(8, -8) = sfix(10, -8)
    -- 
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in7_m8_6_m8_out8_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv6_core8_KPU1_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_2_input_xi, adder_2_input_sum, small_undelayed_out_2);
	adder_2_output <= small_delayed_in_2;

    line_adder_3: entity work.IntMultiAdder_S_in5_m8_8_m8_out10_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv6_core8_KPU1_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_4: entity work.IntMultiAdder_S_in6_m8_10_m8_out10_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv6_core8_KPU1_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_5: entity work.IntMultiAdder_S_in7_m8_10_m8_out10_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv6_core8_KPU1_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_5_input_xi, adder_5_input_sum, small_undelayed_out_4);
	adder_5_output <= small_delayed_in_4;

    line_adder_6: entity work.IntMultiAdder_S_in7_m8_10_m8_out10_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv6_core8_KPU1_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_7: entity work.IntMultiAdder_S_in5_m8_10_m8_out10_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv6_core8_KPU1_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_in5_m8_10_m8_out10_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv6_core8_KPU1_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    last_stage: entity work.IntMultiAdder_S_in6_m8_10_m8_out10_m8_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv6_core8_KPU1_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
