...
entity FixMultiAdder_S_33_lsbOut_m7_uid48_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_3 : in std_logic_vector(10-1 downto 0); --	sfix(3, -7)
        xi_4 : in std_logic_vector(8-1 downto 0); --	sfix(1, -7)
        xi_5 : in std_logic_vector(15-1 downto 0); --	sfix(8, -7)
...
end FixMultiAdder_S_33_lsbOut_m7_uid48_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid48_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m7_uid48_wrapper_wrapper : entity is "yes";
    ...
    signal xi_3_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    signal xi_4_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(1, -7)
    signal xi_5_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(8, -7)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m7_uid48_wrapper
        generic map
        (
        ...
        (
            ...
            xi_3_reshaped, --	sfix(3, -7)
            xi_4_reshaped, --	sfix(1, -7)
            xi_5_reshaped, --	sfix(8, -7)
