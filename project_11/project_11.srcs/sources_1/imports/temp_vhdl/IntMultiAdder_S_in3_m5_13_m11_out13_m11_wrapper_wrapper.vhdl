...
entity IntMultiAdder_S_in3_m5_13_m11_out13_m11_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        rst    : in std_logic;
        enable : in std_logic;
        xi_1 : in std_logic_vector(8-1 downto 0); --	sfix(3, -5)
        xi_2 : in std_logic_vector(24-1 downto 0); --	sfix(13, -11)
        yo : out std_logic_vector(24-1 downto 0) --	sfix(13, -11)
    );
end IntMultiAdder_S_in3_m5_13_m11_out13_m11_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in3_m5_13_m11_out13_m11_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in3_m5_13_m11_out13_m11_wrapper_wrapper : entity is "yes";
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in3_m5_13_m11_out13_m11_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(13, -11)
            xi_2_reshaped, --	sfix(13, -11)
            yo_signal
        );
