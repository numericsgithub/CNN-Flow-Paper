...
package conv2_settings is
    constant AMOUNT_OF_UNITS_PER_CORE : NATURAL := 1; -- Amount of KPUs/PPUs/FCUs per core
    constant AMOUNT_OF_UNITS_IN_LAYER : NATURAL := 8; -- Total amount of KPUs/PPUs/FCUs
    constant AMOUNT_OF_LAYER_INPUTS   : NATURAL := 8; -- Amount of input signals
    constant AMOUNT_OF_LAYER_OUTPUTS  : NATURAL := 8; -- Amount of output signals
