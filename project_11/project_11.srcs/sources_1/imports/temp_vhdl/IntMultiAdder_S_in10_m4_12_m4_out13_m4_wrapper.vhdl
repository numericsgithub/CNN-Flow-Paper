...
entity IntMultiAdder_S_in10_m4_12_m4_out13_m4_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(16-1 downto 0); --	sfix(12, -4)
        xi_2 : in std_logic_vector(16-1 downto 0); --	sfix(12, -4)
        yo  : out std_logic_vector(17-1 downto 0) --	sfix(13, -4)
    );
end IntMultiAdder_S_in10_m4_12_m4_out13_m4_wrapper;

architecture Behavioral of IntMultiAdder_S_in10_m4_12_m4_out13_m4_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in10_m4_12_m4_out13_m4
        port map
        (
            clk, rst, 
            yo_flopoco , 
