...
ENTITY conv2_core2_KPU1 IS
	...
	PORT (
        ...
        kpu_xi_7 : in std_logic_vector(12-1 downto 0); --	sfix(8, -4)
...
END conv2_core2_KPU1;

ARCHITECTURE structural OF conv2_core2_KPU1 IS

    -- All all_additional_output_int_bits are:         [0, 2, 3, 3, 2, 2, 2, 2, 2]
    -- All all_additional_output_int_bits_weights are: [[2.0, 79.0, 0.0, 0.0], [3.0, 66.0, 0.0, 0.0], [1.0, 61.0, 0.0, 0.0], [1.0, 68.0, 0.0, -3.0], [0.0, 58.0, -1.0, -2.0], [1.0, 42.0, 0.0, 0.0], [-2.0, 13.0, 0.0, 0.0], [-3.0, 4.0, -1.0, 1.0], [-2.0, -10.0, 0.0, 0.0]]
    ...
    signal adder_7_input_xi  : std_logic_vector(12-1 downto 0); --	sfix(8, -4)
    ...
    -- Unreshaped Adder would be: sfix(8, -4) + sfix(14, -4) = sfix(14, -4)
    -- Reshaped Adder would be:   sfix(14, -4) + sfix(14, -4) = sfix(14, -4)
    -- 
    ...
    -- Unreshaped Adder would be: sfix(7, -4) + sfix(14, -4) = sfix(14, -4)
    -- Reshaped Adder would be:   sfix(14, -4) + sfix(14, -4) = sfix(14, -4)
    -- 
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in11_m4_11_m4_out13_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv2_core2_KPU1_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_3: entity work.IntMultiAdder_S_in10_m4_13_m4_out14_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv2_core2_KPU1_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_4: entity work.IntMultiAdder_S_in11_m4_14_m4_out14_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv2_core2_KPU1_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_5: entity work.IntMultiAdder_S_in10_m4_14_m4_out14_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv2_core2_KPU1_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_6: entity work.IntMultiAdder_S_in10_m4_14_m4_out14_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv2_core2_KPU1_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_6_input_xi, adder_6_input_sum, big_undelayed_out_2);
	adder_6_output <= big_delayed_in_2;
	adder_7: entity work.IntMultiAdder_S_in8_m4_14_m4_out14_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv2_core2_KPU1_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_7_input_xi, adder_7_input_sum, small_undelayed_out_5);
	adder_7_output <= small_delayed_in_5;
	adder_8: entity work.IntMultiAdder_S_in7_m4_14_m4_out14_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv2_core2_KPU1_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_8_input_xi, adder_8_input_sum, small_undelayed_out_6);
	adder_8_output <= small_delayed_in_6;

    last_stage: entity work.IntMultiAdder_S_in8_m4_14_m4_out14_m4_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv2_core2_KPU1_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
