...
entity IntMultiAdder_S_in6_m4_8_m4_out10_m4_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in6_m4_8_m4_out10_m4_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in6_m4_8_m4_out10_m4_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in6_m4_8_m4_out10_m4_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(14-1 downto 0); --	sfix(10, -4)
    signal xi_1_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(8, -4)
    signal xi_2_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(8, -4)
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in6_m4_8_m4_out10_m4_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(8, -4)
            xi_2_reshaped, --	sfix(8, -4)
            yo_signal
        );
