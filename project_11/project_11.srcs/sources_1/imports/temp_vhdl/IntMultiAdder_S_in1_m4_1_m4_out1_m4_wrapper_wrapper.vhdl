...
entity IntMultiAdder_S_in1_m4_1_m4_out1_m4_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in1_m4_1_m4_out1_m4_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in1_m4_1_m4_out1_m4_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in1_m4_1_m4_out1_m4_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(5-1 downto 0); --	sfix(1, -4)
    signal xi_1_reshaped :  std_logic_vector(5-1 downto 0); --	sfix(1, -4)
    signal xi_2_reshaped :  std_logic_vector(5-1 downto 0); --	sfix(1, -4)
    ...
    subtype DEBUG_TYPE is std_logic_vector(7 downto 0);
    constant allowed_min : integer := -16;
    constant allowed_max : integer := 15;
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in1_m4_1_m4_out1_m4_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(1, -4)
            xi_2_reshaped, --	sfix(1, -4)
            yo_signal
        );
