...
entity IntMultiAdder_S_in6_m9_8_m9_out9_m9_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in6_m9_8_m9_out9_m9_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in6_m9_8_m9_out9_m9_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in6_m9_8_m9_out9_m9_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(18-1 downto 0); --	sfix(9, -9)
    signal xi_1_reshaped :  std_logic_vector(17-1 downto 0); --	sfix(8, -9)
    signal xi_2_reshaped :  std_logic_vector(17-1 downto 0); --	sfix(8, -9)
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in6_m9_8_m9_out9_m9_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(8, -9)
            xi_2_reshaped, --	sfix(8, -9)
            yo_signal
        );
