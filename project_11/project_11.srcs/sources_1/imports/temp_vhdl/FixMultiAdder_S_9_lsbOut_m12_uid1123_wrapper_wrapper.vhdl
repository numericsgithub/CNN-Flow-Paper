...
-- 	sfix(2, -12)
-- 	sfix(12, -12)
-- Output is: sfix(12, -12)

entity FixMultiAdder_S_9_lsbOut_m12_uid1123_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_9 : in std_logic_vector(24-1 downto 0); --	sfix(12, -12)
        yo : out std_logic_vector(24-1 downto 0) --	sfix(12, -12)
    );
end FixMultiAdder_S_9_lsbOut_m12_uid1123_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_9_lsbOut_m12_uid1123_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_9_lsbOut_m12_uid1123_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(24-1 downto 0); --	sfix(12, -12)
    ...
    signal xi_9_reshaped :  std_logic_vector(24-1 downto 0); --	sfix(12, -12)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_9_lsbOut_m12_uid1123_wrapper
        generic map
        (
