...
END conv1_core1_KPU7;

ARCHITECTURE structural OF conv1_core1_KPU7 IS

    -- All all_additional_output_int_bits are:         [0, 2, 5, 5, 5, 6, 5, 5, 5]
    -- All all_additional_output_int_bits_weights are: [[-1.0], [-7.0], [0.0], [0.0], [-7.0], [3.0], [5.0], [1.0], [8.0]]
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in0_m12_m3_m12_out0_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU7_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_3: entity work.IntMultiAdder_S_in1_m12_0_m12_out2_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU7_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_4: entity work.IntMultiAdder_S_in1_m12_2_m12_out2_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU7_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_4_input_xi, adder_4_input_sum, small_undelayed_out_3);
	adder_4_output <= small_delayed_in_3;
	adder_5: entity work.IntMultiAdder_S_in0_m12_2_m12_out2_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU7_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_5_input_xi, adder_5_input_sum, small_undelayed_out_4);
	adder_5_output <= small_delayed_in_4;

    line_adder_6: entity work.IntMultiAdder_S_inm1_m12_2_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU7_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_7: entity work.IntMultiAdder_S_in0_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU7_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_inm2_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU7_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    last_stage: entity work.IntMultiAdder_S_in1_m12_3_m12_out3_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core1_KPU7_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
