...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=1950 name=entity_place_holder_name FixMultiAdder signedIn=1 n=9 msbIn=3:3:2:2:2:2:3:3:10 lsbIn=-11:-11:-11:-11:-11:-11:-11:-11:-11 lsbOut=-11

entity FixMultiAdder_S_9_lsbOut_m11_uid509_wrapper is
    generic
    (
...
end FixMultiAdder_S_9_lsbOut_m11_uid509_wrapper;

architecture Behavioral of FixMultiAdder_S_9_lsbOut_m11_uid509_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_9_PL              is array(0 to 1) of std_logic_vector(22-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_9_lsbOut_m11_uid509
        port map
        (
