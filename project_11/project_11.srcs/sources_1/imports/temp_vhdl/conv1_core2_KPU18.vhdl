...
END conv1_core2_KPU18;

ARCHITECTURE structural OF conv1_core2_KPU18 IS

    -- All all_additional_output_int_bits are:         [0, 2, 5, 6, 6, 5, 5, 5, 5]
    -- All all_additional_output_int_bits_weights are: [[-1.0], [-5.0], [-3.0], [-3.0], [-7.0], [-4.0], [-3.0], [-4.0], [-3.0]]
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in0_m12_m3_m12_out0_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU18_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_3: entity work.IntMultiAdder_S_inm1_m12_0_m12_out2_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU18_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_3_input_xi, adder_3_input_sum, big_undelayed_out_1);
	adder_3_output <= big_delayed_in_1;
	adder_4: entity work.IntMultiAdder_S_inm1_m12_2_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU18_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_5: entity work.IntMultiAdder_S_in0_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU18_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_6: entity work.IntMultiAdder_S_inm1_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU18_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_7: entity work.IntMultiAdder_S_inm1_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU18_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_inm1_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU18_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    last_stage: entity work.IntMultiAdder_S_inm1_m12_3_m12_out3_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core2_KPU18_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
