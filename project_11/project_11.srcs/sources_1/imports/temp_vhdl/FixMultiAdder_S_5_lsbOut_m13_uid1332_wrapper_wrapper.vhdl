...
-- 	sfix(3, -13)
-- 	sfix(17, -13)
-- Output is: sfix(17, -13)

entity FixMultiAdder_S_5_lsbOut_m13_uid1332_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(30-1 downto 0); --	sfix(17, -13)
        yo : out std_logic_vector(30-1 downto 0) --	sfix(17, -13)
    );
end FixMultiAdder_S_5_lsbOut_m13_uid1332_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m13_uid1332_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_5_lsbOut_m13_uid1332_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(30-1 downto 0); --	sfix(17, -13)
    signal xi_1_reshaped :  std_logic_vector(16-1 downto 0); --	sfix(3, -13)
    signal xi_2_reshaped :  std_logic_vector(16-1 downto 0); --	sfix(3, -13)
    signal xi_3_reshaped :  std_logic_vector(16-1 downto 0); --	sfix(3, -13)
    signal xi_4_reshaped :  std_logic_vector(16-1 downto 0); --	sfix(3, -13)
    signal xi_5_reshaped :  std_logic_vector(30-1 downto 0); --	sfix(17, -13)
    ...
    subtype DEBUG_TYPE is std_logic_vector(34 downto 0);
    constant allowed_min : integer := -536870912;
    constant allowed_max : integer := 536870911;
...
begin
    ...
    adder : entity work.FixMultiAdder_S_5_lsbOut_m13_uid1332_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(3, -13)
            xi_2_reshaped, --	sfix(3, -13)
            xi_3_reshaped, --	sfix(3, -13)
            xi_4_reshaped, --	sfix(3, -13)
            xi_5_reshaped, --	sfix(17, -13)
            yo_signal
        );
    ...
    yo_debug <= xi_1_resized_debug  + xi_2_resized_debug  + xi_3_resized_debug  + xi_4_resized_debug  + xi_5_resized_debug ;
