...
entity IntMultiAdder_S_in7_m8_7_m8_out7_m8_wrapper is
    generic
    (
    ...
    Port (
        ...
        yo  : out std_logic_vector(15-1 downto 0) --	sfix(7, -8)
    );
end IntMultiAdder_S_in7_m8_7_m8_out7_m8_wrapper;

architecture Behavioral of IntMultiAdder_S_in7_m8_7_m8_out7_m8_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in7_m8_7_m8_out7_m8
        port map
        (
            clk, rst, 
            yo_flopoco , 
