...
-- 	sfix(3, -11)
-- 	sfix(13, -11)
-- Output is: sfix(13, -11)

entity FixMultiAdder_S_9_lsbOut_m11_uid470_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_9 : in std_logic_vector(24-1 downto 0); --	sfix(13, -11)
        yo : out std_logic_vector(24-1 downto 0) --	sfix(13, -11)
    );
end FixMultiAdder_S_9_lsbOut_m11_uid470_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_9_lsbOut_m11_uid470_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_9_lsbOut_m11_uid470_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(24-1 downto 0); --	sfix(13, -11)
    ...
    signal xi_9_reshaped :  std_logic_vector(24-1 downto 0); --	sfix(13, -11)
    ...
    subtype DEBUG_TYPE is std_logic_vector(28 downto 0);
    constant allowed_min : integer := -8388608;
    constant allowed_max : integer := 8388607;
...
begin
    ...
    adder : entity work.FixMultiAdder_S_9_lsbOut_m11_uid470_wrapper
        generic map
        (
