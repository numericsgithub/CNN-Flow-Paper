...
architecture Behavioral of conv22 is
    ...
    attribute KEEP_HIERARCHY of conv22 : entity is "yes";
...
-- # # # OUT: y_is_valid_signal, pad_[3], big_buffer_delay_counter_signal, small_buffer_delay_counter_signal, interleave_counter_signal, buffer_enable_signal
    ...
    sliding_window_ctrl : entity work.conv22_SlidingWindowController
        port map
        (
            clk,
            reset,
...
-- SAVE THIS SHIT
    ...
    conv_core1 : entity work.conv22_core1
        generic map
        (
    ...
    conv_core2 : entity work.conv22_core2
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
...
-- Add a pipeline step
    ...
    core_1_KPU_1 : entity work.conv22_core1_KPU1
        generic map
        (
        ...
        (
            ...
            core_1_concat_small_undelayed_array(82-1 downto 64),
            core_1_concat_small_delayed_array(82-1 downto 64),
            core_1_concat_small_undelayed_array(100-1 downto 82),
            core_1_concat_small_delayed_array(100-1 downto 82),
    ...
    core_2_KPU_1 : entity work.conv22_core2_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
...
-- Add a pipeline step after the accumulator
    ...
    bias_add : entity work.conv22_bias_add
        Port map (
            clk,
...
-- Add a pipeline step
    ...
    simulation_validation: entity work.conv22_sim_validator
        Port map (
            clk,
            reset,
            layer_xi_1, --	ufix(2, -5)
