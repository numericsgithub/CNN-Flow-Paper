...
entity conv4_core6_rmcm_weightsconstant_memoryROM is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv4_core6_rmcm_weightsconstant_memoryROM;

architecture Behavioral of conv4_core6_rmcm_weightsconstant_memoryROM is
	...
	constant data_ROM : ROM_TYPE := (
	    ...
	    1 => w(3,3,-1,1,0,0,-2,-3,0),
	    2 => w(39,22,3,14,10,3,22,29,6),
	    3 => w(-73,-50,-47,-105,-64,-58,-69,-62,-37)
        );
