...
entity FixMultiAdder_S_17_lsbOut_m11_uid273_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_3 : in std_logic_vector(14-1 downto 0); --	sfix(3, -11)
        ...
        xi_9 : in std_logic_vector(15-1 downto 0); --	sfix(4, -11)
        ...
        xi_14 : in std_logic_vector(14-1 downto 0); --	sfix(3, -11)
...
end FixMultiAdder_S_17_lsbOut_m11_uid273_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m11_uid273_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m11_uid273_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(19-1 downto 0); --	sfix(8, -11)
    signal xi_1_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_2_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(2, -11)
    signal xi_3_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_4_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(2, -11)
    signal xi_5_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_6_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_7_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_8_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(2, -11)
    signal xi_9_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(4, -11)
    signal xi_10_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(2, -11)
    signal xi_11_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    ...
    signal xi_14_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m11_uid273_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(3, -11)
            xi_2_reshaped, --	sfix(2, -11)
            xi_3_reshaped, --	sfix(3, -11)
            xi_4_reshaped, --	sfix(2, -11)
            xi_5_reshaped, --	sfix(3, -11)
            xi_6_reshaped, --	sfix(3, -11)
            xi_7_reshaped, --	sfix(3, -11)
            xi_8_reshaped, --	sfix(2, -11)
            xi_9_reshaped, --	sfix(4, -11)
            xi_10_reshaped, --	sfix(2, -11)
            xi_11_reshaped, --	sfix(3, -11)
            xi_12_reshaped, --	sfix(3, -11)
            xi_13_reshaped, --	sfix(2, -11)
            xi_14_reshaped, --	sfix(3, -11)
