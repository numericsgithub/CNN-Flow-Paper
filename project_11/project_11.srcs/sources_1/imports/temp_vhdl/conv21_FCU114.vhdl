...
architecture structural of conv21_FCU114 is
...
begin
    ...
    accumulation : entity work.FixMultiAdder_S_9_lsbOut_m12_uid1019_wrapper_wrapper generic map(ADDER_LOCATION => "conv21_FCU114", PIPELINE_STEPS => PIPELINE_STEPS-1, ADDITIONAL_PIPELINE_STEP_AT_OUTPUT => TRUE)
        port map
        (
            clk, '0', buffer_enable,
            xi_1,
