...
entity conv4_core12_rmcm_weightsconstant_memoryROM is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv4_core12_rmcm_weightsconstant_memoryROM;

architecture Behavioral of conv4_core12_rmcm_weightsconstant_memoryROM is
	...
	constant data_ROM : ROM_TYPE := (
	    ...
	    0 => w(-2,-2,-1,-1,-2,-1,1,1,1),
	    1 => w(6,9,1,-2,0,1,-5,-8,-2),
	    2 => w(-5,-8,-3,1,1,0,4,8,3),
	    3 => w(0,-1,0,-1,0,1,0,1,0)
        );
