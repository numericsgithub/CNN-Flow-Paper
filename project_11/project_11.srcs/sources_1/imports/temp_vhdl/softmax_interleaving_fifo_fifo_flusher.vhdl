...
entity softmax_interleaving_fifo_fifo_flusher is
    Port (
        clk    : in std_logic;
        rst    : in std_logic;
        enable : in std_logic;
...
end softmax_interleaving_fifo_fifo_flusher;

architecture Behavioral of softmax_interleaving_fifo_fifo_flusher is
    constant AMOUNT_OF_INPUTS : natural := 4;
    constant XI_WIDTH : natural := 8;
    constant FIFO_SIZE : natural := 249;
    constant AMOUNT_OF_FLUSH_STEPS : natural := 125;
...
begin
    ...
    fifo_input_signal    <= data_in_1 & data_in_2 & data_in_3 & data_in_4 ;

    data_out_1 <= fifo_output_signal((XI_WIDTH*4)-1 downto (XI_WIDTH*3));
    data_out_2 <= fifo_output_signal((XI_WIDTH*3)-1 downto (XI_WIDTH*2));
    data_out_3 <= fifo_output_signal((XI_WIDTH*2)-1 downto (XI_WIDTH*1));
    data_out_4 <= fifo_output_signal((XI_WIDTH*1)-1 downto (XI_WIDTH*0));
