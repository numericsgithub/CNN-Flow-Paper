...
entity IntMultiAdder_S_in1_m15_1_m15_out3_m15_wrapper is
    generic
    (
    ...
    Port (
        ...
        yo  : out std_logic_vector(18-1 downto 0) --	sfix(3, -15)
    );
end IntMultiAdder_S_in1_m15_1_m15_out3_m15_wrapper;

architecture Behavioral of IntMultiAdder_S_in1_m15_1_m15_out3_m15_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in1_m15_1_m15_out3_m15
        port map
        (
            clk, rst, 
            yo_flopoco , 
