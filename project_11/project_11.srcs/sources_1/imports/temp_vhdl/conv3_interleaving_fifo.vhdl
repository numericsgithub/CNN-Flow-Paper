...
entity conv3_interleaving_fifo is
    Port (
        clk    : in  std_logic;
        rst    : in  std_logic;
        enable : in  std_logic;
...
end conv3_interleaving_fifo;

architecture Behavioral of conv3_interleaving_fifo is
    ...
    signal fifo_1_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_2_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_3_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_4_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_5_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_6_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_7_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_8_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_9_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_10_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_11_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_12_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_13_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_14_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_15_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_16_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_17_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_18_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_19_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_20_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_21_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_22_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_23_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_24_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_25_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_26_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_27_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_28_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_29_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_30_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_31_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
    signal fifo_32_output_signal   : std_logic_vector(7-1 downto 0); --	ufix(5, -2)
...
begin
    ...
    INPUT_FIFO: entity work.conv3_interleaving_fifo_fifo_flusher
    port map
    (
        clk => clk,
        rst => rst,
    ...
    INTERLEAVER_AND_HOLDER: entity work.conv3_interleaving_fifo_interleaver_and_holder
    port map
    (
        clk => clk,
        rst => rst,
