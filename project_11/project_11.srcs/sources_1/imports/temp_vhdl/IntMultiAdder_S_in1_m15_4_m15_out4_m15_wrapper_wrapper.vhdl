...
entity IntMultiAdder_S_in1_m15_4_m15_out4_m15_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in1_m15_4_m15_out4_m15_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in1_m15_4_m15_out4_m15_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in1_m15_4_m15_out4_m15_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(19-1 downto 0); --	sfix(4, -15)
    signal xi_1_reshaped :  std_logic_vector(19-1 downto 0); --	sfix(4, -15)
    signal xi_2_reshaped :  std_logic_vector(19-1 downto 0); --	sfix(4, -15)
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in1_m15_4_m15_out4_m15_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(4, -15)
            xi_2_reshaped, --	sfix(4, -15)
            yo_signal
        );
