...
entity conv20_bias_add_constant_memory is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv20_bias_add_constant_memory;

architecture Behavioral of conv20_bias_add_constant_memory is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of conv20_bias_add_constant_memory : entity is "yes";

    signal rom_data_out_signal : std_logic_vector((XI_WIDTH * WORDS_PER_ADDR)-1 downto 0);

begin

    ROM_BLOCK: entity conv20_bias_add_constant_memoryROM generic map
    (
        XI_WIDTH        	=> XI_WIDTH,
