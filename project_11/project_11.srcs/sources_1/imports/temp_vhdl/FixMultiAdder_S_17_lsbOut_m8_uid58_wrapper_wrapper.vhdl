...
entity FixMultiAdder_S_17_lsbOut_m8_uid58_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_7 : in std_logic_vector(11-1 downto 0); --	sfix(3, -8)
        xi_8 : in std_logic_vector(12-1 downto 0); --	sfix(4, -8)
        xi_9 : in std_logic_vector(12-1 downto 0); --	sfix(4, -8)
        xi_10 : in std_logic_vector(15-1 downto 0); --	sfix(7, -8)
...
end FixMultiAdder_S_17_lsbOut_m8_uid58_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m8_uid58_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m8_uid58_wrapper_wrapper : entity is "yes";
    ...
    signal xi_7_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    signal xi_8_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    signal xi_9_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    signal xi_10_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(7, -8)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m8_uid58_wrapper
        generic map
        (
        ...
        (
            ...
            xi_7_reshaped, --	sfix(3, -8)
            xi_8_reshaped, --	sfix(4, -8)
            xi_9_reshaped, --	sfix(4, -8)
            xi_10_reshaped, --	sfix(7, -8)
