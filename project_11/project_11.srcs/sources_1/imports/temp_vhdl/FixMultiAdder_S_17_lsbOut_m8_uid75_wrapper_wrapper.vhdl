...
entity FixMultiAdder_S_17_lsbOut_m8_uid75_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_3 : in std_logic_vector(10-1 downto 0); --	sfix(2, -8)
        xi_4 : in std_logic_vector(11-1 downto 0); --	sfix(3, -8)
        xi_5 : in std_logic_vector(11-1 downto 0); --	sfix(3, -8)
        xi_6 : in std_logic_vector(10-1 downto 0); --	sfix(2, -8)
        xi_7 : in std_logic_vector(13-1 downto 0); --	sfix(5, -8)
        xi_8 : in std_logic_vector(11-1 downto 0); --	sfix(3, -8)
        xi_9 : in std_logic_vector(13-1 downto 0); --	sfix(5, -8)
        xi_10 : in std_logic_vector(11-1 downto 0); --	sfix(3, -8)
        xi_11 : in std_logic_vector(15-1 downto 0); --	sfix(7, -8)
        xi_12 : in std_logic_vector(13-1 downto 0); --	sfix(5, -8)
        xi_13 : in std_logic_vector(11-1 downto 0); --	sfix(3, -8)
        xi_14 : in std_logic_vector(12-1 downto 0); --	sfix(4, -8)
        xi_15 : in std_logic_vector(13-1 downto 0); --	sfix(5, -8)
        xi_16 : in std_logic_vector(11-1 downto 0); --	sfix(3, -8)
        xi_17 : in std_logic_vector(22-1 downto 0); --	sfix(14, -8)
        yo : out std_logic_vector(22-1 downto 0) --	sfix(14, -8)
    );
end FixMultiAdder_S_17_lsbOut_m8_uid75_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m8_uid75_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m8_uid75_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(22-1 downto 0); --	sfix(14, -8)
    signal xi_1_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    signal xi_2_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_3_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(2, -8)
    signal xi_4_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    signal xi_5_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    signal xi_6_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(2, -8)
    signal xi_7_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_8_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    signal xi_9_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_10_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    signal xi_11_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(7, -8)
    signal xi_12_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_13_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    signal xi_14_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    signal xi_15_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_16_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    signal xi_17_reshaped :  std_logic_vector(22-1 downto 0); --	sfix(14, -8)
    ...
    subtype DEBUG_TYPE is std_logic_vector(26 downto 0);
    constant allowed_min : integer := -2097152;
    constant allowed_max : integer := 2097151;
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m8_uid75_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(4, -8)
            xi_2_reshaped, --	sfix(5, -8)
            xi_3_reshaped, --	sfix(2, -8)
            xi_4_reshaped, --	sfix(3, -8)
            xi_5_reshaped, --	sfix(3, -8)
            xi_6_reshaped, --	sfix(2, -8)
            xi_7_reshaped, --	sfix(5, -8)
            xi_8_reshaped, --	sfix(3, -8)
            xi_9_reshaped, --	sfix(5, -8)
            xi_10_reshaped, --	sfix(3, -8)
            xi_11_reshaped, --	sfix(7, -8)
            xi_12_reshaped, --	sfix(5, -8)
            xi_13_reshaped, --	sfix(3, -8)
            xi_14_reshaped, --	sfix(4, -8)
            xi_15_reshaped, --	sfix(5, -8)
            xi_16_reshaped, --	sfix(3, -8)
            xi_17_reshaped, --	sfix(14, -8)
            yo_signal
        );
