...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=950 name=entity_place_holder_name IntMultiAdder signedIn=True n=2 wIn=11 wOut=12

entity IntMultiAdder_S_inm1_m12_m2_m12_out0_m12_wrapper is
    generic
    (
...
end IntMultiAdder_S_inm1_m12_m2_m12_out0_m12_wrapper;

architecture Behavioral of IntMultiAdder_S_inm1_m12_m2_m12_out0_m12_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_inm1_m12_m2_m12_out0_m12
        port map
        (
            clk, rst, 
            yo_flopoco , 
