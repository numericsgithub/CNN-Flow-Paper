...
entity FixMultiAdder_S_33_lsbOut_m10_uid140_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        rst    : in std_logic;
        enable : in std_logic;
        xi_1 : in std_logic_vector(15-1 downto 0); --	sfix(5, -10)
        ...
        xi_5 : in std_logic_vector(12-1 downto 0); --	sfix(2, -10)
        xi_6 : in std_logic_vector(13-1 downto 0); --	sfix(3, -10)
        xi_7 : in std_logic_vector(14-1 downto 0); --	sfix(4, -10)
        ...
        xi_17 : in std_logic_vector(13-1 downto 0); --	sfix(3, -10)
        xi_18 : in std_logic_vector(14-1 downto 0); --	sfix(4, -10)
        xi_19 : in std_logic_vector(13-1 downto 0); --	sfix(3, -10)
        xi_20 : in std_logic_vector(14-1 downto 0); --	sfix(4, -10)
        xi_21 : in std_logic_vector(13-1 downto 0); --	sfix(3, -10)
        xi_22 : in std_logic_vector(12-1 downto 0); --	sfix(2, -10)
        xi_23 : in std_logic_vector(13-1 downto 0); --	sfix(3, -10)
        xi_24 : in std_logic_vector(12-1 downto 0); --	sfix(2, -10)
        xi_25 : in std_logic_vector(13-1 downto 0); --	sfix(3, -10)
        xi_26 : in std_logic_vector(15-1 downto 0); --	sfix(5, -10)
        ...
        xi_30 : in std_logic_vector(14-1 downto 0); --	sfix(4, -10)
        xi_31 : in std_logic_vector(13-1 downto 0); --	sfix(3, -10)
        xi_32 : in std_logic_vector(14-1 downto 0); --	sfix(4, -10)
        xi_33 : in std_logic_vector(19-1 downto 0); --	sfix(9, -10)
        yo : out std_logic_vector(19-1 downto 0) --	sfix(9, -10)
    );
end FixMultiAdder_S_33_lsbOut_m10_uid140_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m10_uid140_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m10_uid140_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(19-1 downto 0); --	sfix(9, -10)
    signal xi_1_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(5, -10)
    ...
    signal xi_5_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(2, -10)
    signal xi_6_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(3, -10)
    signal xi_7_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(4, -10)
    ...
    signal xi_17_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(3, -10)
    signal xi_18_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(4, -10)
    signal xi_19_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(3, -10)
    ...
    signal xi_22_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(2, -10)
    ...
    signal xi_25_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(3, -10)
    signal xi_26_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(5, -10)
    ...
    signal xi_30_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(4, -10)
    ...
    signal xi_33_reshaped :  std_logic_vector(19-1 downto 0); --	sfix(9, -10)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m10_uid140_wrapper
        generic map
        (
