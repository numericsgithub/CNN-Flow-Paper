...
architecture structural of conv23_FCU117 is
    ...
    signal xi_6_reshaped : std_logic_vector(20-1 downto 0); --	sfix(8, -12)
    signal xi_7_reshaped : std_logic_vector(20-1 downto 0); --	sfix(8, -12)
    signal xi_8_reshaped : std_logic_vector(20-1 downto 0); --	sfix(8, -12)
...
begin
    ...
    accumulation : entity work.FixMultiAdder_S_9_lsbOut_m12_uid1167_wrapper_wrapper generic map(ADDER_LOCATION => "conv23_FCU117", PIPELINE_STEPS => PIPELINE_STEPS-1, ADDITIONAL_PIPELINE_STEP_AT_OUTPUT => TRUE)
        port map
        (
            clk, '0', buffer_enable,
            xi_1,
