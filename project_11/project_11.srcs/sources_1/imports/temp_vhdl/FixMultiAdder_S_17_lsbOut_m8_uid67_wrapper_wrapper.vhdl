...
entity FixMultiAdder_S_17_lsbOut_m8_uid67_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(12-1 downto 0); --	sfix(4, -8)
        xi_6 : in std_logic_vector(12-1 downto 0); --	sfix(4, -8)
        xi_7 : in std_logic_vector(12-1 downto 0); --	sfix(4, -8)
        ...
        xi_11 : in std_logic_vector(12-1 downto 0); --	sfix(4, -8)
        ...
        xi_15 : in std_logic_vector(14-1 downto 0); --	sfix(6, -8)
        xi_16 : in std_logic_vector(13-1 downto 0); --	sfix(5, -8)
        xi_17 : in std_logic_vector(19-1 downto 0); --	sfix(11, -8)
        yo : out std_logic_vector(19-1 downto 0) --	sfix(11, -8)
    );
end FixMultiAdder_S_17_lsbOut_m8_uid67_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m8_uid67_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m8_uid67_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(19-1 downto 0); --	sfix(11, -8)
    ...
    signal xi_5_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    signal xi_6_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    signal xi_7_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    signal xi_8_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_9_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_10_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    signal xi_11_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    ...
    signal xi_15_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(6, -8)
    signal xi_16_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_17_reshaped :  std_logic_vector(19-1 downto 0); --	sfix(11, -8)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m8_uid67_wrapper
        generic map
        (
        ...
        (
            ...
            xi_5_reshaped, --	sfix(4, -8)
            xi_6_reshaped, --	sfix(4, -8)
            xi_7_reshaped, --	sfix(4, -8)
            xi_8_reshaped, --	sfix(5, -8)
            xi_9_reshaped, --	sfix(5, -8)
            xi_10_reshaped, --	sfix(4, -8)
            xi_11_reshaped, --	sfix(4, -8)
            xi_12_reshaped, --	sfix(5, -8)
            xi_13_reshaped, --	sfix(3, -8)
            xi_14_reshaped, --	sfix(5, -8)
            xi_15_reshaped, --	sfix(6, -8)
            xi_16_reshaped, --	sfix(5, -8)
            xi_17_reshaped, --	sfix(11, -8)
            yo_signal
        );
