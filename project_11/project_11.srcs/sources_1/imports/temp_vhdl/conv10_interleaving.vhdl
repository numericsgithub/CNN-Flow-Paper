...
entity conv10_interleaving is
    generic
    (
        XI_WIDTH        	: natural := 7;
		CONFIGURATIONS      : natural := 64;
		INTERLEAVINGS       : natural := 1;
		INPUTS_PER_MUX      : natural := 16
    );
    port
    (
        clk   : in std_logic;
...
end conv10_interleaving;

architecture Behavioral of conv10_interleaving is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of conv10_interleaving : entity is "yes";
    ...
    constant AMOUNT_OF_LAYER_OUTPUTS          : natural := 4;
    ...
    type PIPELINE_TYPE_FOR_FIFO_MAIN_OUTPUT_SIGNAL_PL is array(0 to 1) of std_logic_vector((XI_WIDTH*64-1) downto 0);
    ...
    -- All fifo outputs
    signal fifo_MAIN_input_signal         : std_logic_vector((XI_WIDTH*64-1) downto 0);
    -- 
    signal fifo_MAIN_output_signal_pl : PIPELINE_TYPE_FOR_FIFO_MAIN_OUTPUT_SIGNAL_PL;
    --signal fifo_MAIN_output_signal        : std_logic_vector((XI_WIDTH*64-1) downto 0);
...
begin
    ...
    fifo_1_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*64)-1 downto (XI_WIDTH*63));
    fifo_2_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*63)-1 downto (XI_WIDTH*62));
    fifo_3_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*62)-1 downto (XI_WIDTH*61));
    fifo_4_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*61)-1 downto (XI_WIDTH*60));
    fifo_5_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*60)-1 downto (XI_WIDTH*59));
    fifo_6_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*59)-1 downto (XI_WIDTH*58));
    fifo_7_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*58)-1 downto (XI_WIDTH*57));
    fifo_8_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*57)-1 downto (XI_WIDTH*56));
    fifo_9_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*56)-1 downto (XI_WIDTH*55));
    fifo_10_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*55)-1 downto (XI_WIDTH*54));
    fifo_11_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*54)-1 downto (XI_WIDTH*53));
    fifo_12_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*53)-1 downto (XI_WIDTH*52));
    fifo_13_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*52)-1 downto (XI_WIDTH*51));
    fifo_14_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*51)-1 downto (XI_WIDTH*50));
    fifo_15_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*50)-1 downto (XI_WIDTH*49));
    fifo_16_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*49)-1 downto (XI_WIDTH*48));
    fifo_17_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*48)-1 downto (XI_WIDTH*47));
    fifo_18_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*47)-1 downto (XI_WIDTH*46));
    fifo_19_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*46)-1 downto (XI_WIDTH*45));
    fifo_20_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*45)-1 downto (XI_WIDTH*44));
    fifo_21_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*44)-1 downto (XI_WIDTH*43));
    fifo_22_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*43)-1 downto (XI_WIDTH*42));
    fifo_23_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*42)-1 downto (XI_WIDTH*41));
    fifo_24_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*41)-1 downto (XI_WIDTH*40));
    fifo_25_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*40)-1 downto (XI_WIDTH*39));
    fifo_26_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*39)-1 downto (XI_WIDTH*38));
    fifo_27_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*38)-1 downto (XI_WIDTH*37));
    fifo_28_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*37)-1 downto (XI_WIDTH*36));
    fifo_29_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*36)-1 downto (XI_WIDTH*35));
    fifo_30_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*35)-1 downto (XI_WIDTH*34));
    fifo_31_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*34)-1 downto (XI_WIDTH*33));
    fifo_32_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*33)-1 downto (XI_WIDTH*32));
    fifo_33_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*32)-1 downto (XI_WIDTH*31));
    fifo_34_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*31)-1 downto (XI_WIDTH*30));
    fifo_35_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*30)-1 downto (XI_WIDTH*29));
    fifo_36_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*29)-1 downto (XI_WIDTH*28));
    fifo_37_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*28)-1 downto (XI_WIDTH*27));
    fifo_38_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*27)-1 downto (XI_WIDTH*26));
    fifo_39_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*26)-1 downto (XI_WIDTH*25));
    fifo_40_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*25)-1 downto (XI_WIDTH*24));
    fifo_41_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*24)-1 downto (XI_WIDTH*23));
    fifo_42_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*23)-1 downto (XI_WIDTH*22));
    fifo_43_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*22)-1 downto (XI_WIDTH*21));
    fifo_44_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*21)-1 downto (XI_WIDTH*20));
    fifo_45_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*20)-1 downto (XI_WIDTH*19));
    fifo_46_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*19)-1 downto (XI_WIDTH*18));
    fifo_47_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*18)-1 downto (XI_WIDTH*17));
    fifo_48_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*17)-1 downto (XI_WIDTH*16));
    fifo_49_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*16)-1 downto (XI_WIDTH*15));
    fifo_50_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*15)-1 downto (XI_WIDTH*14));
    fifo_51_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*14)-1 downto (XI_WIDTH*13));
    fifo_52_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*13)-1 downto (XI_WIDTH*12));
    fifo_53_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*12)-1 downto (XI_WIDTH*11));
    fifo_54_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*11)-1 downto (XI_WIDTH*10));
    fifo_55_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*10)-1 downto (XI_WIDTH*9));
    fifo_56_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*9)-1 downto (XI_WIDTH*8));
    fifo_57_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*8)-1 downto (XI_WIDTH*7));
    fifo_58_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*7)-1 downto (XI_WIDTH*6));
    fifo_59_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*6)-1 downto (XI_WIDTH*5));
    fifo_60_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*5)-1 downto (XI_WIDTH*4));
    fifo_61_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*4)-1 downto (XI_WIDTH*3));
    fifo_62_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*3)-1 downto (XI_WIDTH*2));
    fifo_63_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*2)-1 downto (XI_WIDTH*1));
    fifo_64_output_signal <= fifo_MAIN_output_signal_pl(1)((XI_WIDTH*1)-1 downto (XI_WIDTH*0));



    MUX_0: entity work.muxB_16to1 generic map(DATA_WIDTH => (XI_WIDTH))
                               port map(fifo_1_output_signal, fifo_5_output_signal, fifo_9_output_signal, fifo_13_output_signal, fifo_17_output_signal, fifo_21_output_signal, fifo_25_output_signal, fifo_29_output_signal, fifo_33_output_signal, fifo_37_output_signal, fifo_41_output_signal, fifo_45_output_signal, fifo_49_output_signal, fifo_53_output_signal, fifo_57_output_signal, fifo_61_output_signal, mux_select_signal_pl(1), layer_yo_1_pl(0));

    MUX_1: entity work.muxB_16to1 generic map(DATA_WIDTH => (XI_WIDTH))
                               port map(fifo_2_output_signal, fifo_6_output_signal, fifo_10_output_signal, fifo_14_output_signal, fifo_18_output_signal, fifo_22_output_signal, fifo_26_output_signal, fifo_30_output_signal, fifo_34_output_signal, fifo_38_output_signal, fifo_42_output_signal, fifo_46_output_signal, fifo_50_output_signal, fifo_54_output_signal, fifo_58_output_signal, fifo_62_output_signal, mux_select_signal_pl(1), layer_yo_2_pl(0));

    MUX_2: entity work.muxB_16to1 generic map(DATA_WIDTH => (XI_WIDTH))
                               port map(fifo_3_output_signal, fifo_7_output_signal, fifo_11_output_signal, fifo_15_output_signal, fifo_19_output_signal, fifo_23_output_signal, fifo_27_output_signal, fifo_31_output_signal, fifo_35_output_signal, fifo_39_output_signal, fifo_43_output_signal, fifo_47_output_signal, fifo_51_output_signal, fifo_55_output_signal, fifo_59_output_signal, fifo_63_output_signal, mux_select_signal_pl(1), layer_yo_3_pl(0));

    MUX_3: entity work.muxB_16to1 generic map(DATA_WIDTH => (XI_WIDTH))
                               port map(fifo_4_output_signal, fifo_8_output_signal, fifo_12_output_signal, fifo_16_output_signal, fifo_20_output_signal, fifo_24_output_signal, fifo_28_output_signal, fifo_32_output_signal, fifo_36_output_signal, fifo_40_output_signal, fifo_44_output_signal, fifo_48_output_signal, fifo_52_output_signal, fifo_56_output_signal, fifo_60_output_signal, fifo_64_output_signal, mux_select_signal_pl(1), layer_yo_4_pl(0));
    ...
    begin
        if rising_edge(clk) then
            if fifo_data_counter >= FIFO_SIZE then
                assert false
                report "Interleaving layer conv10_interleaving: FIFO Overflow!"
                severity warning;
            end if;
        end if;
    end process;
