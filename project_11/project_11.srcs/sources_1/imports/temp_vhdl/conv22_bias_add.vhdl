...
architecture Behavioral of conv22_bias_add is
...
begin
    BIAS_ROM: entity work.conv22_bias_add_constant_memory
        generic map
        (
            XI_WIDTH        	          => BIAS_WIDTH,
            ARRAY_SIZE                    => 256,
    ...
    adder_1 : entity work.IntMultiAdder_S_in4_m4_8_m10_out8_m10_wrapper_wrapper generic map(ADDER_LOCATION => "conv22_bias_add" & "_1")
        port map
        (
            clk,
            '0',
    ...
    adder_2 : entity work.IntMultiAdder_S_in4_m4_8_m10_out8_m10_wrapper_wrapper generic map(ADDER_LOCATION => "conv22_bias_add" & "_2")
        port map
        (
            clk,
            '0',
