...
entity conv9_interleaving_fifo is
    Port (
        clk    : in  std_logic;
        rst    : in  std_logic;
        enable : in  std_logic;
...
end conv9_interleaving_fifo;

architecture Behavioral of conv9_interleaving_fifo is
...
begin
    ...
    INPUT_FIFO: entity work.conv9_interleaving_fifo_fifo_flusher
    port map
    (
        clk => clk,
        rst => rst,
    ...
    INTERLEAVER_AND_HOLDER: entity work.conv9_interleaving_fifo_interleaver_and_holder
    port map
    (
        clk => clk,
        rst => rst,
