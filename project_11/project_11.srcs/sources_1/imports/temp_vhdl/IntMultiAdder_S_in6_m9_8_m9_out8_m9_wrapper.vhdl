...
entity IntMultiAdder_S_in6_m9_8_m9_out8_m9_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(17-1 downto 0); --	sfix(8, -9)
        xi_2 : in std_logic_vector(17-1 downto 0); --	sfix(8, -9)
        yo  : out std_logic_vector(17-1 downto 0) --	sfix(8, -9)
    );
end IntMultiAdder_S_in6_m9_8_m9_out8_m9_wrapper;

architecture Behavioral of IntMultiAdder_S_in6_m9_8_m9_out8_m9_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in6_m9_8_m9_out8_m9
        port map
        (
            clk, rst, 
            yo_flopoco , 
