...
entity conv24 is
    ...
    (
        ...
        layer_xi_2    : in std_logic_vector(7-1 downto 0); --	ufix(2, -5)
...
architecture Behavioral of conv24 is
    ...
    attribute KEEP_HIERARCHY of conv24 : entity is "yes";
    ...
    type PIPELINE_TYPE_FOR_CORE_1_KPU_1_INPUT_3 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_1_KPU_1_INPUT_9 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_2_KPU_1_INPUT_7 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_2_KPU_1_INPUT_8 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_2_KPU_1_INPUT_9 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    type PIPELINE_TYPE_FOR_SIGNAL_CORE_1_YO_1   is array(0 to 0) of std_logic_vector(19-1 downto 0);
    type PIPELINE_TYPE_FOR_SIGNAL_CORE_2_YO_1   is array(0 to 0) of std_logic_vector(19-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_LAYER_YO_1_UNCLIPPED is array(0 to 0) of std_logic_vector(11-1 downto 0);
    type PIPELINE_TYPE_FOR_LAYER_YO_2_UNCLIPPED is array(0 to 0) of std_logic_vector(11-1 downto 0);
    ...
    -- The one std_logic_vector to delay
    subtype CORE_1_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(108-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_2_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(37-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_2_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(107-1 downto 0);
...
-- # # # OUT: y_is_valid_signal, pad_[3], big_buffer_delay_counter_signal, small_buffer_delay_counter_signal, interleave_counter_signal, buffer_enable_signal
    ...
    sliding_window_ctrl : entity work.conv24_SlidingWindowController
        port map
        (
            clk,
            reset,
...
-- SAVE THIS SHIT
    ...
    conv_core1 : entity work.conv24_core1
        generic map
        (
    ...
    conv_core2 : entity work.conv24_core2
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
...
-- Add a pipeline step
    ...
    core_1_KPU_1 : entity work.conv24_core1_KPU1
        generic map
        (
        ...
        (
            ...
            core_1_kpu_1_input_1(0), --	sfix(3, -12)
            core_1_kpu_1_input_2(0), --	sfix(3, -12)
            core_1_kpu_1_input_3(0), --	sfix(3, -12)
            core_1_kpu_1_input_4(0), --	sfix(3, -12)
            core_1_kpu_1_input_5(0), --	sfix(3, -12)
            core_1_kpu_1_input_6(0), --	sfix(3, -12)
            core_1_kpu_1_input_7(0), --	sfix(3, -12)
            core_1_kpu_1_input_8(0), --	sfix(3, -12)
            core_1_kpu_1_input_9(0), --	sfix(3, -12)
            ...
            core_1_concat_small_undelayed_array(51-1 downto 32),
            core_1_concat_small_delayed_array(51-1 downto 32),
            core_1_concat_small_undelayed_array(70-1 downto 51),
            core_1_concat_small_delayed_array(70-1 downto 51),
            core_1_concat_small_undelayed_array(89-1 downto 70),
            core_1_concat_small_delayed_array(89-1 downto 70),
            core_1_concat_small_undelayed_array(108-1 downto 89),
            core_1_concat_small_delayed_array(108-1 downto 89),
    ...
    core_2_KPU_1 : entity work.conv24_core2_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_2_kpu_1_input_1(0), --	sfix(3, -12)
            core_2_kpu_1_input_2(0), --	sfix(3, -12)
            core_2_kpu_1_input_3(0), --	sfix(2, -12)
            core_2_kpu_1_input_4(0), --	sfix(3, -12)
            core_2_kpu_1_input_5(0), --	sfix(3, -12)
            core_2_kpu_1_input_6(0), --	sfix(2, -12)
            core_2_kpu_1_input_7(0), --	sfix(3, -12)
            core_2_kpu_1_input_8(0), --	sfix(3, -12)
            core_2_kpu_1_input_9(0), --	sfix(3, -12)

        
            core_2_concat_big_undelayed_array(18-1 downto 0),
            core_2_concat_big_delayed_array(18-1 downto 0),
            core_2_concat_big_undelayed_array(37-1 downto 18),
            core_2_concat_big_delayed_array(37-1 downto 18),
            ...
            core_2_concat_small_undelayed_array(69-1 downto 50),
            core_2_concat_small_delayed_array(69-1 downto 50),
            core_2_concat_small_undelayed_array(88-1 downto 69),
            core_2_concat_small_delayed_array(88-1 downto 69),
            core_2_concat_small_undelayed_array(107-1 downto 88),
            core_2_concat_small_delayed_array(107-1 downto 88),
...
-- Add a pipeline step after the accumulator
    ...
    bias_add : entity work.conv24_bias_add
        Port map (
            clk,
...
-- Add a pipeline step
    ...
    simulation_validation: entity work.conv24_sim_validator
        Port map (
            clk,
            reset,
            layer_xi_1, --	ufix(2, -5)
