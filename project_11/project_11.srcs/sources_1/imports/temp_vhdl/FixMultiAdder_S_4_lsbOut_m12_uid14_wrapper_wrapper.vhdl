...
entity FixMultiAdder_S_4_lsbOut_m12_uid14_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_2 : in std_logic_vector(18-1 downto 0); --	sfix(6, -12)
        xi_3 : in std_logic_vector(17-1 downto 0); --	sfix(5, -12)
        xi_4 : in std_logic_vector(20-1 downto 0); --	sfix(8, -12)
        yo : out std_logic_vector(20-1 downto 0) --	sfix(8, -12)
    );
end FixMultiAdder_S_4_lsbOut_m12_uid14_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_4_lsbOut_m12_uid14_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_4_lsbOut_m12_uid14_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(20-1 downto 0); --	sfix(8, -12)
    signal xi_1_reshaped :  std_logic_vector(18-1 downto 0); --	sfix(6, -12)
    signal xi_2_reshaped :  std_logic_vector(18-1 downto 0); --	sfix(6, -12)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_4_lsbOut_m12_uid14_wrapper
        generic map
        (
        ...
        (
            ...
            xi_2_reshaped, --	sfix(6, -12)
            xi_3_reshaped, --	sfix(5, -12)
            xi_4_reshaped, --	sfix(8, -12)
            yo_signal
        );
