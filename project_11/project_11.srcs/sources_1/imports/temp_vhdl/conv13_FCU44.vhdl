...
architecture structural of conv13_FCU44 is
...
begin
    ...
    accumulation : entity work.FixMultiAdder_S_5_lsbOut_m12_uid343_wrapper_wrapper generic map(ADDER_LOCATION => "conv13_FCU44", PIPELINE_STEPS => PIPELINE_STEPS-1, ADDITIONAL_PIPELINE_STEP_AT_OUTPUT => TRUE)
        port map
        (
            clk, '0', buffer_enable,
            xi_1,
