...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=950 name=entity_place_holder_name IntMultiAdder signedIn=True n=2 wIn=5 wOut=5

entity IntMultiAdder_S_in1_m4_1_m4_out1_m4_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(5-1 downto 0); --	sfix(1, -4)
        xi_2 : in std_logic_vector(5-1 downto 0); --	sfix(1, -4)
        yo  : out std_logic_vector(5-1 downto 0) --	sfix(1, -4)
    );
end IntMultiAdder_S_in1_m4_1_m4_out1_m4_wrapper;

architecture Behavioral of IntMultiAdder_S_in1_m4_1_m4_out1_m4_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_1_PL              is array(0 to 1) of std_logic_vector(5-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_2_PL              is array(0 to 1) of std_logic_vector(5-1 downto 0);
    type PIPELINE_TYPE_FOR_YO_PL                is array(0 to 1) of std_logic_vector(5-1 downto 0);
    ...
    signal yo_flopoco : std_logic_vector(5-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in1_m4_1_m4_out1_m4
        port map
        (
            clk, rst, 
            yo_flopoco , 
