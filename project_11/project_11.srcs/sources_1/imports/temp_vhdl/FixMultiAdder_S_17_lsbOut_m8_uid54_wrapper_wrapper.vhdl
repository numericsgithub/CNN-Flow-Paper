...
entity FixMultiAdder_S_17_lsbOut_m8_uid54_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        rst    : in std_logic;
        enable : in std_logic;
        xi_1 : in std_logic_vector(11-1 downto 0); --	sfix(3, -8)
...
end FixMultiAdder_S_17_lsbOut_m8_uid54_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m8_uid54_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m8_uid54_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(19-1 downto 0); --	sfix(11, -8)
    signal xi_1_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m8_uid54_wrapper
        generic map
        (
