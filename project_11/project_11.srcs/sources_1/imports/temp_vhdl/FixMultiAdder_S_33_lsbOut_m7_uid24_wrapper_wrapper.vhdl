...
entity FixMultiAdder_S_33_lsbOut_m7_uid24_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_3 : in std_logic_vector(15-1 downto 0); --	sfix(8, -7)
        ...
        xi_24 : in std_logic_vector(14-1 downto 0); --	sfix(7, -7)
        ...
        xi_32 : in std_logic_vector(11-1 downto 0); --	sfix(4, -7)
        xi_33 : in std_logic_vector(18-1 downto 0); --	sfix(11, -7)
        yo : out std_logic_vector(18-1 downto 0) --	sfix(11, -7)
    );
end FixMultiAdder_S_33_lsbOut_m7_uid24_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid24_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m7_uid24_wrapper_wrapper : entity is "yes";
    ...
    signal xi_3_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(8, -7)
    ...
    signal xi_17_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(7, -7)
    ...
    signal xi_20_reshaped :  std_logic_vector(9-1 downto 0); --	sfix(2, -7)
    ...
    signal xi_24_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(7, -7)
    ...
    signal xi_32_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m7_uid24_wrapper
        generic map
        (
