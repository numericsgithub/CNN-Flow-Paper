...
entity FixMultiAdder_S_5_lsbOut_m9_uid1286_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(25-1 downto 0); --	sfix(16, -9)
        yo : out std_logic_vector(25-1 downto 0) --	sfix(16, -9)
    );
end FixMultiAdder_S_5_lsbOut_m9_uid1286_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m9_uid1286_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_5_lsbOut_m9_uid1286_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(25-1 downto 0); --	sfix(16, -9)
    signal xi_1_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(5, -9)
    ...
    signal xi_5_reshaped :  std_logic_vector(25-1 downto 0); --	sfix(16, -9)
    ...
    subtype DEBUG_TYPE is std_logic_vector(29 downto 0);
    constant allowed_min : integer := -16777216;
    constant allowed_max : integer := 16777215;
...
begin
    ...
    adder : entity work.FixMultiAdder_S_5_lsbOut_m9_uid1286_wrapper
        generic map
        (
