...
entity IntMultiAdder_S_inm3_m12_m1_m12_out0_m12_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_inm3_m12_m1_m12_out0_m12_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_inm3_m12_m1_m12_out0_m12_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_inm3_m12_m1_m12_out0_m12_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(12-1 downto 0); --	sfix(0, -12)
    ...
    subtype DEBUG_TYPE is std_logic_vector(14 downto 0);
    constant allowed_min : integer := -2048;
    constant allowed_max : integer := 2047;
...
begin
    ...
    adder : entity work.IntMultiAdder_S_inm3_m12_m1_m12_out0_m12_wrapper
        generic map
        (
