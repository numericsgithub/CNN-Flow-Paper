...
end FixMultiAdder_S_9_lsbOut_m10_uid160_wrapper;

architecture Behavioral of FixMultiAdder_S_9_lsbOut_m10_uid160_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_9_PL              is array(0 to 1) of std_logic_vector(20-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_9_lsbOut_m10_uid160
        port map
        (
