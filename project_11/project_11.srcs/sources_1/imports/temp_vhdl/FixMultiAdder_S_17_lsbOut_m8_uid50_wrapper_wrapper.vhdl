...
entity FixMultiAdder_S_17_lsbOut_m8_uid50_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_2 : in std_logic_vector(11-1 downto 0); --	sfix(3, -8)
        xi_3 : in std_logic_vector(12-1 downto 0); --	sfix(4, -8)
        xi_4 : in std_logic_vector(14-1 downto 0); --	sfix(6, -8)
        xi_5 : in std_logic_vector(13-1 downto 0); --	sfix(5, -8)
        xi_6 : in std_logic_vector(11-1 downto 0); --	sfix(3, -8)
        ...
        xi_11 : in std_logic_vector(14-1 downto 0); --	sfix(6, -8)
        xi_12 : in std_logic_vector(10-1 downto 0); --	sfix(2, -8)
        ...
        xi_16 : in std_logic_vector(12-1 downto 0); --	sfix(4, -8)
        xi_17 : in std_logic_vector(18-1 downto 0); --	sfix(10, -8)
        yo : out std_logic_vector(18-1 downto 0) --	sfix(10, -8)
    );
end FixMultiAdder_S_17_lsbOut_m8_uid50_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m8_uid50_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m8_uid50_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(18-1 downto 0); --	sfix(10, -8)
    signal xi_1_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(6, -8)
    signal xi_2_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    signal xi_3_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    signal xi_4_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(6, -8)
    signal xi_5_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_6_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    ...
    signal xi_11_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(6, -8)
    signal xi_12_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(2, -8)
    ...
    signal xi_16_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m8_uid50_wrapper
        generic map
        (
