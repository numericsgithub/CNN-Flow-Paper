...
entity conv25_interleaving_fifo_interleaver_and_holder is
    Port (
        clk        : in  std_logic;
        rst        : in  std_logic;
        enable     : in  std_logic;
...
end conv25_interleaving_fifo_interleaver_and_holder;

architecture Behavioral of conv25_interleaving_fifo_interleaver_and_holder is
    constant AMOUNT_OF_MUX_INPUTS : natural := 1;
    constant AMOUNT_OF_HOLD_CYCLES : natural := 8;
...
begin
    ...
    INTERLEAVER: entity work.conv25_interleaving_fifo_interleaver
    ...
    HOLDER: entity work.conv25_interleaving_fifo_holder
    generic map (KEEP_AT_FIRST_RUN => '0')
    port map
    (
        clk => clk,
