...
entity IntMultiAdder_S_in7_m8_8_m8_out9_m8_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in7_m8_8_m8_out9_m8_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in7_m8_8_m8_out9_m8_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in7_m8_8_m8_out9_m8_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(17-1 downto 0); --	sfix(9, -8)
    signal xi_1_reshaped :  std_logic_vector(16-1 downto 0); --	sfix(8, -8)
    signal xi_2_reshaped :  std_logic_vector(16-1 downto 0); --	sfix(8, -8)
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in7_m8_8_m8_out9_m8_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(8, -8)
            xi_2_reshaped, --	sfix(8, -8)
            yo_signal
        );
