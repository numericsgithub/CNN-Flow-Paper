...
entity FixMultiAdder_S_33_lsbOut_m7_uid20_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(13-1 downto 0); --	sfix(6, -7)
        xi_6 : in std_logic_vector(14-1 downto 0); --	sfix(7, -7)
        xi_7 : in std_logic_vector(11-1 downto 0); --	sfix(4, -7)
        xi_8 : in std_logic_vector(11-1 downto 0); --	sfix(4, -7)
        ...
        xi_13 : in std_logic_vector(10-1 downto 0); --	sfix(3, -7)
        xi_14 : in std_logic_vector(11-1 downto 0); --	sfix(4, -7)
        xi_15 : in std_logic_vector(8-1 downto 0); --	sfix(1, -7)
        xi_16 : in std_logic_vector(13-1 downto 0); --	sfix(6, -7)
        xi_17 : in std_logic_vector(10-1 downto 0); --	sfix(3, -7)
        xi_18 : in std_logic_vector(10-1 downto 0); --	sfix(3, -7)
        xi_19 : in std_logic_vector(10-1 downto 0); --	sfix(3, -7)
        xi_20 : in std_logic_vector(14-1 downto 0); --	sfix(7, -7)
        xi_21 : in std_logic_vector(8-1 downto 0); --	sfix(1, -7)
        xi_22 : in std_logic_vector(14-1 downto 0); --	sfix(7, -7)
        ...
        xi_33 : in std_logic_vector(19-1 downto 0); --	sfix(12, -7)
        yo : out std_logic_vector(19-1 downto 0) --	sfix(12, -7)
    );
end FixMultiAdder_S_33_lsbOut_m7_uid20_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid20_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m7_uid20_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(19-1 downto 0); --	sfix(12, -7)
    ...
    signal xi_5_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(6, -7)
    signal xi_6_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(7, -7)
    signal xi_7_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    signal xi_8_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    ...
    signal xi_12_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(8, -7)
    signal xi_13_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    ...
    signal xi_16_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(6, -7)
    signal xi_17_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    signal xi_18_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    signal xi_19_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    signal xi_20_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(7, -7)
    signal xi_21_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(1, -7)
    signal xi_22_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(7, -7)
    ...
    signal xi_25_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    ...
    signal xi_33_reshaped :  std_logic_vector(19-1 downto 0); --	sfix(12, -7)
    ...
    subtype DEBUG_TYPE is std_logic_vector(23 downto 0);
    constant allowed_min : integer := -262144;
    constant allowed_max : integer := 262143;
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m7_uid20_wrapper
        generic map
        (
        ...
        (
            ...
            xi_5_reshaped, --	sfix(6, -7)
            xi_6_reshaped, --	sfix(7, -7)
            xi_7_reshaped, --	sfix(4, -7)
            xi_8_reshaped, --	sfix(4, -7)
            xi_9_reshaped, --	sfix(1, -7)
            xi_10_reshaped, --	sfix(1, -7)
            xi_11_reshaped, --	sfix(1, -7)
            xi_12_reshaped, --	sfix(8, -7)
            xi_13_reshaped, --	sfix(3, -7)
            xi_14_reshaped, --	sfix(4, -7)
            xi_15_reshaped, --	sfix(1, -7)
            xi_16_reshaped, --	sfix(6, -7)
            xi_17_reshaped, --	sfix(3, -7)
            xi_18_reshaped, --	sfix(3, -7)
            xi_19_reshaped, --	sfix(3, -7)
            xi_20_reshaped, --	sfix(7, -7)
            xi_21_reshaped, --	sfix(1, -7)
            xi_22_reshaped, --	sfix(7, -7)
            xi_23_reshaped, --	sfix(1, -7)
            xi_24_reshaped, --	sfix(4, -7)
            xi_25_reshaped, --	sfix(3, -7)
