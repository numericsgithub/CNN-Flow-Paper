...
entity IntMultiAdder_S_in5_m3_16_m9_out16_m9_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        rst    : in std_logic;
        enable : in std_logic;
        xi_1 : in std_logic_vector(8-1 downto 0); --	sfix(5, -3)
        xi_2 : in std_logic_vector(25-1 downto 0); --	sfix(16, -9)
        yo : out std_logic_vector(25-1 downto 0) --	sfix(16, -9)
    );
end IntMultiAdder_S_in5_m3_16_m9_out16_m9_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in5_m3_16_m9_out16_m9_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in5_m3_16_m9_out16_m9_wrapper_wrapper : entity is "yes";
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in5_m3_16_m9_out16_m9_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(16, -9)
            xi_2_reshaped, --	sfix(16, -9)
            yo_signal
        );
