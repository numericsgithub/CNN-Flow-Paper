...
entity FixMultiAdder_S_4_lsbOut_m12_uid3_wrapper_wrapper is
    generic
    (
        ADDER_LOCATION                       : string  := "not specified";
        PIPELINE_STEPS                       : natural := 1;
    ...
    (
        ...
        rst    : in std_logic;
        enable : in std_logic;
        xi_1 : in std_logic_vector(18-1 downto 0); --	sfix(6, -12)
        xi_2 : in std_logic_vector(19-1 downto 0); --	sfix(7, -12)
        xi_3 : in std_logic_vector(20-1 downto 0); --	sfix(8, -12)
        xi_4 : in std_logic_vector(22-1 downto 0); --	sfix(10, -12)
        yo : out std_logic_vector(22-1 downto 0) --	sfix(10, -12)
    );
end FixMultiAdder_S_4_lsbOut_m12_uid3_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_4_lsbOut_m12_uid3_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_4_lsbOut_m12_uid3_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(22-1 downto 0); --	sfix(10, -12)
    signal xi_1_reshaped :  std_logic_vector(18-1 downto 0); --	sfix(6, -12)
    signal xi_2_reshaped :  std_logic_vector(19-1 downto 0); --	sfix(7, -12)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_4_lsbOut_m12_uid3_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(6, -12)
            xi_2_reshaped, --	sfix(7, -12)
            xi_3_reshaped, --	sfix(8, -12)
            xi_4_reshaped, --	sfix(10, -12)
            yo_signal
        );
    ...
    yo_debug <= xi_1_resized_debug  + xi_2_resized_debug  + xi_3_resized_debug  + xi_4_resized_debug ;
