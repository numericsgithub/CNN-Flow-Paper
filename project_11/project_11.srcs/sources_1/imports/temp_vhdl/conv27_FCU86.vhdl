...
architecture structural of conv27_FCU86 is
...
begin
    ...
    accumulation : entity work.FixMultiAdder_S_5_lsbOut_m9_uid1252_wrapper_wrapper generic map(ADDER_LOCATION => "conv27_FCU86", PIPELINE_STEPS => PIPELINE_STEPS-1, ADDITIONAL_PIPELINE_STEP_AT_OUTPUT => TRUE)
        port map
        (
            clk, '0', buffer_enable,
            xi_1,
