...
architecture Behavioral of conv20 is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of conv20 : entity is "yes";
    ...
    type PIPELINE_TYPE_FOR_LAYER_YO_2_UNCLIPPED is array(0 to 0) of std_logic_vector(12-1 downto 0);
...
-- # # # OUT: y_is_valid_signal, pad_[3], big_buffer_delay_counter_signal, small_buffer_delay_counter_signal, interleave_counter_signal, buffer_enable_signal
    ...
    sliding_window_ctrl : entity work.conv20_SlidingWindowController
        port map
        (
            clk,
            reset,
...
-- SAVE THIS SHIT
    ...
    conv_core1 : entity work.conv20_core1
        generic map
        (
    ...
    conv_core2 : entity work.conv20_core2
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
...
-- Add a pipeline step
    ...
    core_1_KPU_1 : entity work.conv20_core1_KPU1
        generic map
        (
        ...
        (
            ...
            core_1_kpu_1_input_1(0), --	sfix(4, -10)
            core_1_kpu_1_input_2(0), --	sfix(4, -10)
            core_1_kpu_1_input_3(0), --	sfix(3, -10)
            core_1_kpu_1_input_4(0), --	sfix(4, -10)
            core_1_kpu_1_input_5(0), --	sfix(5, -10)
            core_1_kpu_1_input_6(0), --	sfix(4, -10)
            core_1_kpu_1_input_7(0), --	sfix(4, -10)
            core_1_kpu_1_input_8(0), --	sfix(4, -10)
    ...
    core_2_KPU_1 : entity work.conv20_core2_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_2_kpu_1_input_1(0), --	sfix(4, -10)
            core_2_kpu_1_input_2(0), --	sfix(5, -10)
            core_2_kpu_1_input_3(0), --	sfix(4, -10)
            core_2_kpu_1_input_4(0), --	sfix(4, -10)
...
-- Add a pipeline step after the accumulator
    ...
    bias_add : entity work.conv20_bias_add
        Port map (
            clk,
...
-- Add a pipeline step
    ...
    simulation_validation: entity work.conv20_sim_validator
        Port map (
            clk,
            reset,
            layer_xi_1, --	ufix(2, -5)
