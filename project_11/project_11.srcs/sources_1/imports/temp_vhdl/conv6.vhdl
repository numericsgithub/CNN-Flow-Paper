...
architecture Behavioral of conv6 is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of conv6 : entity is "yes";
    ...
    type PIPELINE_TYPE_FOR_CORE_3_KPU_1_INPUT_1 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_3_KPU_1_INPUT_8 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_4_KPU_1_INPUT_2 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_5 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_6 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_9 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_4 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_5 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_6 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_7 is array(0 to 0) of std_logic_vector(12-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_8 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_9 is array(0 to 0) of std_logic_vector(12-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_1 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_2 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_3 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_6 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_1 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_2 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_3 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_4 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_5 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_6 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_7 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_8 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_9 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_SIGNAL_CORE_5_YO_1   is array(0 to 0) of std_logic_vector(18-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_SIGNAL_CORE_8_YO_1   is array(0 to 0) of std_logic_vector(18-1 downto 0);
    ...
    -- The one std_logic_vector to delay
    subtype CORE_1_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(100-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_3_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(35-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_3_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(100-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_4_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(33-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_4_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(93-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_5_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(35-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_5_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(100-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_6_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(95-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_7_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(102-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_8_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(36-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_8_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(102-1 downto 0);
...
-- # # # OUT: y_is_valid_signal, pad_[3], big_buffer_delay_counter_signal, small_buffer_delay_counter_signal, interleave_counter_signal, buffer_enable_signal
    ...
    sliding_window_ctrl : entity work.conv6_SlidingWindowController
        port map
        (
            clk,
            reset,
...
-- SAVE THIS SHIT
    ...
    conv_core1 : entity work.conv6_core1
        generic map
        (
    ...
    conv_core2 : entity work.conv6_core2
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core3 : entity work.conv6_core3
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core4 : entity work.conv6_core4
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core5 : entity work.conv6_core5
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core6 : entity work.conv6_core6
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core7 : entity work.conv6_core7
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core8 : entity work.conv6_core8
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
...
-- Add a pipeline step
    ...
    core_1_KPU_1 : entity work.conv6_core1_KPU1
        generic map
        (
        ...
        (
            ...
            core_1_concat_small_undelayed_array(49-1 downto 32),
            core_1_concat_small_delayed_array(49-1 downto 32),
            core_1_concat_small_undelayed_array(66-1 downto 49),
            core_1_concat_small_delayed_array(66-1 downto 49),
            core_1_concat_small_undelayed_array(83-1 downto 66),
            core_1_concat_small_delayed_array(83-1 downto 66),
            core_1_concat_small_undelayed_array(100-1 downto 83),
            core_1_concat_small_delayed_array(100-1 downto 83),
    ...
    core_2_KPU_1 : entity work.conv6_core2_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            core_2_kpu_1_input_4(0), --	sfix(7, -8)
            core_2_kpu_1_input_5(0), --	sfix(7, -8)
            core_2_kpu_1_input_6(0), --	sfix(6, -8)
    ...
    core_3_KPU_1 : entity work.conv6_core3_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_3_kpu_1_input_1(0), --	sfix(6, -8)
            core_3_kpu_1_input_2(0), --	sfix(7, -8)
            ...
            core_3_kpu_1_input_8(0), --	sfix(7, -8)
            core_3_kpu_1_input_9(0), --	sfix(5, -8)

        
            core_3_concat_big_undelayed_array(17-1 downto 0),
            core_3_concat_big_delayed_array(17-1 downto 0),
            core_3_concat_big_undelayed_array(35-1 downto 17),
            core_3_concat_big_delayed_array(35-1 downto 17),

        
            core_3_concat_small_undelayed_array(14-1 downto 0),
            core_3_concat_small_delayed_array(14-1 downto 0),
            core_3_concat_small_undelayed_array(30-1 downto 14),
            core_3_concat_small_delayed_array(30-1 downto 14),
            core_3_concat_small_undelayed_array(47-1 downto 30),
            core_3_concat_small_delayed_array(47-1 downto 30),
            core_3_concat_small_undelayed_array(64-1 downto 47),
            core_3_concat_small_delayed_array(64-1 downto 47),
            core_3_concat_small_undelayed_array(82-1 downto 64),
            core_3_concat_small_delayed_array(82-1 downto 64),
            core_3_concat_small_undelayed_array(100-1 downto 82),
            core_3_concat_small_delayed_array(100-1 downto 82),
    ...
    core_4_KPU_1 : entity work.conv6_core4_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_4_kpu_1_input_1(0), --	sfix(4, -8)
            core_4_kpu_1_input_2(0), --	sfix(5, -8)
            ...
            core_4_concat_big_undelayed_array(16-1 downto 0),
            core_4_concat_big_delayed_array(16-1 downto 0),
            core_4_concat_big_undelayed_array(33-1 downto 16),
            core_4_concat_big_delayed_array(33-1 downto 16),
            ...
            core_4_concat_small_undelayed_array(59-1 downto 42),
            core_4_concat_small_delayed_array(59-1 downto 42),
            core_4_concat_small_undelayed_array(76-1 downto 59),
            core_4_concat_small_delayed_array(76-1 downto 59),
            core_4_concat_small_undelayed_array(93-1 downto 76),
            core_4_concat_small_delayed_array(93-1 downto 76),
    ...
    core_5_KPU_1 : entity work.conv6_core5_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            core_5_kpu_1_input_2(0), --	sfix(6, -8)
            core_5_kpu_1_input_3(0), --	sfix(6, -8)
            core_5_kpu_1_input_4(0), --	sfix(6, -8)
            core_5_kpu_1_input_5(0), --	sfix(7, -8)
            core_5_kpu_1_input_6(0), --	sfix(7, -8)
            core_5_kpu_1_input_7(0), --	sfix(6, -8)
            core_5_kpu_1_input_8(0), --	sfix(5, -8)
            core_5_kpu_1_input_9(0), --	sfix(6, -8)

        
            core_5_concat_big_undelayed_array(17-1 downto 0),
            core_5_concat_big_delayed_array(17-1 downto 0),
            core_5_concat_big_undelayed_array(35-1 downto 17),
            core_5_concat_big_delayed_array(35-1 downto 17),
            ...
            core_5_concat_small_undelayed_array(82-1 downto 64),
            core_5_concat_small_delayed_array(82-1 downto 64),
            core_5_concat_small_undelayed_array(100-1 downto 82),
            core_5_concat_small_delayed_array(100-1 downto 82),
    ...
    core_6_KPU_1 : entity work.conv6_core6_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            core_6_kpu_1_input_2(0), --	sfix(6, -8)
            core_6_kpu_1_input_3(0), --	sfix(5, -8)
            core_6_kpu_1_input_4(0), --	sfix(6, -8)
            core_6_kpu_1_input_5(0), --	sfix(7, -8)
            core_6_kpu_1_input_6(0), --	sfix(6, -8)
            core_6_kpu_1_input_7(0), --	sfix(4, -8)
            core_6_kpu_1_input_8(0), --	sfix(5, -8)
            core_6_kpu_1_input_9(0), --	sfix(4, -8)
            ...
            core_6_concat_small_undelayed_array(44-1 downto 28),
            core_6_concat_small_delayed_array(44-1 downto 28),
            core_6_concat_small_undelayed_array(61-1 downto 44),
            core_6_concat_small_delayed_array(61-1 downto 44),
            core_6_concat_small_undelayed_array(78-1 downto 61),
            core_6_concat_small_delayed_array(78-1 downto 61),
            core_6_concat_small_undelayed_array(95-1 downto 78),
            core_6_concat_small_delayed_array(95-1 downto 78),
    ...
    core_7_KPU_1 : entity work.conv6_core7_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_7_kpu_1_input_1(0), --	sfix(6, -8)
            core_7_kpu_1_input_2(0), --	sfix(7, -8)
            core_7_kpu_1_input_3(0), --	sfix(5, -8)
            core_7_kpu_1_input_4(0), --	sfix(7, -8)
            core_7_kpu_1_input_5(0), --	sfix(7, -8)
            core_7_kpu_1_input_6(0), --	sfix(5, -8)
            core_7_kpu_1_input_7(0), --	sfix(6, -8)
            core_7_kpu_1_input_8(0), --	sfix(6, -8)
            core_7_kpu_1_input_9(0), --	sfix(5, -8)
            ...
            core_7_concat_small_undelayed_array(14-1 downto 0),
            core_7_concat_small_delayed_array(14-1 downto 0),
            core_7_concat_small_undelayed_array(30-1 downto 14),
            core_7_concat_small_delayed_array(30-1 downto 14),
            core_7_concat_small_undelayed_array(48-1 downto 30),
            core_7_concat_small_delayed_array(48-1 downto 30),
            core_7_concat_small_undelayed_array(66-1 downto 48),
            core_7_concat_small_delayed_array(66-1 downto 48),
            core_7_concat_small_undelayed_array(84-1 downto 66),
            core_7_concat_small_delayed_array(84-1 downto 66),
            core_7_concat_small_undelayed_array(102-1 downto 84),
            core_7_concat_small_delayed_array(102-1 downto 84),
    ...
    core_8_KPU_1 : entity work.conv6_core8_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_8_kpu_1_input_1(0), --	sfix(6, -8)
            core_8_kpu_1_input_2(0), --	sfix(7, -8)
            core_8_kpu_1_input_3(0), --	sfix(5, -8)
            core_8_kpu_1_input_4(0), --	sfix(6, -8)
            core_8_kpu_1_input_5(0), --	sfix(7, -8)
            core_8_kpu_1_input_6(0), --	sfix(7, -8)
            core_8_kpu_1_input_7(0), --	sfix(5, -8)
            core_8_kpu_1_input_8(0), --	sfix(5, -8)
            core_8_kpu_1_input_9(0), --	sfix(6, -8)

        
            core_8_concat_big_undelayed_array(18-1 downto 0),
            core_8_concat_big_delayed_array(18-1 downto 0),
            core_8_concat_big_undelayed_array(36-1 downto 18),
            core_8_concat_big_delayed_array(36-1 downto 18),

        
            core_8_concat_small_undelayed_array(14-1 downto 0),
            core_8_concat_small_delayed_array(14-1 downto 0),
            core_8_concat_small_undelayed_array(30-1 downto 14),
            core_8_concat_small_delayed_array(30-1 downto 14),
            core_8_concat_small_undelayed_array(48-1 downto 30),
            core_8_concat_small_delayed_array(48-1 downto 30),
            core_8_concat_small_undelayed_array(66-1 downto 48),
            core_8_concat_small_delayed_array(66-1 downto 48),
            core_8_concat_small_undelayed_array(84-1 downto 66),
            core_8_concat_small_delayed_array(84-1 downto 66),
            core_8_concat_small_undelayed_array(102-1 downto 84),
            core_8_concat_small_delayed_array(102-1 downto 84),
...
-- Add a pipeline step after the accumulator
    ...
    bias_add : entity work.conv6_bias_add
        Port map (
            clk,
...
-- Add a pipeline step
    ...
    simulation_validation: entity work.conv6_sim_validator
        Port map (
            clk,
            reset,
            layer_xi_1, --	ufix(4, -3)
