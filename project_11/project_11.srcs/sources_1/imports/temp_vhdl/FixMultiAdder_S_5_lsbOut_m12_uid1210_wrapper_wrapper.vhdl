...
-- 	sfix(2, -12)
-- 	sfix(13, -12)
-- Output is: sfix(13, -12)

entity FixMultiAdder_S_5_lsbOut_m12_uid1210_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(25-1 downto 0); --	sfix(13, -12)
        yo : out std_logic_vector(25-1 downto 0) --	sfix(13, -12)
    );
end FixMultiAdder_S_5_lsbOut_m12_uid1210_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m12_uid1210_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_5_lsbOut_m12_uid1210_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(25-1 downto 0); --	sfix(13, -12)
    ...
    signal xi_5_reshaped :  std_logic_vector(25-1 downto 0); --	sfix(13, -12)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_5_lsbOut_m12_uid1210_wrapper
        generic map
        (
