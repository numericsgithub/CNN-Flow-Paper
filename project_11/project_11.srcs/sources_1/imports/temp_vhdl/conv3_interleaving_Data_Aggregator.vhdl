...
package conv3_interleaving_Data_Aggregator_pkg is
    type conv3_interleaving_Data_Aggregator_output is array(32-1 downto 0) of std_logic_vector(7-1 downto 0);
end package;
...
entity conv3_interleaving_Data_Aggregator is
    Port (
        ...
        output_array   : out conv3_interleaving_Data_Aggregator_output;
        valid_out      : out std_logic
    );
end conv3_interleaving_Data_Aggregator;

architecture Behavioral of conv3_interleaving_Data_Aggregator is
    constant AMOUNT_OF_INPUTS : natural := 8;

    signal output_is_valid      : std_logic;                         -- Interne Valid-Flag für den Output
    signal output_array_signal  : conv3_interleaving_Data_Aggregator_output;          -- Zwischenspeicher für 8 Daten
