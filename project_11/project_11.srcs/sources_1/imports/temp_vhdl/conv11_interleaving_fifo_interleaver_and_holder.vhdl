...
entity conv11_interleaving_fifo_interleaver_and_holder is
    Port (
        clk        : in  std_logic;
        rst        : in  std_logic;
        enable     : in  std_logic;
...
end conv11_interleaving_fifo_interleaver_and_holder;

architecture Behavioral of conv11_interleaving_fifo_interleaver_and_holder is
...
begin
    ...
    INTERLEAVER: entity work.conv11_interleaving_fifo_interleaver
    ...
    HOLDER: entity work.conv11_interleaving_fifo_holder
    generic map (KEEP_AT_FIRST_RUN => '0')
    port map
    (
        clk => clk,
