...
architecture Behavioral of conv16 is
    ...
    attribute KEEP_HIERARCHY of conv16 : entity is "yes";
    ...
    type PIPELINE_TYPE_FOR_SIGNAL_CORE_1_YO_1   is array(0 to 0) of std_logic_vector(18-1 downto 0);
    ...
    subtype CORE_1_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(35-1 downto 0);
    ...
    -- The one std_logic_vector to delay
    subtype CORE_1_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(101-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_2_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(100-1 downto 0);
...
-- # # # OUT: y_is_valid_signal, pad_[3], big_buffer_delay_counter_signal, small_buffer_delay_counter_signal, interleave_counter_signal, buffer_enable_signal
    ...
    sliding_window_ctrl : entity work.conv16_SlidingWindowController
        port map
        (
            clk,
            reset,
...
-- # # # IN:  layer_xi[2] y_is_valid_signal, pad_[3], big_buffer_delay_counter_signal(0), small_buffer_delay_counter_signal(0), interleave_counter_signal(0)
-- # # # OUT: signal_core_[]_yo_2
...
-- Add a pipeline step
    ...
    PL_STEP_0_for_layer_xi_2_signal: entity work.Pipe_Vector PORT MAP(clk, '1', layer_xi_2_signal(0), layer_xi_2_signal(1)); -- This is always needed. The sliding window controller forces this.
-- Add a pipeline step
...
-- SAVE THIS SHIT
    ...
    conv_core1 : entity work.conv16_core1
        generic map
        (
    ...
    conv_core2 : entity work.conv16_core2
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
...
-- Add a pipeline step
    ...
    core_1_KPU_1 : entity work.conv16_core1_KPU1
        generic map
        (
        ...
        (
            ...
            core_1_kpu_1_input_1(0), --	sfix(5, -9)
            core_1_kpu_1_input_2(0), --	sfix(6, -9)
            core_1_kpu_1_input_3(0), --	sfix(5, -9)
            core_1_kpu_1_input_4(0), --	sfix(6, -9)
            core_1_kpu_1_input_5(0), --	sfix(6, -9)
            core_1_kpu_1_input_6(0), --	sfix(6, -9)
            core_1_kpu_1_input_7(0), --	sfix(5, -9)
            core_1_kpu_1_input_8(0), --	sfix(5, -9)
            core_1_kpu_1_input_9(0), --	sfix(4, -9)

        
            core_1_concat_big_undelayed_array(17-1 downto 0),
            core_1_concat_big_delayed_array(17-1 downto 0),
            core_1_concat_big_undelayed_array(35-1 downto 17),
            core_1_concat_big_delayed_array(35-1 downto 17),
            ...
            core_1_concat_small_undelayed_array(65-1 downto 47),
            core_1_concat_small_delayed_array(65-1 downto 47),
            core_1_concat_small_undelayed_array(83-1 downto 65),
            core_1_concat_small_delayed_array(83-1 downto 65),
            core_1_concat_small_undelayed_array(101-1 downto 83),
            core_1_concat_small_delayed_array(101-1 downto 83),
    ...
    core_2_KPU_1 : entity work.conv16_core2_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_2_kpu_1_input_1(0), --	sfix(4, -9)
            core_2_kpu_1_input_2(0), --	sfix(6, -9)
            core_2_kpu_1_input_3(0), --	sfix(5, -9)
            core_2_kpu_1_input_4(0), --	sfix(6, -9)
            core_2_kpu_1_input_5(0), --	sfix(6, -9)
            core_2_kpu_1_input_6(0), --	sfix(5, -9)
            core_2_kpu_1_input_7(0), --	sfix(5, -9)
            core_2_kpu_1_input_8(0), --	sfix(5, -9)
            core_2_kpu_1_input_9(0), --	sfix(5, -9)
            ...
            core_2_concat_small_undelayed_array(46-1 downto 28),
            core_2_concat_small_delayed_array(46-1 downto 28),
            core_2_concat_small_undelayed_array(64-1 downto 46),
            core_2_concat_small_delayed_array(64-1 downto 46),
            core_2_concat_small_undelayed_array(82-1 downto 64),
            core_2_concat_small_delayed_array(82-1 downto 64),
            core_2_concat_small_undelayed_array(100-1 downto 82),
            core_2_concat_small_delayed_array(100-1 downto 82),
...
-- Add a pipeline step after the accumulator
    ...
    bias_add : entity work.conv16_bias_add
        Port map (
            clk,
...
-- Add a pipeline step
    ...
    simulation_validation: entity work.conv16_sim_validator
        Port map (
            clk,
            reset,
            layer_xi_1, --	ufix(3, -4)
