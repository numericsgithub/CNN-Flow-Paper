...
entity FixMultiAdder_S_33_lsbOut_m7_uid22_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_14 : in std_logic_vector(12-1 downto 0); --	sfix(5, -7)
        xi_15 : in std_logic_vector(8-1 downto 0); --	sfix(1, -7)
        xi_16 : in std_logic_vector(9-1 downto 0); --	sfix(2, -7)
        ...
        xi_20 : in std_logic_vector(15-1 downto 0); --	sfix(8, -7)
...
end FixMultiAdder_S_33_lsbOut_m7_uid22_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid22_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m7_uid22_wrapper_wrapper : entity is "yes";
    ...
    signal xi_14_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(5, -7)
    signal xi_15_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(1, -7)
    signal xi_16_reshaped :  std_logic_vector(9-1 downto 0); --	sfix(2, -7)
    ...
    signal xi_20_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(8, -7)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m7_uid22_wrapper
        generic map
        (
