...
entity FixMultiAdder_S_5_lsbOut_m12_uid388_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(18-1 downto 0); --	sfix(6, -12)
        yo : out std_logic_vector(18-1 downto 0) --	sfix(6, -12)
    );
end FixMultiAdder_S_5_lsbOut_m12_uid388_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m12_uid388_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_5_lsbOut_m12_uid388_wrapper_wrapper : entity is "yes";
    ...
    signal xi_3_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(1, -12)
    signal xi_4_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(2, -12)
    signal xi_5_reshaped :  std_logic_vector(18-1 downto 0); --	sfix(6, -12)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_5_lsbOut_m12_uid388_wrapper
        generic map
        (
        ...
        (
            ...
            xi_3_reshaped, --	sfix(1, -12)
            xi_4_reshaped, --	sfix(2, -12)
            xi_5_reshaped, --	sfix(6, -12)
            yo_signal
        );
