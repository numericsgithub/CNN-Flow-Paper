...
entity IntMultiAdder_S_in6_m2_13_m7_out13_m7_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(20-1 downto 0); --	sfix(13, -7)
        xi_2 : in std_logic_vector(20-1 downto 0); --	sfix(13, -7)
        yo  : out std_logic_vector(20-1 downto 0) --	sfix(13, -7)
    );
end IntMultiAdder_S_in6_m2_13_m7_out13_m7_wrapper;

architecture Behavioral of IntMultiAdder_S_in6_m2_13_m7_out13_m7_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in6_m2_13_m7_out13_m7
        port map
        (
            clk, rst, 
            yo_flopoco , 
