...
entity conv15_interleaving_fifo_fifo_flusher is
    Port (
        clk    : in std_logic;
        rst    : in std_logic;
        enable : in std_logic;
...
end conv15_interleaving_fifo_fifo_flusher;

architecture Behavioral of conv15_interleaving_fifo_fifo_flusher is
