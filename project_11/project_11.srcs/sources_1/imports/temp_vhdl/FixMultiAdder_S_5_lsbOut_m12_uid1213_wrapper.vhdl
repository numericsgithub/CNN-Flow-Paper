...
end FixMultiAdder_S_5_lsbOut_m12_uid1213_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m12_uid1213_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_5_PL              is array(0 to 1) of std_logic_vector(26-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_5_lsbOut_m12_uid1213
        port map
        (
