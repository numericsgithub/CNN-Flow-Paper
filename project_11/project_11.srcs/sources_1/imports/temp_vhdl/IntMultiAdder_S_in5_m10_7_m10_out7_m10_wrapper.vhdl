...
entity IntMultiAdder_S_in5_m10_7_m10_out7_m10_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(17-1 downto 0); --	sfix(7, -10)
        xi_2 : in std_logic_vector(17-1 downto 0); --	sfix(7, -10)
        yo  : out std_logic_vector(17-1 downto 0) --	sfix(7, -10)
    );
end IntMultiAdder_S_in5_m10_7_m10_out7_m10_wrapper;

architecture Behavioral of IntMultiAdder_S_in5_m10_7_m10_out7_m10_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in5_m10_7_m10_out7_m10
        port map
        (
            clk, rst, 
            yo_flopoco , 
