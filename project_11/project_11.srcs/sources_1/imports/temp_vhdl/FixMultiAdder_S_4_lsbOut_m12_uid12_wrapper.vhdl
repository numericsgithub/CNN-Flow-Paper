...
end FixMultiAdder_S_4_lsbOut_m12_uid12_wrapper;

architecture Behavioral of FixMultiAdder_S_4_lsbOut_m12_uid12_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_3_PL              is array(0 to 1) of std_logic_vector(19-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_4_PL              is array(0 to 1) of std_logic_vector(21-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_4_lsbOut_m12_uid12
        port map
        (
            clk, rst,  enable,
            yo_flopoco , 
