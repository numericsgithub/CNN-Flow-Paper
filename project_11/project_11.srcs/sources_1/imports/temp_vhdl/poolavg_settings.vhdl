...
package poolavg_settings is
    constant AMOUNT_OF_UNITS_PER_CORE : NATURAL := 1; -- Amount of KPUs/PPUs/FCUs per core
    constant AMOUNT_OF_UNITS_IN_LAYER : NATURAL := 1; -- Total amount of KPUs/PPUs/FCUs
    constant AMOUNT_OF_LAYER_INPUTS   : NATURAL := 1; -- Amount of input signals
    constant AMOUNT_OF_LAYER_OUTPUTS  : NATURAL := 1; -- Amount of output signals
    constant XI_WIDTH : NATURAL := 7;
    subtype XI_TYPE is std_logic_vector((XI_WIDTH-1) downto 0);

    constant WI_WIDTH : NATURAL := 9;
    ...
    constant CONFIGURATIONS : NATURAL := 1024;
    ...
    constant KERNEL_SIZE : NATURAL := 7;
    constant FEATURE_MAP_SIZE : NATURAL := 7;
    constant STRIDE : NATURAL := 7;
