...
architecture Behavioral of conv2_bias_add is
...
begin
    BIAS_ROM: entity work.conv2_bias_add_constant_memory
        generic map
        (
            XI_WIDTH        	          => BIAS_WIDTH,
            ARRAY_SIZE                    => 4,
    ...
    adder_1 : entity work.IntMultiAdder_S_in4_m4_14_m4_out14_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv2_bias_add" & "_1")
        port map
        (
            clk,
            '0',
    ...
    adder_2 : entity work.IntMultiAdder_S_in4_m4_14_m4_out14_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv2_bias_add" & "_2")
        port map
        (
            clk,
            '0',
    ...
    adder_3 : entity work.IntMultiAdder_S_in4_m4_14_m4_out14_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv2_bias_add" & "_3")
        port map
        (
            clk,
            '0',
    ...
    adder_4 : entity work.IntMultiAdder_S_in4_m4_14_m4_out14_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv2_bias_add" & "_4")
        port map
        (
            clk,
            '0',
    ...
    adder_5 : entity work.IntMultiAdder_S_in4_m4_14_m4_out14_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv2_bias_add" & "_5")
        port map
        (
            clk,
            '0',
    ...
    adder_6 : entity work.IntMultiAdder_S_in4_m4_14_m4_out14_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv2_bias_add" & "_6")
        port map
        (
            clk,
            '0',
    ...
    adder_7 : entity work.IntMultiAdder_S_in4_m4_14_m4_out14_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv2_bias_add" & "_7")
        port map
        (
            clk,
            '0',
    ...
    adder_8 : entity work.IntMultiAdder_S_in4_m4_14_m4_out14_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv2_bias_add" & "_8")
        port map
        (
            clk,
            '0',
