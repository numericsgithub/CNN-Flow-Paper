...
entity conv4_core16_rmcm_weightsconstant_memoryROM is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv4_core16_rmcm_weightsconstant_memoryROM;

architecture Behavioral of conv4_core16_rmcm_weightsconstant_memoryROM is
	...
	constant data_ROM : ROM_TYPE := (
	    ...
	    0 => w(1,1,0,1,1,0,0,0,0),
	    1 => w(0,1,1,0,1,1,0,-1,-1),
	    2 => w(-7,0,7,-9,1,8,-2,1,1),
	    3 => w(0,0,0,1,1,0,0,1,0)
        );
