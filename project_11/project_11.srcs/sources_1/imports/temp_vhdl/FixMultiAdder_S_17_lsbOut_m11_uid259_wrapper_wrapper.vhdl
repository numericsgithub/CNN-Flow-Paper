...
entity FixMultiAdder_S_17_lsbOut_m11_uid259_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_4 : in std_logic_vector(15-1 downto 0); --	sfix(4, -11)
        ...
        xi_8 : in std_logic_vector(15-1 downto 0); --	sfix(4, -11)
        xi_9 : in std_logic_vector(14-1 downto 0); --	sfix(3, -11)
        xi_10 : in std_logic_vector(15-1 downto 0); --	sfix(4, -11)
        ...
        xi_15 : in std_logic_vector(15-1 downto 0); --	sfix(4, -11)
...
end FixMultiAdder_S_17_lsbOut_m11_uid259_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m11_uid259_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m11_uid259_wrapper_wrapper : entity is "yes";
    ...
    signal xi_4_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(4, -11)
    ...
    signal xi_8_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(4, -11)
    signal xi_9_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_10_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(4, -11)
    signal xi_11_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_12_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(2, -11)
    signal xi_13_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_14_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_15_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(4, -11)
    signal xi_16_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m11_uid259_wrapper
        generic map
        (
        ...
        (
            ...
            xi_4_reshaped, --	sfix(4, -11)
            xi_5_reshaped, --	sfix(3, -11)
            xi_6_reshaped, --	sfix(3, -11)
            xi_7_reshaped, --	sfix(2, -11)
            xi_8_reshaped, --	sfix(4, -11)
            xi_9_reshaped, --	sfix(3, -11)
            xi_10_reshaped, --	sfix(4, -11)
            xi_11_reshaped, --	sfix(3, -11)
            xi_12_reshaped, --	sfix(2, -11)
            xi_13_reshaped, --	sfix(3, -11)
            xi_14_reshaped, --	sfix(3, -11)
            xi_15_reshaped, --	sfix(4, -11)
            xi_16_reshaped, --	sfix(3, -11)
