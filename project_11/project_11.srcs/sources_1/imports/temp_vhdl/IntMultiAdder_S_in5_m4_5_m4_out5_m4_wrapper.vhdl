...
entity IntMultiAdder_S_in5_m4_5_m4_out5_m4_wrapper is
    generic
    (
    ...
    Port (
        ...
        yo  : out std_logic_vector(9-1 downto 0) --	sfix(5, -4)
    );
end IntMultiAdder_S_in5_m4_5_m4_out5_m4_wrapper;

architecture Behavioral of IntMultiAdder_S_in5_m4_5_m4_out5_m4_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in5_m4_5_m4_out5_m4
        port map
        (
            clk, rst, 
            yo_flopoco , 
