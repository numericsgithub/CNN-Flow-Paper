...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=950 name=entity_place_holder_name IntMultiAdder signedIn=True n=2 wIn=15 wOut=18

entity IntMultiAdder_S_in4_m8_7_m8_out10_m8_wrapper is
    generic
    (
...
end IntMultiAdder_S_in4_m8_7_m8_out10_m8_wrapper;

architecture Behavioral of IntMultiAdder_S_in4_m8_7_m8_out10_m8_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in4_m8_7_m8_out10_m8
        port map
        (
            clk, rst, 
            yo_flopoco , 
