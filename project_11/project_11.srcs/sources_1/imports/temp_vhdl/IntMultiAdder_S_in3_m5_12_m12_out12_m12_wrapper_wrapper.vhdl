...
entity IntMultiAdder_S_in3_m5_12_m12_out12_m12_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_2 : in std_logic_vector(24-1 downto 0); --	sfix(12, -12)
        yo : out std_logic_vector(24-1 downto 0) --	sfix(12, -12)
    );
end IntMultiAdder_S_in3_m5_12_m12_out12_m12_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in3_m5_12_m12_out12_m12_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in3_m5_12_m12_out12_m12_wrapper_wrapper : entity is "yes";
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in3_m5_12_m12_out12_m12_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(12, -12)
            xi_2_reshaped, --	sfix(12, -12)
            yo_signal
        );
