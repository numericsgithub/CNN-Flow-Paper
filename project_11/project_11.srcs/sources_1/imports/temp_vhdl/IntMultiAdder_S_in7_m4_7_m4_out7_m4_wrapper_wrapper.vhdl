...
entity IntMultiAdder_S_in7_m4_7_m4_out7_m4_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in7_m4_7_m4_out7_m4_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in7_m4_7_m4_out7_m4_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in7_m4_7_m4_out7_m4_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(11-1 downto 0); --	sfix(7, -4)
    signal xi_1_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(7, -4)
    signal xi_2_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(7, -4)
    ...
    subtype DEBUG_TYPE is std_logic_vector(13 downto 0);
    constant allowed_min : integer := -1024;
    constant allowed_max : integer := 1023;
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in7_m4_7_m4_out7_m4_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(7, -4)
            xi_2_reshaped, --	sfix(7, -4)
            yo_signal
        );
