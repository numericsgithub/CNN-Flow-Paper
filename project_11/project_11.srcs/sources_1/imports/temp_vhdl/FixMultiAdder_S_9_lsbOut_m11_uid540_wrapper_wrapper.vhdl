...
entity FixMultiAdder_S_9_lsbOut_m11_uid540_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_9 : in std_logic_vector(19-1 downto 0); --	sfix(8, -11)
        yo : out std_logic_vector(19-1 downto 0) --	sfix(8, -11)
    );
end FixMultiAdder_S_9_lsbOut_m11_uid540_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_9_lsbOut_m11_uid540_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_9_lsbOut_m11_uid540_wrapper_wrapper : entity is "yes";
...
begin
    ...
    adder : entity work.FixMultiAdder_S_9_lsbOut_m11_uid540_wrapper
        generic map
        (
