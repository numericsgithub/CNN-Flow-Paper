...
entity IntMultiAdder_S_in6_m4_6_m4_out6_m4_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in6_m4_6_m4_out6_m4_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in6_m4_6_m4_out6_m4_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in6_m4_6_m4_out6_m4_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(10-1 downto 0); --	sfix(6, -4)
    ...
    subtype DEBUG_TYPE is std_logic_vector(12 downto 0);
    constant allowed_min : integer := -512;
    constant allowed_max : integer := 511;
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in6_m4_6_m4_out6_m4_wrapper
        generic map
        (
