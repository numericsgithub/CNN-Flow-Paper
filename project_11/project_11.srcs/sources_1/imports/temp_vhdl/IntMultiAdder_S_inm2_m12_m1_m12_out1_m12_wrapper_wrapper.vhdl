...
entity IntMultiAdder_S_inm2_m12_m1_m12_out1_m12_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_inm2_m12_m1_m12_out1_m12_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_inm2_m12_m1_m12_out1_m12_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_inm2_m12_m1_m12_out1_m12_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(13-1 downto 0); --	sfix(1, -12)
    signal xi_1_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(-1, -12)
    signal xi_2_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(-1, -12)
    ...
    subtype DEBUG_TYPE is std_logic_vector(15 downto 0);
    constant allowed_min : integer := -4096;
    constant allowed_max : integer := 4095;
...
begin
    ...
    adder : entity work.IntMultiAdder_S_inm2_m12_m1_m12_out1_m12_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(-1, -12)
            xi_2_reshaped, --	sfix(-1, -12)
            yo_signal
        );
