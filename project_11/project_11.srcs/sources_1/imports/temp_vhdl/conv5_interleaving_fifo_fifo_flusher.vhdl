...
entity conv5_interleaving_fifo_fifo_flusher is
    Port (
        clk    : in std_logic;
        rst    : in std_logic;
        enable : in std_logic;
...
end conv5_interleaving_fifo_fifo_flusher;

architecture Behavioral of conv5_interleaving_fifo_fifo_flusher is
...
begin
    ...
    fifo_input_signal    <= data_in_1 & data_in_2 & data_in_3 & data_in_4 & data_in_5 & data_in_6 & data_in_7 & data_in_8 & data_in_9 & data_in_10 & data_in_11 & data_in_12 & data_in_13 & data_in_14 & data_in_15 & data_in_16 ;

    data_out_1 <= fifo_output_signal((XI_WIDTH*16)-1 downto (XI_WIDTH*15));
    data_out_2 <= fifo_output_signal((XI_WIDTH*15)-1 downto (XI_WIDTH*14));
    data_out_3 <= fifo_output_signal((XI_WIDTH*14)-1 downto (XI_WIDTH*13));
    data_out_4 <= fifo_output_signal((XI_WIDTH*13)-1 downto (XI_WIDTH*12));
    data_out_5 <= fifo_output_signal((XI_WIDTH*12)-1 downto (XI_WIDTH*11));
    data_out_6 <= fifo_output_signal((XI_WIDTH*11)-1 downto (XI_WIDTH*10));
    data_out_7 <= fifo_output_signal((XI_WIDTH*10)-1 downto (XI_WIDTH*9));
    data_out_8 <= fifo_output_signal((XI_WIDTH*9)-1 downto (XI_WIDTH*8));
    data_out_9 <= fifo_output_signal((XI_WIDTH*8)-1 downto (XI_WIDTH*7));
    data_out_10 <= fifo_output_signal((XI_WIDTH*7)-1 downto (XI_WIDTH*6));
    data_out_11 <= fifo_output_signal((XI_WIDTH*6)-1 downto (XI_WIDTH*5));
    data_out_12 <= fifo_output_signal((XI_WIDTH*5)-1 downto (XI_WIDTH*4));
    data_out_13 <= fifo_output_signal((XI_WIDTH*4)-1 downto (XI_WIDTH*3));
    data_out_14 <= fifo_output_signal((XI_WIDTH*3)-1 downto (XI_WIDTH*2));
    data_out_15 <= fifo_output_signal((XI_WIDTH*2)-1 downto (XI_WIDTH*1));
    data_out_16 <= fifo_output_signal((XI_WIDTH*1)-1 downto (XI_WIDTH*0));
