...
architecture Behavioral of conv14 is
    ...
    attribute KEEP_HIERARCHY of conv14 : entity is "yes";
    ...
    type PIPELINE_TYPE_FOR_CORE_2_KPU_1_INPUT_3 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    ...
    subtype CORE_1_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(33-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_2_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(102-1 downto 0);
...
-- # # # OUT: y_is_valid_signal, pad_[3], big_buffer_delay_counter_signal, small_buffer_delay_counter_signal, interleave_counter_signal, buffer_enable_signal
    ...
    sliding_window_ctrl : entity work.conv14_SlidingWindowController
        port map
        (
            clk,
            reset,
...
-- SAVE THIS SHIT
    ...
    conv_core1 : entity work.conv14_core1
        generic map
        (
    ...
    conv_core2 : entity work.conv14_core2
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
...
-- Add a pipeline step
    ...
    core_1_KPU_1 : entity work.conv14_core1_KPU1
        generic map
        (
        ...
        (
            ...
            core_1_kpu_1_input_3(0), --	sfix(6, -8)
            core_1_kpu_1_input_4(0), --	sfix(6, -8)
            core_1_kpu_1_input_5(0), --	sfix(7, -8)
            core_1_kpu_1_input_6(0), --	sfix(7, -8)
            core_1_kpu_1_input_7(0), --	sfix(5, -8)
            core_1_kpu_1_input_8(0), --	sfix(6, -8)
            core_1_kpu_1_input_9(0), --	sfix(4, -8)

        
            core_1_concat_big_undelayed_array(16-1 downto 0),
            core_1_concat_big_delayed_array(16-1 downto 0),
            core_1_concat_big_undelayed_array(33-1 downto 16),
            core_1_concat_big_delayed_array(33-1 downto 16),
    ...
    core_2_KPU_1 : entity work.conv14_core2_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            core_2_concat_small_undelayed_array(48-1 downto 30),
            core_2_concat_small_delayed_array(48-1 downto 30),
            core_2_concat_small_undelayed_array(66-1 downto 48),
            core_2_concat_small_delayed_array(66-1 downto 48),
            core_2_concat_small_undelayed_array(84-1 downto 66),
            core_2_concat_small_delayed_array(84-1 downto 66),
            core_2_concat_small_undelayed_array(102-1 downto 84),
            core_2_concat_small_delayed_array(102-1 downto 84),
...
-- Add a pipeline step after the accumulator
    ...
    bias_add : entity work.conv14_bias_add
        Port map (
            clk,
...
-- Add a pipeline step
    ...
    simulation_validation: entity work.conv14_sim_validator
        Port map (
            clk,
            reset,
            layer_xi_1, --	ufix(3, -4)
