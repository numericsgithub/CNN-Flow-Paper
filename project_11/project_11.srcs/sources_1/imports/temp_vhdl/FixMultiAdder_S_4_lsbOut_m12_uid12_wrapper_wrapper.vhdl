...
entity FixMultiAdder_S_4_lsbOut_m12_uid12_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        rst    : in std_logic;
        enable : in std_logic;
        xi_1 : in std_logic_vector(19-1 downto 0); --	sfix(7, -12)
        xi_2 : in std_logic_vector(16-1 downto 0); --	sfix(4, -12)
        xi_3 : in std_logic_vector(19-1 downto 0); --	sfix(7, -12)
        xi_4 : in std_logic_vector(21-1 downto 0); --	sfix(9, -12)
        yo : out std_logic_vector(21-1 downto 0) --	sfix(9, -12)
    );
end FixMultiAdder_S_4_lsbOut_m12_uid12_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_4_lsbOut_m12_uid12_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_4_lsbOut_m12_uid12_wrapper_wrapper : entity is "yes";
...
begin
    ...
    adder : entity work.FixMultiAdder_S_4_lsbOut_m12_uid12_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(7, -12)
            xi_2_reshaped, --	sfix(4, -12)
            xi_3_reshaped, --	sfix(7, -12)
            xi_4_reshaped, --	sfix(9, -12)
            yo_signal
        );
