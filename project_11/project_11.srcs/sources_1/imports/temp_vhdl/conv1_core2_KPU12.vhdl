...
END conv1_core2_KPU12;

ARCHITECTURE structural OF conv1_core2_KPU12 IS

    -- All all_additional_output_int_bits are:         [0, 2, 2, 3, 3, 3, 3, 3, 2]
    -- All all_additional_output_int_bits_weights are: [[-69.0], [55.0], [7.0], [-53.0], [55.0], [4.0], [-8.0], [6.0], [-8.0]]
    ...
    -- Unreshaped Adder would be: sfix(3, -12) + sfix(4, -12) = sfix(6, -12)
    ...
    -- Unreshaped Adder would be: sfix(0, -12) + sfix(7, -12) = sfix(7, -12)
    -- Reshaped Adder would be:   sfix(7, -12) + sfix(7, -12) = sfix(7, -12)
    -- 
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in3_m12_4_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU12_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_2_input_xi, adder_2_input_sum, small_undelayed_out_2);
	adder_2_output <= small_delayed_in_2;

    line_adder_3: entity work.IntMultiAdder_S_in0_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU12_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_4: entity work.IntMultiAdder_S_in3_m12_6_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU12_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_5: entity work.IntMultiAdder_S_in3_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU12_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_5_input_xi, adder_5_input_sum, small_undelayed_out_4);
	adder_5_output <= small_delayed_in_4;

    line_adder_6: entity work.IntMultiAdder_S_in0_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU12_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_6_input_xi, adder_6_input_sum, big_undelayed_out_2);
	adder_6_output <= big_delayed_in_2;
	adder_7: entity work.IntMultiAdder_S_in0_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU12_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_7_input_xi, adder_7_input_sum, small_undelayed_out_5);
	adder_7_output <= small_delayed_in_5;
	adder_8: entity work.IntMultiAdder_S_in0_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU12_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_8_input_xi, adder_8_input_sum, small_undelayed_out_6);
	adder_8_output <= small_delayed_in_6;

    last_stage: entity work.IntMultiAdder_S_in0_m12_7_m12_out7_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core2_KPU12_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
