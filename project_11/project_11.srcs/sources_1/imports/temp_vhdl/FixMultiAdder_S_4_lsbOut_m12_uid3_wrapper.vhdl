...
end FixMultiAdder_S_4_lsbOut_m12_uid3_wrapper;

architecture Behavioral of FixMultiAdder_S_4_lsbOut_m12_uid3_wrapper is



    constant MIN_PIPELINE_STEPS : natural := 1;
    ...
    type PIPELINE_TYPE_FOR_XI_1_PL              is array(0 to 1) of std_logic_vector(18-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_2_PL              is array(0 to 1) of std_logic_vector(19-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_3_PL              is array(0 to 1) of std_logic_vector(20-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_4_PL              is array(0 to 1) of std_logic_vector(22-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_4_lsbOut_m12_uid3
        port map
        (
            clk, rst,  enable,
            yo_flopoco , 
