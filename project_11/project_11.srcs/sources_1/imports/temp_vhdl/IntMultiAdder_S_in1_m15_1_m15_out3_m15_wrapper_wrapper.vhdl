...
entity IntMultiAdder_S_in1_m15_1_m15_out3_m15_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in1_m15_1_m15_out3_m15_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in1_m15_1_m15_out3_m15_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in1_m15_1_m15_out3_m15_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(18-1 downto 0); --	sfix(3, -15)
    signal xi_1_reshaped :  std_logic_vector(16-1 downto 0); --	sfix(1, -15)
    signal xi_2_reshaped :  std_logic_vector(16-1 downto 0); --	sfix(1, -15)
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in1_m15_1_m15_out3_m15_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(1, -15)
            xi_2_reshaped, --	sfix(1, -15)
            yo_signal
        );
