...
entity FixMultiAdder_S_17_lsbOut_m8_uid71_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_2 : in std_logic_vector(15-1 downto 0); --	sfix(7, -8)
        ...
        xi_8 : in std_logic_vector(15-1 downto 0); --	sfix(7, -8)
        ...
        xi_14 : in std_logic_vector(14-1 downto 0); --	sfix(6, -8)
...
end FixMultiAdder_S_17_lsbOut_m8_uid71_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m8_uid71_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m8_uid71_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(18-1 downto 0); --	sfix(10, -8)
    signal xi_1_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(6, -8)
    signal xi_2_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(7, -8)
    signal xi_3_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(6, -8)
    signal xi_4_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(6, -8)
    signal xi_5_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(6, -8)
    signal xi_6_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_7_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    signal xi_8_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(7, -8)
    ...
    signal xi_13_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_14_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(6, -8)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m8_uid71_wrapper
        generic map
        (
