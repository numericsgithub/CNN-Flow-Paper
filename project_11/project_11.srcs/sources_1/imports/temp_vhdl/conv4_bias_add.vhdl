...
architecture Behavioral of conv4_bias_add is
...
begin
    BIAS_ROM: entity work.conv4_bias_add_constant_memory
        generic map
        (
            XI_WIDTH        	          => BIAS_WIDTH,
            ARRAY_SIZE                    => 4,
    ...
    adder_1 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_1")
        port map
        (
            clk,
            '0',
    ...
    adder_2 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_2")
        port map
        (
            clk,
            '0',
    ...
    adder_3 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_3")
        port map
        (
            clk,
            '0',
    ...
    adder_4 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_4")
        port map
        (
            clk,
            '0',
    ...
    adder_5 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_5")
        port map
        (
            clk,
            '0',
    ...
    adder_6 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_6")
        port map
        (
            clk,
            '0',
    ...
    adder_7 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_7")
        port map
        (
            clk,
            '0',
    ...
    adder_8 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_8")
        port map
        (
            clk,
            '0',
    ...
    adder_9 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_9")
        port map
        (
            clk,
            '0',
    ...
    adder_10 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_10")
        port map
        (
            clk,
            '0',
    ...
    adder_11 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_11")
        port map
        (
            clk,
            '0',
    ...
    adder_12 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_12")
        port map
        (
            clk,
            '0',
    ...
    adder_13 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_13")
        port map
        (
            clk,
            '0',
    ...
    adder_14 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_14")
        port map
        (
            clk,
            '0',
    ...
    adder_15 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_15")
        port map
        (
            clk,
            '0',
    ...
    adder_16 : entity work.IntMultiAdder_S_in4_m4_15_m4_out15_m4_wrapper_wrapper generic map(ADDER_LOCATION => "conv4_bias_add" & "_16")
        port map
        (
            clk,
            '0',
