...
package conv19_interleaving_Data_Aggregator_pkg is
    type conv19_interleaving_Data_Aggregator_output is array(8-1 downto 0) of std_logic_vector(7-1 downto 0);
end package;

library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
use IEEE.NUMERIC_STD.ALL;
use work.conv19_interleaving_Data_Aggregator_pkg.all;

entity conv19_interleaving_Data_Aggregator is
    Port (
        ...
        output_array   : out conv19_interleaving_Data_Aggregator_output;
        valid_out      : out std_logic
    );
end conv19_interleaving_Data_Aggregator;

architecture Behavioral of conv19_interleaving_Data_Aggregator is
    constant AMOUNT_OF_INPUTS : natural := 2;

    signal output_is_valid      : std_logic;                         -- Interne Valid-Flag für den Output
    signal output_array_signal  : conv19_interleaving_Data_Aggregator_output;          -- Zwischenspeicher für 8 Daten
