...
entity conv4_core10_rmcm_weightsconstant_memoryROM is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv4_core10_rmcm_weightsconstant_memoryROM;

architecture Behavioral of conv4_core10_rmcm_weightsconstant_memoryROM is
	...
	constant data_ROM : ROM_TYPE := (
	    ...
	    0 => w(0,0,0,1,0,0,-1,-1,0),
	    1 => w(-2,-2,0,0,0,0,2,2,0),
	    2 => w(0,7,5,7,2,1,3,-3,3),
	    3 => w(5,0,-5,7,0,-8,2,0,-1)
        );
