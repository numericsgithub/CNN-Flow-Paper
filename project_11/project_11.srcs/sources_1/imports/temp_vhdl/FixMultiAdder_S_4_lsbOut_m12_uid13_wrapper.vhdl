...
end FixMultiAdder_S_4_lsbOut_m12_uid13_wrapper;

architecture Behavioral of FixMultiAdder_S_4_lsbOut_m12_uid13_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_1_PL              is array(0 to 1) of std_logic_vector(17-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_2_PL              is array(0 to 1) of std_logic_vector(17-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_3_PL              is array(0 to 1) of std_logic_vector(16-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_4_PL              is array(0 to 1) of std_logic_vector(19-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_4_lsbOut_m12_uid13
        port map
        (
            clk, rst,  enable,
            yo_flopoco , 
