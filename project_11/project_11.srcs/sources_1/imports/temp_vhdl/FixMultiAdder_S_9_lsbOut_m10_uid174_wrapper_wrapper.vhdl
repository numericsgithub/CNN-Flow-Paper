...
-- 	sfix(5, -10)
-- 	sfix(12, -10)
-- Output is: sfix(12, -10)

entity FixMultiAdder_S_9_lsbOut_m10_uid174_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_9 : in std_logic_vector(22-1 downto 0); --	sfix(12, -10)
        yo : out std_logic_vector(22-1 downto 0) --	sfix(12, -10)
    );
end FixMultiAdder_S_9_lsbOut_m10_uid174_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_9_lsbOut_m10_uid174_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_9_lsbOut_m10_uid174_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(22-1 downto 0); --	sfix(12, -10)
    ...
    signal xi_9_reshaped :  std_logic_vector(22-1 downto 0); --	sfix(12, -10)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_9_lsbOut_m10_uid174_wrapper
        generic map
        (
