...
entity FixMultiAdder_S_4_lsbOut_m12_uid13_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        rst    : in std_logic;
        enable : in std_logic;
        xi_1 : in std_logic_vector(17-1 downto 0); --	sfix(5, -12)
        xi_2 : in std_logic_vector(17-1 downto 0); --	sfix(5, -12)
        xi_3 : in std_logic_vector(16-1 downto 0); --	sfix(4, -12)
        xi_4 : in std_logic_vector(19-1 downto 0); --	sfix(7, -12)
        yo : out std_logic_vector(19-1 downto 0) --	sfix(7, -12)
    );
end FixMultiAdder_S_4_lsbOut_m12_uid13_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_4_lsbOut_m12_uid13_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_4_lsbOut_m12_uid13_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(19-1 downto 0); --	sfix(7, -12)
    signal xi_1_reshaped :  std_logic_vector(17-1 downto 0); --	sfix(5, -12)
    signal xi_2_reshaped :  std_logic_vector(17-1 downto 0); --	sfix(5, -12)
    signal xi_3_reshaped :  std_logic_vector(16-1 downto 0); --	sfix(4, -12)
    signal xi_4_reshaped :  std_logic_vector(19-1 downto 0); --	sfix(7, -12)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_4_lsbOut_m12_uid13_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(5, -12)
            xi_2_reshaped, --	sfix(5, -12)
            xi_3_reshaped, --	sfix(4, -12)
            xi_4_reshaped, --	sfix(7, -12)
            yo_signal
        );
