...
entity conv4_core4_rmcm_weightsconstant_memoryROM is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv4_core4_rmcm_weightsconstant_memoryROM;

architecture Behavioral of conv4_core4_rmcm_weightsconstant_memoryROM is
	...
	constant data_ROM : ROM_TYPE := (
	    ...
	    0 => w(-2,0,1,-3,3,2,-4,2,1),
	    1 => w(0,2,1,0,2,1,-1,0,0),
	    2 => w(1,0,0,1,0,-1,0,0,0),
	    3 => w(2,4,2,-2,-5,-1,0,0,0)
        );
