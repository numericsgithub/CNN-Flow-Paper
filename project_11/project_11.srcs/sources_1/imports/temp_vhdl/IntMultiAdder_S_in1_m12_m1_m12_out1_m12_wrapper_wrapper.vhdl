...
entity IntMultiAdder_S_in1_m12_m1_m12_out1_m12_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in1_m12_m1_m12_out1_m12_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in1_m12_m1_m12_out1_m12_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in1_m12_m1_m12_out1_m12_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(13-1 downto 0); --	sfix(1, -12)
    signal xi_1_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(1, -12)
    signal xi_2_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(1, -12)
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in1_m12_m1_m12_out1_m12_wrapper
        generic map
        (
