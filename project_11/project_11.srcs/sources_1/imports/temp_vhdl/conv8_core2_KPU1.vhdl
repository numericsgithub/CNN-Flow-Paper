...
ENTITY conv8_core2_KPU1 IS
	...
	PORT (
        ...
        kpu_xi_9 : in std_logic_vector(11-1 downto 0); --	sfix(3, -8)
...
END conv8_core2_KPU1;

ARCHITECTURE structural OF conv8_core2_KPU1 IS

    -- All all_additional_output_int_bits are:         [0, 2, 3, 3, 4, 4, 4, 3, 3]
    -- All all_additional_output_int_bits_weights are: [[7.0, 8.0, -5.0, 9.0, 7.0, -48.0, 14.0, -10.0, 13.0, 8.0, 7.0, 41.0, 11.0, 14.0, 9.0, -14.0], [9.0, 10.0, -7.0, 11.0, 14.0, 49.0, 21.0, -12.0, 18.0, 12.0, 9.0, 49.0, 12.0, 16.0, 13.0, -18.0], [5.0, 3.0, -3.0, 4.0, 9.0, 7.0, 9.0, -7.0, 8.0, 4.0, 4.0, 22.0, 4.0, 5.0, 5.0, -7.0], [9.0, 11.0, -8.0, 10.0, 14.0, -62.0, 21.0, -10.0, 17.0, 12.0, 10.0, 41.0, 14.0, 16.0, 13.0, -18.0], [12.0, 15.0, -12.0, 15.0, 22.0, 68.0, 31.0, -14.0, 20.0, 16.0, 12.0, 49.0, 18.0, 19.0, 19.0, -26.0], [5.0, 4.0, -5.0, 6.0, 11.0, 4.0, 13.0, -9.0, 8.0, 6.0, 4.0, 17.0, 8.0, 7.0, 8.0, -12.0], [5.0, 5.0, -4.0, 4.0, 9.0, -25.0, 10.0, -4.0, 7.0, 5.0, 5.0, 12.0, 6.0, 5.0, 6.0, -6.0], [6.0, 7.0, -6.0, 6.0, 11.0, 27.0, 13.0, -6.0, 8.0, 6.0, 5.0, 2.0, 9.0, 7.0, 8.0, -12.0], [3.0, 2.0, -2.0, 3.0, 4.0, -1.0, 5.0, -3.0, 3.0, 2.0, 2.0, 1.0, 5.0, 3.0, 3.0, -7.0]]
    ...
    signal adder_9_input_xi  : std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    ...
    -- Unreshaped Adder would be: sfix(3, -8) + sfix(10, -8) = sfix(10, -8)
    -- Reshaped Adder would be:   sfix(10, -8) + sfix(10, -8) = sfix(10, -8)
    -- 
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in6_m8_6_m8_out8_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv8_core2_KPU1_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_3: entity work.IntMultiAdder_S_in5_m8_8_m8_out9_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv8_core2_KPU1_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_4: entity work.IntMultiAdder_S_in6_m8_9_m8_out9_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv8_core2_KPU1_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_5: entity work.IntMultiAdder_S_in7_m8_9_m8_out10_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv8_core2_KPU1_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_6: entity work.IntMultiAdder_S_in5_m8_10_m8_out10_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv8_core2_KPU1_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_7: entity work.IntMultiAdder_S_in5_m8_10_m8_out10_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv8_core2_KPU1_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_in5_m8_10_m8_out10_m8_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv8_core2_KPU1_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_8_input_xi, adder_8_input_sum, small_undelayed_out_6);
	adder_8_output <= small_delayed_in_6;

    last_stage: entity work.IntMultiAdder_S_in3_m8_10_m8_out10_m8_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv8_core2_KPU1_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
