...
-- 	sfix(2, -12)
-- 	sfix(14, -12)
-- Output is: sfix(14, -12)

entity FixMultiAdder_S_5_lsbOut_m12_uid1213_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(26-1 downto 0); --	sfix(14, -12)
        yo : out std_logic_vector(26-1 downto 0) --	sfix(14, -12)
    );
end FixMultiAdder_S_5_lsbOut_m12_uid1213_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m12_uid1213_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_5_lsbOut_m12_uid1213_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(26-1 downto 0); --	sfix(14, -12)
    ...
    signal xi_5_reshaped :  std_logic_vector(26-1 downto 0); --	sfix(14, -12)
    ...
    subtype DEBUG_TYPE is std_logic_vector(30 downto 0);
    constant allowed_min : integer := -33554432;
    constant allowed_max : integer := 33554431;
...
begin
    ...
    adder : entity work.FixMultiAdder_S_5_lsbOut_m12_uid1213_wrapper
        generic map
        (
