...
end FixMultiAdder_S_4_lsbOut_m12_uid8_wrapper;

architecture Behavioral of FixMultiAdder_S_4_lsbOut_m12_uid8_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_3_PL              is array(0 to 1) of std_logic_vector(18-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_4_lsbOut_m12_uid8
        port map
        (
            clk, rst,  enable,
            yo_flopoco , 
