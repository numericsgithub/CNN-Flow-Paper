...
entity IntMultiAdder_S_in5_m10_8_m10_out9_m10_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(18-1 downto 0); --	sfix(8, -10)
        xi_2 : in std_logic_vector(18-1 downto 0); --	sfix(8, -10)
        yo  : out std_logic_vector(19-1 downto 0) --	sfix(9, -10)
    );
end IntMultiAdder_S_in5_m10_8_m10_out9_m10_wrapper;

architecture Behavioral of IntMultiAdder_S_in5_m10_8_m10_out9_m10_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in5_m10_8_m10_out9_m10
        port map
        (
            clk, rst, 
            yo_flopoco , 
