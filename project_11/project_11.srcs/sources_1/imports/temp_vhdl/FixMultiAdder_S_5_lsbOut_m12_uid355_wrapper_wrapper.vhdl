...
entity FixMultiAdder_S_5_lsbOut_m12_uid355_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(19-1 downto 0); --	sfix(7, -12)
        yo : out std_logic_vector(19-1 downto 0) --	sfix(7, -12)
    );
end FixMultiAdder_S_5_lsbOut_m12_uid355_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m12_uid355_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_5_lsbOut_m12_uid355_wrapper_wrapper : entity is "yes";
...
begin
    ...
    adder : entity work.FixMultiAdder_S_5_lsbOut_m12_uid355_wrapper
        generic map
        (
