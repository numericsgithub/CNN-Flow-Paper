...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=950 name=entity_place_holder_name IntMultiAdder signedIn=True n=2 wIn=18 wOut=19

entity IntMultiAdder_S_in1_m15_3_m15_out4_m15_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(18-1 downto 0); --	sfix(3, -15)
        xi_2 : in std_logic_vector(18-1 downto 0); --	sfix(3, -15)
        yo  : out std_logic_vector(19-1 downto 0) --	sfix(4, -15)
    );
end IntMultiAdder_S_in1_m15_3_m15_out4_m15_wrapper;

architecture Behavioral of IntMultiAdder_S_in1_m15_3_m15_out4_m15_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in1_m15_3_m15_out4_m15
        port map
        (
            clk, rst, 
            yo_flopoco , 
