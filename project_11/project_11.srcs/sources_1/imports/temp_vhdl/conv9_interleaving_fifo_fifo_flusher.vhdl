...
entity conv9_interleaving_fifo_fifo_flusher is
    Port (
        clk    : in std_logic;
        rst    : in std_logic;
        enable : in std_logic;
...
end conv9_interleaving_fifo_fifo_flusher;

architecture Behavioral of conv9_interleaving_fifo_fifo_flusher is
