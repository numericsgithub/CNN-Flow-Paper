...
entity FixMultiAdder_S_17_lsbOut_m8_uid78_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_17 : in std_logic_vector(17-1 downto 0); --	sfix(9, -8)
        yo : out std_logic_vector(17-1 downto 0) --	sfix(9, -8)
    );
end FixMultiAdder_S_17_lsbOut_m8_uid78_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m8_uid78_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m8_uid78_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(17-1 downto 0); --	sfix(9, -8)
    signal xi_1_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_2_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(5, -8)
    signal xi_3_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    signal xi_4_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(4, -8)
    ...
    signal xi_11_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(3, -8)
    ...
    signal xi_17_reshaped :  std_logic_vector(17-1 downto 0); --	sfix(9, -8)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m8_uid78_wrapper
        generic map
        (
        ...
        (
            ...
            xi_3_reshaped, --	sfix(3, -8)
            xi_4_reshaped, --	sfix(4, -8)
