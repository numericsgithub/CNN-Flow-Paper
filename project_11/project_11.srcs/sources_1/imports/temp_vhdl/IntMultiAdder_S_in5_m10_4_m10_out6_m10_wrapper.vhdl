...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=950 name=entity_place_holder_name IntMultiAdder signedIn=True n=2 wIn=15 wOut=16

entity IntMultiAdder_S_in5_m10_4_m10_out6_m10_wrapper is
    generic
    (
    ...
    Port (
        ...
        yo  : out std_logic_vector(16-1 downto 0) --	sfix(6, -10)
    );
end IntMultiAdder_S_in5_m10_4_m10_out6_m10_wrapper;

architecture Behavioral of IntMultiAdder_S_in5_m10_4_m10_out6_m10_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in5_m10_4_m10_out6_m10
        port map
        (
            clk, rst, 
            yo_flopoco , 
