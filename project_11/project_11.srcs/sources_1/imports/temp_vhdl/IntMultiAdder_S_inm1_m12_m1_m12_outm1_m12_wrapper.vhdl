...
entity IntMultiAdder_S_inm1_m12_m1_m12_outm1_m12_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_2 : in std_logic_vector(11-1 downto 0); --	sfix(-1, -12)
        yo  : out std_logic_vector(11-1 downto 0) --	sfix(-1, -12)
    );
end IntMultiAdder_S_inm1_m12_m1_m12_outm1_m12_wrapper;

architecture Behavioral of IntMultiAdder_S_inm1_m12_m1_m12_outm1_m12_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_inm1_m12_m1_m12_outm1_m12
        port map
        (
            clk, rst, 
            yo_flopoco , 
