...
entity IntMultiAdder_S_in4_m8_4_m8_out4_m8_wrapper is
    generic
    (
    ...
    Port (
        ...
        yo  : out std_logic_vector(12-1 downto 0) --	sfix(4, -8)
    );
end IntMultiAdder_S_in4_m8_4_m8_out4_m8_wrapper;

architecture Behavioral of IntMultiAdder_S_in4_m8_4_m8_out4_m8_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in4_m8_4_m8_out4_m8
        port map
        (
            clk, rst, 
            yo_flopoco , 
