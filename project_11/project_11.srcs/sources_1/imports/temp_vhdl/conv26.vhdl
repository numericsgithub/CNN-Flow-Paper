...
architecture Behavioral of conv26 is
    ...
    attribute KEEP_HIERARCHY of conv26 : entity is "yes";
    ...
    subtype CORE_1_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(36-1 downto 0);
    ...
    -- The one std_logic_vector to delay
    subtype CORE_1_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(104-1 downto 0);
...
-- # # # OUT: y_is_valid_signal, pad_[3], big_buffer_delay_counter_signal, small_buffer_delay_counter_signal, interleave_counter_signal, buffer_enable_signal
    ...
    sliding_window_ctrl : entity work.conv26_SlidingWindowController
        port map
        (
            clk,
            reset,
...
-- # # # IN:  layer_xi[1] y_is_valid_signal, pad_[3], big_buffer_delay_counter_signal(0), small_buffer_delay_counter_signal(0), interleave_counter_signal(0)
...
-- SAVE THIS SHIT
    ...
    conv_core1 : entity work.conv26_core1
        generic map
        (
...
-- Add a pipeline step
    ...
    core_1_KPU_1 : entity work.conv26_core1_KPU1
        generic map
        (
        ...
        (
            ...
            core_1_concat_small_undelayed_array(68-1 downto 50),
            core_1_concat_small_delayed_array(68-1 downto 50),
            core_1_concat_small_undelayed_array(86-1 downto 68),
            core_1_concat_small_delayed_array(86-1 downto 68),
            core_1_concat_small_undelayed_array(104-1 downto 86),
            core_1_concat_small_delayed_array(104-1 downto 86),
...
-- Add a pipeline step after the accumulator
    ...
    bias_add : entity work.conv26_bias_add
        Port map (
            clk,
...
-- Add a pipeline step
    ...
    simulation_validation: entity work.conv26_sim_validator
        Port map (
            clk,
            reset,
            layer_xi_1, --	ufix(2, -5)
