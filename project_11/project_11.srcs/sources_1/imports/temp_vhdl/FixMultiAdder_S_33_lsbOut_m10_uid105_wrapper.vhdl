...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=750 name=entity_place_holder_name FixMultiAdder signedIn=1 n=33 msbIn=3:1:1:2:2:1:1:2:3:1:1:1:1:3:2:1:1:2:3:1:3:2:1:1:0:3:2:2:3:2:1:2:6 lsbIn=-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10 lsbOut=-10

entity FixMultiAdder_S_33_lsbOut_m10_uid105_wrapper is
    generic
    (
...
end FixMultiAdder_S_33_lsbOut_m10_uid105_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m10_uid105_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_7_PL              is array(0 to 1) of std_logic_vector(12-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_XI_10_PL             is array(0 to 1) of std_logic_vector(12-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_11_PL             is array(0 to 1) of std_logic_vector(12-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_12_PL             is array(0 to 1) of std_logic_vector(12-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_XI_15_PL             is array(0 to 1) of std_logic_vector(13-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_XI_20_PL             is array(0 to 1) of std_logic_vector(12-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_21_PL             is array(0 to 1) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_22_PL             is array(0 to 1) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_23_PL             is array(0 to 1) of std_logic_vector(12-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_24_PL             is array(0 to 1) of std_logic_vector(12-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_25_PL             is array(0 to 1) of std_logic_vector(11-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_26_PL             is array(0 to 1) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_27_PL             is array(0 to 1) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_XI_28_PL             is array(0 to 1) of std_logic_vector(13-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_XI_31_PL             is array(0 to 1) of std_logic_vector(12-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_33_lsbOut_m10_uid105
        port map
        (
