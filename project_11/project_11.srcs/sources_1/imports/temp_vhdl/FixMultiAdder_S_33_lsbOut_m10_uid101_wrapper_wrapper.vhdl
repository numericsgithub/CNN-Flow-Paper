...
entity FixMultiAdder_S_33_lsbOut_m10_uid101_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_27 : in std_logic_vector(12-1 downto 0); --	sfix(2, -10)
...
end FixMultiAdder_S_33_lsbOut_m10_uid101_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m10_uid101_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m10_uid101_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(18-1 downto 0); --	sfix(8, -10)
    signal xi_1_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(3, -10)
    signal xi_2_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(4, -10)
    ...
    signal xi_20_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(3, -10)
    ...
    signal xi_27_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(2, -10)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m10_uid101_wrapper
        generic map
        (
