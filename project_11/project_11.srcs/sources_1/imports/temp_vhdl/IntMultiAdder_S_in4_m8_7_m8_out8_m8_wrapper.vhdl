...
entity IntMultiAdder_S_in4_m8_7_m8_out8_m8_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(15-1 downto 0); --	sfix(7, -8)
        xi_2 : in std_logic_vector(15-1 downto 0); --	sfix(7, -8)
        yo  : out std_logic_vector(16-1 downto 0) --	sfix(8, -8)
    );
end IntMultiAdder_S_in4_m8_7_m8_out8_m8_wrapper;

architecture Behavioral of IntMultiAdder_S_in4_m8_7_m8_out8_m8_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in4_m8_7_m8_out8_m8
        port map
        (
            clk, rst, 
            yo_flopoco , 
