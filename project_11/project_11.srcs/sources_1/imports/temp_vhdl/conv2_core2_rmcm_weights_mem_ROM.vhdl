...
entity conv2_core2_rmcm_weightsconstant_memoryROM is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv2_core2_rmcm_weightsconstant_memoryROM;

architecture Behavioral of conv2_core2_rmcm_weightsconstant_memoryROM is
	...
	constant data_ROM : ROM_TYPE := (
	    ...
	    0 => w(2,3,1,1,0,1,-2,-3,-2),
	    1 => w(79,66,61,68,58,42,13,4,-10),
	    2 => w(0,0,0,0,-1,0,0,-1,0),
	    3 => w(0,0,0,-3,-2,0,0,1,0)
        );
