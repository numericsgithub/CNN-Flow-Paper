...
entity FixMultiAdder_S_33_lsbOut_m7_uid26_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_7 : in std_logic_vector(12-1 downto 0); --	sfix(5, -7)
        ...
        xi_15 : in std_logic_vector(9-1 downto 0); --	sfix(2, -7)
        ...
        xi_20 : in std_logic_vector(10-1 downto 0); --	sfix(3, -7)
        ...
        xi_26 : in std_logic_vector(15-1 downto 0); --	sfix(8, -7)
        xi_27 : in std_logic_vector(13-1 downto 0); --	sfix(6, -7)
        xi_28 : in std_logic_vector(8-1 downto 0); --	sfix(1, -7)
        xi_29 : in std_logic_vector(9-1 downto 0); --	sfix(2, -7)
        ...
        xi_33 : in std_logic_vector(20-1 downto 0); --	sfix(13, -7)
        yo : out std_logic_vector(20-1 downto 0) --	sfix(13, -7)
    );
end FixMultiAdder_S_33_lsbOut_m7_uid26_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid26_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m7_uid26_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(20-1 downto 0); --	sfix(13, -7)
    ...
    signal xi_5_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    signal xi_6_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    signal xi_7_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(5, -7)
    ...
    signal xi_15_reshaped :  std_logic_vector(9-1 downto 0); --	sfix(2, -7)
    signal xi_16_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    ...
    signal xi_20_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    ...
    signal xi_26_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(8, -7)
    ...
    signal xi_29_reshaped :  std_logic_vector(9-1 downto 0); --	sfix(2, -7)
    ...
    signal xi_33_reshaped :  std_logic_vector(20-1 downto 0); --	sfix(13, -7)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m7_uid26_wrapper
        generic map
        (
        ...
        (
            ...
            xi_5_reshaped, --	sfix(3, -7)
            xi_6_reshaped, --	sfix(4, -7)
            xi_7_reshaped, --	sfix(5, -7)
