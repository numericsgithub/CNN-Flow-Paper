...
entity FixMultiAdder_S_33_lsbOut_m7_uid46_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_2 : in std_logic_vector(11-1 downto 0); --	sfix(4, -7)
        xi_3 : in std_logic_vector(14-1 downto 0); --	sfix(7, -7)
        xi_4 : in std_logic_vector(8-1 downto 0); --	sfix(1, -7)
        xi_5 : in std_logic_vector(13-1 downto 0); --	sfix(6, -7)
        xi_6 : in std_logic_vector(15-1 downto 0); --	sfix(8, -7)
        ...
        xi_24 : in std_logic_vector(15-1 downto 0); --	sfix(8, -7)
...
end FixMultiAdder_S_33_lsbOut_m7_uid46_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid46_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m7_uid46_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(18-1 downto 0); --	sfix(11, -7)
    signal xi_1_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(1, -7)
    signal xi_2_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    signal xi_3_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(7, -7)
    signal xi_4_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(1, -7)
    signal xi_5_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(6, -7)
    signal xi_6_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(8, -7)
    signal xi_7_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    signal xi_8_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(6, -7)
    ...
    signal xi_24_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(8, -7)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m7_uid46_wrapper
        generic map
        (
        ...
        (
            ...
            xi_2_reshaped, --	sfix(4, -7)
            xi_3_reshaped, --	sfix(7, -7)
            xi_4_reshaped, --	sfix(1, -7)
            xi_5_reshaped, --	sfix(6, -7)
            xi_6_reshaped, --	sfix(8, -7)
            xi_7_reshaped, --	sfix(4, -7)
            xi_8_reshaped, --	sfix(6, -7)
