...
END conv1_core3_KPU19;

ARCHITECTURE structural OF conv1_core3_KPU19 IS

    -- All all_additional_output_int_bits are:         [0, 2, 3, 3, 4, 4, 3, 3, 3]
    -- All all_additional_output_int_bits_weights are: [[47.0], [48.0], [31.0], [50.0], [53.0], [47.0], [31.0], [31.0], [34.0]]
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in3_m12_3_m12_out5_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU19_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_3: entity work.IntMultiAdder_S_in2_m12_5_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU19_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_4: entity work.IntMultiAdder_S_in3_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU19_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_5: entity work.IntMultiAdder_S_in3_m12_6_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU19_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_6: entity work.IntMultiAdder_S_in3_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU19_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_7: entity work.IntMultiAdder_S_in2_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU19_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_in2_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU19_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    last_stage: entity work.IntMultiAdder_S_in3_m12_7_m12_out7_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core3_KPU19_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
