...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=1050 name=entity_place_holder_name FixMultiAdder signedIn=1 n=5 msbIn=2:2:1:2:8 lsbIn=-12:-12:-12:-12:-12 lsbOut=-12

entity FixMultiAdder_S_5_lsbOut_m12_uid341_wrapper is
    generic
    (
...
end FixMultiAdder_S_5_lsbOut_m12_uid341_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m12_uid341_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_5_lsbOut_m12_uid341
        port map
        (
