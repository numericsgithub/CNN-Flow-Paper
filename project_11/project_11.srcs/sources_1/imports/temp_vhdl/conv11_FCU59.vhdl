...
architecture structural of conv11_FCU59 is
...
begin
    ...
    accumulation : entity work.FixMultiAdder_S_17_lsbOut_m11_uid292_wrapper_wrapper generic map(ADDER_LOCATION => "conv11_FCU59", PIPELINE_STEPS => PIPELINE_STEPS-1, ADDITIONAL_PIPELINE_STEP_AT_OUTPUT => TRUE)
        port map
        (
            clk, '0', buffer_enable,
            xi_1,
