...
entity IntMultiAdder_S_in1_m15_1_m15_out1_m15_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(16-1 downto 0); --	sfix(1, -15)
        xi_2 : in std_logic_vector(16-1 downto 0); --	sfix(1, -15)
        yo  : out std_logic_vector(16-1 downto 0) --	sfix(1, -15)
    );
end IntMultiAdder_S_in1_m15_1_m15_out1_m15_wrapper;

architecture Behavioral of IntMultiAdder_S_in1_m15_1_m15_out1_m15_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in1_m15_1_m15_out1_m15
        port map
        (
            clk, rst, 
            yo_flopoco , 
