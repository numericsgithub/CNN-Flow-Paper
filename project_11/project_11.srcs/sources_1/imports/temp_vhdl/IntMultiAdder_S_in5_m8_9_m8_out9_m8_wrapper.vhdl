...
entity IntMultiAdder_S_in5_m8_9_m8_out9_m8_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(17-1 downto 0); --	sfix(9, -8)
        xi_2 : in std_logic_vector(17-1 downto 0); --	sfix(9, -8)
        yo  : out std_logic_vector(17-1 downto 0) --	sfix(9, -8)
    );
end IntMultiAdder_S_in5_m8_9_m8_out9_m8_wrapper;

architecture Behavioral of IntMultiAdder_S_in5_m8_9_m8_out9_m8_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in5_m8_9_m8_out9_m8
        port map
        (
            clk, rst, 
            yo_flopoco , 
