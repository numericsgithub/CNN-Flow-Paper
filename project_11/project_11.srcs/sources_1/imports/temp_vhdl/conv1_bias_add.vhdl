...
architecture Behavioral of conv1_bias_add is
...
begin
    BIAS_ROM: entity work.conv1_bias_add_constant_memory
        generic map
        (
            XI_WIDTH        	          => BIAS_WIDTH,
            ARRAY_SIZE                    => 1,
    ...
    adder_1 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_1")
        port map
        (
            clk,
            '0',
    ...
    adder_2 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_2")
        port map
        (
            clk,
            '0',
    ...
    adder_3 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_3")
        port map
        (
            clk,
            '0',
    ...
    adder_4 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_4")
        port map
        (
            clk,
            '0',
    ...
    adder_5 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_5")
        port map
        (
            clk,
            '0',
    ...
    adder_6 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_6")
        port map
        (
            clk,
            '0',
    ...
    adder_7 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_7")
        port map
        (
            clk,
            '0',
    ...
    adder_8 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_8")
        port map
        (
            clk,
            '0',
    ...
    adder_9 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_9")
        port map
        (
            clk,
            '0',
    ...
    adder_10 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_10")
        port map
        (
            clk,
            '0',
    ...
    adder_11 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_11")
        port map
        (
            clk,
            '0',
    ...
    adder_12 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_12")
        port map
        (
            clk,
            '0',
    ...
    adder_13 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_13")
        port map
        (
            clk,
            '0',
    ...
    adder_14 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_14")
        port map
        (
            clk,
            '0',
    ...
    adder_15 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_15")
        port map
        (
            clk,
            '0',
    ...
    adder_16 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_16")
        port map
        (
            clk,
            '0',
    ...
    adder_17 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_17")
        port map
        (
            clk,
            '0',
    ...
    adder_18 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_18")
        port map
        (
            clk,
            '0',
    ...
    adder_19 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_19")
        port map
        (
            clk,
            '0',
    ...
    adder_20 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_20")
        port map
        (
            clk,
            '0',
    ...
    adder_21 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_21")
        port map
        (
            clk,
            '0',
    ...
    adder_22 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_22")
        port map
        (
            clk,
            '0',
    ...
    adder_23 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_23")
        port map
        (
            clk,
            '0',
    ...
    adder_24 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_24")
        port map
        (
            clk,
            '0',
    ...
    adder_25 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_25")
        port map
        (
            clk,
            '0',
    ...
    adder_26 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_26")
        port map
        (
            clk,
            '0',
    ...
    adder_27 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_27")
        port map
        (
            clk,
            '0',
    ...
    adder_28 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_28")
        port map
        (
            clk,
            '0',
    ...
    adder_29 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_29")
        port map
        (
            clk,
            '0',
    ...
    adder_30 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_30")
        port map
        (
            clk,
            '0',
    ...
    adder_31 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_31")
        port map
        (
            clk,
            '0',
    ...
    adder_32 : entity work.IntMultiAdder_S_in4_m4_10_m12_out10_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_bias_add" & "_32")
        port map
        (
            clk,
            '0',
