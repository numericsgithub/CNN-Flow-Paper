...
entity FixMultiAdder_S_33_lsbOut_m7_uid36_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_18 : in std_logic_vector(12-1 downto 0); --	sfix(5, -7)
        xi_19 : in std_logic_vector(9-1 downto 0); --	sfix(2, -7)
        xi_20 : in std_logic_vector(12-1 downto 0); --	sfix(5, -7)
        ...
        xi_24 : in std_logic_vector(10-1 downto 0); --	sfix(3, -7)
...
end FixMultiAdder_S_33_lsbOut_m7_uid36_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid36_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m7_uid36_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(17-1 downto 0); --	sfix(10, -7)
    signal xi_1_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(1, -7)
    signal xi_2_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(5, -7)
    ...
    signal xi_14_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(6, -7)
    ...
    signal xi_18_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(5, -7)
    signal xi_19_reshaped :  std_logic_vector(9-1 downto 0); --	sfix(2, -7)
    signal xi_20_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(5, -7)
    ...
    signal xi_24_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    ...
    signal xi_29_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(6, -7)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m7_uid36_wrapper
        generic map
        (
