...
end conv1_accumulator9;

architecture structural of conv1_accumulator9 is
...
begin
    ...
    accumulation : entity work.FixMultiAdder_S_4_lsbOut_m12_uid0_wrapper_wrapper generic map(ADDER_LOCATION => "conv1_accumulator9", PIPELINE_STEPS => PIPELINE_STEPS, ADDITIONAL_PIPELINE_STEP_AT_INPUT => FALSE)
        port map
        (
            clk, '0', x_is_valid,
            xi_1,
