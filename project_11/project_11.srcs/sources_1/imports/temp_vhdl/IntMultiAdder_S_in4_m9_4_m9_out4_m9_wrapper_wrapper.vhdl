...
entity IntMultiAdder_S_in4_m9_4_m9_out4_m9_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_2 : in std_logic_vector(13-1 downto 0); --	sfix(4, -9)
        yo : out std_logic_vector(13-1 downto 0) --	sfix(4, -9)
    );
end IntMultiAdder_S_in4_m9_4_m9_out4_m9_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in4_m9_4_m9_out4_m9_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in4_m9_4_m9_out4_m9_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(13-1 downto 0); --	sfix(4, -9)
    signal xi_1_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(4, -9)
    signal xi_2_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(4, -9)
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in4_m9_4_m9_out4_m9_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(4, -9)
            xi_2_reshaped, --	sfix(4, -9)
            yo_signal
        );
