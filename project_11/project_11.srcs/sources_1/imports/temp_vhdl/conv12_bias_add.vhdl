...
architecture Behavioral of conv12_bias_add is
...
begin
    BIAS_ROM: entity work.conv12_bias_add_constant_memory
        generic map
        (
            XI_WIDTH        	          => BIAS_WIDTH,
            ARRAY_SIZE                    => 64,
    ...
    adder_1 : entity work.IntMultiAdder_S_in4_m4_9_m10_out9_m10_wrapper_wrapper generic map(ADDER_LOCATION => "conv12_bias_add" & "_1")
        port map
        (
            clk,
            '0',
    ...
    adder_2 : entity work.IntMultiAdder_S_in4_m4_9_m10_out9_m10_wrapper_wrapper generic map(ADDER_LOCATION => "conv12_bias_add" & "_2")
        port map
        (
            clk,
            '0',
    ...
    adder_3 : entity work.IntMultiAdder_S_in4_m4_9_m10_out9_m10_wrapper_wrapper generic map(ADDER_LOCATION => "conv12_bias_add" & "_3")
        port map
        (
            clk,
            '0',
    ...
    adder_4 : entity work.IntMultiAdder_S_in4_m4_9_m10_out9_m10_wrapper_wrapper generic map(ADDER_LOCATION => "conv12_bias_add" & "_4")
        port map
        (
            clk,
            '0',
