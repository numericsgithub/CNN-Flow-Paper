...
entity FixMultiAdder_S_9_lsbOut_m12_uid1015_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_9 : in std_logic_vector(20-1 downto 0); --	sfix(8, -12)
        yo : out std_logic_vector(20-1 downto 0) --	sfix(8, -12)
    );
end FixMultiAdder_S_9_lsbOut_m12_uid1015_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_9_lsbOut_m12_uid1015_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_9_lsbOut_m12_uid1015_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(20-1 downto 0); --	sfix(8, -12)
    ...
    signal xi_9_reshaped :  std_logic_vector(20-1 downto 0); --	sfix(8, -12)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_9_lsbOut_m12_uid1015_wrapper
        generic map
        (
