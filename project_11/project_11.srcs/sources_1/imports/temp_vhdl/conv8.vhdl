...
architecture Behavioral of conv8 is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of conv8 : entity is "yes";
    ...
    type PIPELINE_TYPE_FOR_CORE_2_KPU_1_INPUT_1 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_2_KPU_1_INPUT_9 is array(0 to 0) of std_logic_vector(11-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_3_KPU_1_INPUT_3 is array(0 to 0) of std_logic_vector(12-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_3_KPU_1_INPUT_4 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_3_KPU_1_INPUT_5 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_3_KPU_1_INPUT_6 is array(0 to 0) of std_logic_vector(12-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_4_KPU_1_INPUT_1 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_CORE_4_KPU_1_INPUT_9 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_1 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_2 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_3 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_4 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_5 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_6 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_7 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_8 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_5_KPU_1_INPUT_9 is array(0 to 0) of std_logic_vector(12-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_1 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_2 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_3 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_4 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_5 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_6 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_7 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_8 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_6_KPU_1_INPUT_9 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_1 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_2 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_3 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_4 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_5 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_6 is array(0 to 0) of std_logic_vector(12-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_7 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_8 is array(0 to 0) of std_logic_vector(15-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_7_KPU_1_INPUT_9 is array(0 to 0) of std_logic_vector(14-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_1 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_2 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_3 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_4 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_5 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_6 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_7 is array(0 to 0) of std_logic_vector(12-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_8 is array(0 to 0) of std_logic_vector(13-1 downto 0);
    type PIPELINE_TYPE_FOR_CORE_8_KPU_1_INPUT_9 is array(0 to 0) of std_logic_vector(12-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_SIGNAL_CORE_6_YO_1   is array(0 to 0) of std_logic_vector(17-1 downto 0);
    type PIPELINE_TYPE_FOR_SIGNAL_CORE_7_YO_1   is array(0 to 0) of std_logic_vector(18-1 downto 0);
    type PIPELINE_TYPE_FOR_SIGNAL_CORE_8_YO_1   is array(0 to 0) of std_logic_vector(17-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_2_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(35-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_2_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(101-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_3_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(32-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_3_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(90-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_4_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(34-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_4_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(98-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_5_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(34-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_5_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(98-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_6_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(33-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_6_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(96-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_7_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(35-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_7_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(99-1 downto 0);
    ...
    -- All KPU big buffer (line buffer) delays
    -- The one std_logic_vector to delay
    subtype CORE_8_CONCAT_BIG_DELAY_ARRAY_TYPE is std_logic_vector(33-1 downto 0);
    ...
    -- All KPU small buffer delays
    -- The one std_logic_vector to delay
    subtype CORE_8_CONCAT_SMALL_DELAY_ARRAY_TYPE is std_logic_vector(95-1 downto 0);
...
-- # # # OUT: y_is_valid_signal, pad_[3], big_buffer_delay_counter_signal, small_buffer_delay_counter_signal, interleave_counter_signal, buffer_enable_signal
    ...
    sliding_window_ctrl : entity work.conv8_SlidingWindowController
        port map
        (
            clk,
            reset,
...
-- SAVE THIS SHIT
    ...
    conv_core1 : entity work.conv8_core1
        generic map
        (
    ...
    conv_core2 : entity work.conv8_core2
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core3 : entity work.conv8_core3
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core4 : entity work.conv8_core4
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core5 : entity work.conv8_core5
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core6 : entity work.conv8_core6
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core7 : entity work.conv8_core7
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
    ...
    conv_core8 : entity work.conv8_core8
        generic map
        (
            PIPELINE_STEPS => RMCM_PIPELINE_STEPS
        )
...
-- Add a pipeline step
    ...
    core_1_KPU_1 : entity work.conv8_core1_KPU1
        generic map
        (
        ...
        (
            ...
            core_1_kpu_1_input_1(0), --	sfix(6, -8)
            core_1_kpu_1_input_2(0), --	sfix(6, -8)
            core_1_kpu_1_input_3(0), --	sfix(5, -8)
            core_1_kpu_1_input_4(0), --	sfix(5, -8)
            core_1_kpu_1_input_5(0), --	sfix(6, -8)
            core_1_kpu_1_input_6(0), --	sfix(5, -8)
            core_1_kpu_1_input_7(0), --	sfix(5, -8)
            core_1_kpu_1_input_8(0), --	sfix(5, -8)
    ...
    core_2_KPU_1 : entity work.conv8_core2_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_2_kpu_1_input_1(0), --	sfix(6, -8)
            core_2_kpu_1_input_2(0), --	sfix(6, -8)
            core_2_kpu_1_input_3(0), --	sfix(5, -8)
            ...
            core_2_kpu_1_input_8(0), --	sfix(5, -8)
            core_2_kpu_1_input_9(0), --	sfix(3, -8)

        
            core_2_concat_big_undelayed_array(17-1 downto 0),
            core_2_concat_big_delayed_array(17-1 downto 0),
            core_2_concat_big_undelayed_array(35-1 downto 17),
            core_2_concat_big_delayed_array(35-1 downto 17),

        
            core_2_concat_small_undelayed_array(14-1 downto 0),
            core_2_concat_small_delayed_array(14-1 downto 0),
            core_2_concat_small_undelayed_array(30-1 downto 14),
            core_2_concat_small_delayed_array(30-1 downto 14),
            core_2_concat_small_undelayed_array(47-1 downto 30),
            core_2_concat_small_delayed_array(47-1 downto 30),
            core_2_concat_small_undelayed_array(65-1 downto 47),
            core_2_concat_small_delayed_array(65-1 downto 47),
            core_2_concat_small_undelayed_array(83-1 downto 65),
            core_2_concat_small_delayed_array(83-1 downto 65),
            core_2_concat_small_undelayed_array(101-1 downto 83),
            core_2_concat_small_delayed_array(101-1 downto 83),
    ...
    core_3_KPU_1 : entity work.conv8_core3_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_3_kpu_1_input_1(0), --	sfix(4, -8)
            core_3_kpu_1_input_2(0), --	sfix(5, -8)
            core_3_kpu_1_input_3(0), --	sfix(4, -8)
            core_3_kpu_1_input_4(0), --	sfix(5, -8)
            core_3_kpu_1_input_5(0), --	sfix(6, -8)
            core_3_kpu_1_input_6(0), --	sfix(4, -8)
            core_3_kpu_1_input_7(0), --	sfix(5, -8)
            core_3_kpu_1_input_8(0), --	sfix(5, -8)
            ...
            core_3_concat_big_undelayed_array(32-1 downto 16),
            core_3_concat_big_delayed_array(32-1 downto 16),
            ...
            core_3_concat_small_undelayed_array(42-1 downto 26),
            core_3_concat_small_delayed_array(42-1 downto 26),
            core_3_concat_small_undelayed_array(58-1 downto 42),
            core_3_concat_small_delayed_array(58-1 downto 42),
            core_3_concat_small_undelayed_array(74-1 downto 58),
            core_3_concat_small_delayed_array(74-1 downto 58),
            core_3_concat_small_undelayed_array(90-1 downto 74),
            core_3_concat_small_delayed_array(90-1 downto 74),
    ...
    core_4_KPU_1 : entity work.conv8_core4_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_4_kpu_1_input_1(0), --	sfix(6, -8)
            core_4_kpu_1_input_2(0), --	sfix(6, -8)
            core_4_kpu_1_input_3(0), --	sfix(4, -8)
            core_4_kpu_1_input_4(0), --	sfix(5, -8)
            core_4_kpu_1_input_5(0), --	sfix(5, -8)
            core_4_kpu_1_input_6(0), --	sfix(5, -8)
            core_4_kpu_1_input_7(0), --	sfix(4, -8)
            core_4_kpu_1_input_8(0), --	sfix(6, -8)
            core_4_kpu_1_input_9(0), --	sfix(5, -8)

        
            core_4_concat_big_undelayed_array(17-1 downto 0),
            core_4_concat_big_delayed_array(17-1 downto 0),
            core_4_concat_big_undelayed_array(34-1 downto 17),
            core_4_concat_big_delayed_array(34-1 downto 17),

        
            core_4_concat_small_undelayed_array(14-1 downto 0),
            core_4_concat_small_delayed_array(14-1 downto 0),
            core_4_concat_small_undelayed_array(30-1 downto 14),
            core_4_concat_small_delayed_array(30-1 downto 14),
            core_4_concat_small_undelayed_array(47-1 downto 30),
            core_4_concat_small_delayed_array(47-1 downto 30),
            core_4_concat_small_undelayed_array(64-1 downto 47),
            core_4_concat_small_delayed_array(64-1 downto 47),
            core_4_concat_small_undelayed_array(81-1 downto 64),
            core_4_concat_small_delayed_array(81-1 downto 64),
            core_4_concat_small_undelayed_array(98-1 downto 81),
            core_4_concat_small_delayed_array(98-1 downto 81),
    ...
    core_5_KPU_1 : entity work.conv8_core5_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_5_kpu_1_input_1(0), --	sfix(6, -8)
            core_5_kpu_1_input_2(0), --	sfix(5, -8)
            core_5_kpu_1_input_3(0), --	sfix(5, -8)
            core_5_kpu_1_input_4(0), --	sfix(6, -8)
            core_5_kpu_1_input_5(0), --	sfix(6, -8)
            core_5_kpu_1_input_6(0), --	sfix(5, -8)
            core_5_kpu_1_input_7(0), --	sfix(5, -8)
            core_5_kpu_1_input_8(0), --	sfix(5, -8)
            core_5_kpu_1_input_9(0), --	sfix(4, -8)

        
            core_5_concat_big_undelayed_array(17-1 downto 0),
            core_5_concat_big_delayed_array(17-1 downto 0),
            core_5_concat_big_undelayed_array(34-1 downto 17),
            core_5_concat_big_delayed_array(34-1 downto 17),

        
            core_5_concat_small_undelayed_array(14-1 downto 0),
            core_5_concat_small_delayed_array(14-1 downto 0),
            core_5_concat_small_undelayed_array(30-1 downto 14),
            core_5_concat_small_delayed_array(30-1 downto 14),
            core_5_concat_small_undelayed_array(47-1 downto 30),
            core_5_concat_small_delayed_array(47-1 downto 30),
            core_5_concat_small_undelayed_array(64-1 downto 47),
            core_5_concat_small_delayed_array(64-1 downto 47),
            core_5_concat_small_undelayed_array(81-1 downto 64),
            core_5_concat_small_delayed_array(81-1 downto 64),
            core_5_concat_small_undelayed_array(98-1 downto 81),
            core_5_concat_small_delayed_array(98-1 downto 81),
    ...
    core_6_KPU_1 : entity work.conv8_core6_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_6_kpu_1_input_1(0), --	sfix(5, -8)
            core_6_kpu_1_input_2(0), --	sfix(5, -8)
            core_6_kpu_1_input_3(0), --	sfix(5, -8)
            core_6_kpu_1_input_4(0), --	sfix(5, -8)
            core_6_kpu_1_input_5(0), --	sfix(6, -8)
            core_6_kpu_1_input_6(0), --	sfix(5, -8)
            core_6_kpu_1_input_7(0), --	sfix(5, -8)
            core_6_kpu_1_input_8(0), --	sfix(5, -8)
            core_6_kpu_1_input_9(0), --	sfix(5, -8)

        
            core_6_concat_big_undelayed_array(16-1 downto 0),
            core_6_concat_big_delayed_array(16-1 downto 0),
            core_6_concat_big_undelayed_array(33-1 downto 16),
            core_6_concat_big_delayed_array(33-1 downto 16),

        
            core_6_concat_small_undelayed_array(13-1 downto 0),
            core_6_concat_small_delayed_array(13-1 downto 0),
            core_6_concat_small_undelayed_array(28-1 downto 13),
            core_6_concat_small_delayed_array(28-1 downto 13),
            core_6_concat_small_undelayed_array(45-1 downto 28),
            core_6_concat_small_delayed_array(45-1 downto 28),
            core_6_concat_small_undelayed_array(62-1 downto 45),
            core_6_concat_small_delayed_array(62-1 downto 45),
            core_6_concat_small_undelayed_array(79-1 downto 62),
            core_6_concat_small_delayed_array(79-1 downto 62),
            core_6_concat_small_undelayed_array(96-1 downto 79),
            core_6_concat_small_delayed_array(96-1 downto 79),
    ...
    core_7_KPU_1 : entity work.conv8_core7_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_7_kpu_1_input_1(0), --	sfix(5, -8)
            core_7_kpu_1_input_2(0), --	sfix(6, -8)
            core_7_kpu_1_input_3(0), --	sfix(6, -8)
            core_7_kpu_1_input_4(0), --	sfix(6, -8)
            core_7_kpu_1_input_5(0), --	sfix(7, -8)
            core_7_kpu_1_input_6(0), --	sfix(4, -8)
            core_7_kpu_1_input_7(0), --	sfix(6, -8)
            core_7_kpu_1_input_8(0), --	sfix(7, -8)
            core_7_kpu_1_input_9(0), --	sfix(6, -8)

        
            core_7_concat_big_undelayed_array(17-1 downto 0),
            core_7_concat_big_delayed_array(17-1 downto 0),
            core_7_concat_big_undelayed_array(35-1 downto 17),
            core_7_concat_big_delayed_array(35-1 downto 17),

        
            core_7_concat_small_undelayed_array(13-1 downto 0),
            core_7_concat_small_delayed_array(13-1 downto 0),
            core_7_concat_small_undelayed_array(28-1 downto 13),
            core_7_concat_small_delayed_array(28-1 downto 13),
            core_7_concat_small_undelayed_array(45-1 downto 28),
            core_7_concat_small_delayed_array(45-1 downto 28),
            core_7_concat_small_undelayed_array(63-1 downto 45),
            core_7_concat_small_delayed_array(63-1 downto 45),
            core_7_concat_small_undelayed_array(81-1 downto 63),
            core_7_concat_small_delayed_array(81-1 downto 63),
            core_7_concat_small_undelayed_array(99-1 downto 81),
            core_7_concat_small_delayed_array(99-1 downto 81),
    ...
    core_8_KPU_1 : entity work.conv8_core8_KPU1
        generic map
        (
            PIPELINE_STEPS => KPU_PIPELINE_STEPS
        )
        ...
        (
            ...
            reset,
            buffer_enable_signal(2),
            core_8_kpu_1_input_1(0), --	sfix(5, -8)
            core_8_kpu_1_input_2(0), --	sfix(5, -8)
            core_8_kpu_1_input_3(0), --	sfix(5, -8)
            core_8_kpu_1_input_4(0), --	sfix(5, -8)
            core_8_kpu_1_input_5(0), --	sfix(5, -8)
            core_8_kpu_1_input_6(0), --	sfix(5, -8)
            core_8_kpu_1_input_7(0), --	sfix(4, -8)
            core_8_kpu_1_input_8(0), --	sfix(5, -8)
            core_8_kpu_1_input_9(0), --	sfix(4, -8)

        
            core_8_concat_big_undelayed_array(16-1 downto 0),
            core_8_concat_big_delayed_array(16-1 downto 0),
            core_8_concat_big_undelayed_array(33-1 downto 16),
            core_8_concat_big_delayed_array(33-1 downto 16),

        
            core_8_concat_small_undelayed_array(13-1 downto 0),
            core_8_concat_small_delayed_array(13-1 downto 0),
            core_8_concat_small_undelayed_array(28-1 downto 13),
            core_8_concat_small_delayed_array(28-1 downto 13),
            core_8_concat_small_undelayed_array(44-1 downto 28),
            core_8_concat_small_delayed_array(44-1 downto 28),
            core_8_concat_small_undelayed_array(61-1 downto 44),
            core_8_concat_small_delayed_array(61-1 downto 44),
            core_8_concat_small_undelayed_array(78-1 downto 61),
            core_8_concat_small_delayed_array(78-1 downto 61),
            core_8_concat_small_undelayed_array(95-1 downto 78),
            core_8_concat_small_delayed_array(95-1 downto 78),
...
-- Add a pipeline step after the accumulator
    ...
    bias_add : entity work.conv8_bias_add
        Port map (
            clk,
...
-- Add a pipeline step
    ...
    simulation_validation: entity work.conv8_sim_validator
        Port map (
            clk,
            reset,
            layer_xi_1, --	ufix(4, -3)
