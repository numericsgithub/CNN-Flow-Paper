...
entity FixMultiAdder_S_17_lsbOut_m11_uid287_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_17 : in std_logic_vector(17-1 downto 0); --	sfix(6, -11)
        yo : out std_logic_vector(17-1 downto 0) --	sfix(6, -11)
    );
end FixMultiAdder_S_17_lsbOut_m11_uid287_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m11_uid287_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m11_uid287_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(17-1 downto 0); --	sfix(6, -11)
    ...
    signal xi_3_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(1, -11)
    ...
    signal xi_17_reshaped :  std_logic_vector(17-1 downto 0); --	sfix(6, -11)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m11_uid287_wrapper
        generic map
        (
