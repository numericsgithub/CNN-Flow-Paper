...
architecture structural of conv3_FCU1 is
...
begin
    ...
    accumulation : entity work.FixMultiAdder_S_33_lsbOut_m7_uid20_wrapper_wrapper generic map(ADDER_LOCATION => "conv3_FCU1", PIPELINE_STEPS => PIPELINE_STEPS-1, ADDITIONAL_PIPELINE_STEP_AT_OUTPUT => TRUE)
        port map
        (
            clk, '0', buffer_enable,
            xi_1,
