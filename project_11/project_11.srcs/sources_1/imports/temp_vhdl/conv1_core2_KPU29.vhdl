...
ENTITY conv1_core2_KPU29 IS
	...
	PORT (
        ...
        kpu_xi_1 : in std_logic_vector(16-1 downto 0); --	sfix(4, -12)
        kpu_xi_2 : in std_logic_vector(16-1 downto 0); --	sfix(4, -12)
        kpu_xi_3 : in std_logic_vector(15-1 downto 0); --	sfix(3, -12)
        kpu_xi_4 : in std_logic_vector(16-1 downto 0); --	sfix(4, -12)
        ...
        big_undelayed_out_1 : out std_logic_vector(19-1 downto 0); --	sfix(7, -12)
        big_delayed_in_1 : in std_logic_vector(19-1 downto 0); --	sfix(7, -12)
        ...
        small_undelayed_out_1 : out std_logic_vector(16-1 downto 0); --	sfix(4, -12)
        small_delayed_in_1 : in std_logic_vector(16-1 downto 0); --	sfix(4, -12)
        small_undelayed_out_2 : out std_logic_vector(18-1 downto 0); --	sfix(6, -12)
        small_delayed_in_2 : in std_logic_vector(18-1 downto 0); --	sfix(6, -12)
...
END conv1_core2_KPU29;

ARCHITECTURE structural OF conv1_core2_KPU29 IS

    -- All all_additional_output_int_bits are:         [0, 2, 3, 3, 2, 2, 2, 2, 2]
    -- All all_additional_output_int_bits_weights are: [[-90.0], [-69.0], [40.0], [66.0], [17.0], [-14.0], [25.0], [49.0], [-26.0]]
    signal adder_1_input_xi  : std_logic_vector(16-1 downto 0); --	sfix(4, -12)
    signal adder_2_input_xi  : std_logic_vector(16-1 downto 0); --	sfix(4, -12)
    signal adder_3_input_xi  : std_logic_vector(15-1 downto 0); --	sfix(3, -12)
    signal adder_4_input_xi  : std_logic_vector(16-1 downto 0); --	sfix(4, -12)
    ...
    -- Unreshaped Adder would be: sfix(4, -12) + nothing = sfix(4, -12)
    -- Reshaped Adder would be:   sfix(4, -12) + sfix(4, -12) = sfix(4, -12)
    -- 
    signal adder_1_output    : std_logic_vector(16-1 downto 0); --	sfix(4, -12)
    signal adder_2_input_sum : std_logic_vector(16-1 downto 0); --	sfix(4, -12)



    -- Unreshaped Adder would be: sfix(4, -12) + sfix(4, -12) = sfix(6, -12)
    -- Reshaped Adder would be:   sfix(4, -12) + sfix(4, -12) = sfix(6, -12)
    -- 
    signal adder_2_output    : std_logic_vector(18-1 downto 0); --	sfix(6, -12)
    signal adder_3_input_sum : std_logic_vector(18-1 downto 0); --	sfix(6, -12)
    ...
    -- 
    signal adder_3_output    : std_logic_vector(19-1 downto 0); --	sfix(7, -12)
    signal adder_4_input_sum : std_logic_vector(19-1 downto 0); --	sfix(7, -12)



    -- Unreshaped Adder would be: sfix(4, -12) + sfix(7, -12) = sfix(7, -12)
    ...
    -- Unreshaped Adder would be: sfix(1, -12) + sfix(7, -12) = sfix(7, -12)
    -- Reshaped Adder would be:   sfix(7, -12) + sfix(7, -12) = sfix(7, -12)
    -- 
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in4_m12_4_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU29_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_2_input_xi, adder_2_input_sum, small_undelayed_out_2);
	adder_2_output <= small_delayed_in_2;

    line_adder_3: entity work.IntMultiAdder_S_in3_m12_6_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU29_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_3_input_xi, adder_3_input_sum, big_undelayed_out_1);
	adder_3_output <= big_delayed_in_1;
	adder_4: entity work.IntMultiAdder_S_in4_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU29_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_4_input_xi, adder_4_input_sum, small_undelayed_out_3);
	adder_4_output <= small_delayed_in_3;
	adder_5: entity work.IntMultiAdder_S_in2_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU29_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_5_input_xi, adder_5_input_sum, small_undelayed_out_4);
	adder_5_output <= small_delayed_in_4;

    line_adder_6: entity work.IntMultiAdder_S_in1_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU29_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_6_input_xi, adder_6_input_sum, big_undelayed_out_2);
	adder_6_output <= big_delayed_in_2;
	adder_7: entity work.IntMultiAdder_S_in2_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU29_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_in3_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU29_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_8_input_xi, adder_8_input_sum, small_undelayed_out_6);
	adder_8_output <= small_delayed_in_6;

    last_stage: entity work.IntMultiAdder_S_in2_m12_7_m12_out7_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core2_KPU29_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
