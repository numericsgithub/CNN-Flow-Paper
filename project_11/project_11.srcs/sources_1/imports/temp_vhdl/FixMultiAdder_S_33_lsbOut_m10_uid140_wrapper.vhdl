...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=750 name=entity_place_holder_name FixMultiAdder signedIn=1 n=33 msbIn=4:2:1:1:1:2:3:3:2:1:1:2:1:2:3:4:2:3:2:3:2:1:2:1:2:4:2:3:2:3:2:3:8 lsbIn=-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10 lsbOut=-10

entity FixMultiAdder_S_33_lsbOut_m10_uid140_wrapper is
    generic
    (
...
end FixMultiAdder_S_33_lsbOut_m10_uid140_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m10_uid140_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_19_PL             is array(0 to 1) of std_logic_vector(13-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_XI_25_PL             is array(0 to 1) of std_logic_vector(13-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_XI_30_PL             is array(0 to 1) of std_logic_vector(14-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_33_lsbOut_m10_uid140
        port map
        (
