...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=950 name=entity_place_holder_name IntMultiAdder signedIn=True n=2 wIn=13 wOut=14

entity IntMultiAdder_S_in8_m4_9_m4_out10_m4_wrapper is
    generic
    (
...
end IntMultiAdder_S_in8_m4_9_m4_out10_m4_wrapper;

architecture Behavioral of IntMultiAdder_S_in8_m4_9_m4_out10_m4_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in8_m4_9_m4_out10_m4
        port map
        (
            clk, rst, 
            yo_flopoco , 
