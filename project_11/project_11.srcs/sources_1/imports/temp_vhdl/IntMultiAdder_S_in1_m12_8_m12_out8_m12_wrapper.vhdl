...
entity IntMultiAdder_S_in1_m12_8_m12_out8_m12_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(20-1 downto 0); --	sfix(8, -12)
        xi_2 : in std_logic_vector(20-1 downto 0); --	sfix(8, -12)
        yo  : out std_logic_vector(20-1 downto 0) --	sfix(8, -12)
    );
end IntMultiAdder_S_in1_m12_8_m12_out8_m12_wrapper;

architecture Behavioral of IntMultiAdder_S_in1_m12_8_m12_out8_m12_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in1_m12_8_m12_out8_m12
        port map
        (
            clk, rst, 
            yo_flopoco , 
