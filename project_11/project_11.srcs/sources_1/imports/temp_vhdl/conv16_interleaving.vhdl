...
end conv16_interleaving;

architecture Behavioral of conv16_interleaving is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of conv16_interleaving : entity is "yes";
    ...
    begin
        if rising_edge(clk) then
            if fifo_data_counter >= FIFO_SIZE then
                assert false
                report "Interleaving layer conv16_interleaving: FIFO Overflow!"
                severity warning;
            end if;
        end if;
    end process;
