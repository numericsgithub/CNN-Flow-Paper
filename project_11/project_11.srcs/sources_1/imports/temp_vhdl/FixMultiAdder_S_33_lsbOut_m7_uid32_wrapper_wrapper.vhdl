...
entity FixMultiAdder_S_33_lsbOut_m7_uid32_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_7 : in std_logic_vector(9-1 downto 0); --	sfix(2, -7)
        ...
        xi_13 : in std_logic_vector(11-1 downto 0); --	sfix(4, -7)
        ...
        xi_17 : in std_logic_vector(13-1 downto 0); --	sfix(6, -7)
        xi_18 : in std_logic_vector(14-1 downto 0); --	sfix(7, -7)
        ...
        xi_27 : in std_logic_vector(14-1 downto 0); --	sfix(7, -7)
...
end FixMultiAdder_S_33_lsbOut_m7_uid32_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid32_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m7_uid32_wrapper_wrapper : entity is "yes";
    ...
    signal xi_7_reshaped :  std_logic_vector(9-1 downto 0); --	sfix(2, -7)
    ...
    signal xi_13_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    ...
    signal xi_17_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(6, -7)
    signal xi_18_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(7, -7)
    ...
    signal xi_27_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(7, -7)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m7_uid32_wrapper
        generic map
        (
