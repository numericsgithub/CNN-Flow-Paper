...
architecture Behavioral of conv24_bias_add is
...
begin
    BIAS_ROM: entity work.conv24_bias_add_constant_memory
        generic map
        (
            XI_WIDTH        	          => BIAS_WIDTH,
            ARRAY_SIZE                    => 256,
    ...
    adder_1 : entity work.IntMultiAdder_S_in3_m5_7_m12_out7_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv24_bias_add" & "_1")
        port map
        (
            clk,
            '0',
    ...
    adder_2 : entity work.IntMultiAdder_S_in3_m5_7_m12_out7_m12_wrapper_wrapper generic map(ADDER_LOCATION => "conv24_bias_add" & "_2")
        port map
        (
            clk,
            '0',
