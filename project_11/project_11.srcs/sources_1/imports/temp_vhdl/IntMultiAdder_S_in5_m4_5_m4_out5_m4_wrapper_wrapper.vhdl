...
entity IntMultiAdder_S_in5_m4_5_m4_out5_m4_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in5_m4_5_m4_out5_m4_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in5_m4_5_m4_out5_m4_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in5_m4_5_m4_out5_m4_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(9-1 downto 0); --	sfix(5, -4)
    ...
    subtype DEBUG_TYPE is std_logic_vector(11 downto 0);
    constant allowed_min : integer := -256;
    constant allowed_max : integer := 255;
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in5_m4_5_m4_out5_m4_wrapper
        generic map
        (
