...
END conv1_core1_KPU12;

ARCHITECTURE structural OF conv1_core1_KPU12 IS

    -- All all_additional_output_int_bits are:         [0, 2, 3, 3, 3, 2, 2, 2, 2]
    -- All all_additional_output_int_bits_weights are: [[-44.0], [39.0], [3.0], [-37.0], [42.0], [1.0], [-5.0], [12.0], [-8.0]]
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in3_m12_3_m12_out5_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU12_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_2_input_xi, adder_2_input_sum, small_undelayed_out_2);
	adder_2_output <= small_delayed_in_2;

    line_adder_3: entity work.IntMultiAdder_S_inm1_m12_5_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU12_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_4: entity work.IntMultiAdder_S_in3_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU12_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_5: entity work.IntMultiAdder_S_in3_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU12_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_5_input_xi, adder_5_input_sum, small_undelayed_out_4);
	adder_5_output <= small_delayed_in_4;

    line_adder_6: entity work.IntMultiAdder_S_inm2_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU12_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_7: entity work.IntMultiAdder_S_in0_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU12_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_in1_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU12_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    last_stage: entity work.IntMultiAdder_S_in0_m12_6_m12_out6_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core1_KPU12_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
