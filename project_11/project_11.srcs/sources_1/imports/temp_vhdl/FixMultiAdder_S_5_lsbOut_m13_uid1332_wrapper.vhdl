...
end FixMultiAdder_S_5_lsbOut_m13_uid1332_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m13_uid1332_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_5_PL              is array(0 to 1) of std_logic_vector(30-1 downto 0);
    type PIPELINE_TYPE_FOR_YO_PL                is array(0 to 1) of std_logic_vector(30-1 downto 0);
    ...
    signal yo_flopoco : std_logic_vector(30-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_5_lsbOut_m13_uid1332
        port map
        (
