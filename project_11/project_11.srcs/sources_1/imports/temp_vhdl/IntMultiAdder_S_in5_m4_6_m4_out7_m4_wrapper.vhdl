...
entity IntMultiAdder_S_in5_m4_6_m4_out7_m4_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(10-1 downto 0); --	sfix(6, -4)
        xi_2 : in std_logic_vector(10-1 downto 0); --	sfix(6, -4)
        yo  : out std_logic_vector(11-1 downto 0) --	sfix(7, -4)
    );
end IntMultiAdder_S_in5_m4_6_m4_out7_m4_wrapper;

architecture Behavioral of IntMultiAdder_S_in5_m4_6_m4_out7_m4_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in5_m4_6_m4_out7_m4
        port map
        (
            clk, rst, 
            yo_flopoco , 
