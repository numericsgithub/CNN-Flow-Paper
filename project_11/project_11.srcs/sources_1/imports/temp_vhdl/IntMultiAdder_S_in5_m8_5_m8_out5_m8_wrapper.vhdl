...
entity IntMultiAdder_S_in5_m8_5_m8_out5_m8_wrapper is
    generic
    (
    ...
    Port (
        ...
        yo  : out std_logic_vector(13-1 downto 0) --	sfix(5, -8)
    );
end IntMultiAdder_S_in5_m8_5_m8_out5_m8_wrapper;

architecture Behavioral of IntMultiAdder_S_in5_m8_5_m8_out5_m8_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in5_m8_5_m8_out5_m8
        port map
        (
            clk, rst, 
            yo_flopoco , 
