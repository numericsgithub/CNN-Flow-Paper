...
END conv1_core3_KPU6;

ARCHITECTURE structural OF conv1_core3_KPU6 IS

    -- All all_additional_output_int_bits are:         [0, 2, 5, 5, 6, 5, 5, 5, 5]
    -- All all_additional_output_int_bits_weights are: [[0.0], [5.0], [-2.0], [4.0], [7.0], [-6.0], [2.0], [6.0], [-3.0]]
    ...
    -- Unreshaped Adder would be: sfix(-2, -12) + sfix(3, -12) = sfix(6, -12)
    -- Reshaped Adder would be:   sfix(3, -12) + sfix(3, -12) = sfix(6, -12)
    -- 
    ...
    -- Unreshaped Adder would be: sfix(0, -12) + sfix(6, -12) = sfix(7, -12)
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in0_m12_1_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU6_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_2_input_xi, adder_2_input_sum, small_undelayed_out_2);
	adder_2_output <= small_delayed_in_2;

    line_adder_3: entity work.IntMultiAdder_S_inm2_m12_3_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU6_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_3_input_xi, adder_3_input_sum, big_undelayed_out_1);
	adder_3_output <= big_delayed_in_1;
	adder_4: entity work.IntMultiAdder_S_in0_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU6_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_4_input_xi, adder_4_input_sum, small_undelayed_out_3);
	adder_4_output <= small_delayed_in_3;
	adder_5: entity work.IntMultiAdder_S_in0_m12_6_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU6_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_6: entity work.IntMultiAdder_S_in0_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU6_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_6_input_xi, adder_6_input_sum, big_undelayed_out_2);
	adder_6_output <= big_delayed_in_2;
	adder_7: entity work.IntMultiAdder_S_inm1_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU6_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_in0_m12_7_m12_out7_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core3_KPU6_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_8_input_xi, adder_8_input_sum, small_undelayed_out_6);
	adder_8_output <= small_delayed_in_6;

    last_stage: entity work.IntMultiAdder_S_inm1_m12_7_m12_out7_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core3_KPU6_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
