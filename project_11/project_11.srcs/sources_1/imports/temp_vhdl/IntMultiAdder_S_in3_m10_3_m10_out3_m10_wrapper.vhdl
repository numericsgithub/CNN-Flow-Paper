...
entity IntMultiAdder_S_in3_m10_3_m10_out3_m10_wrapper is
    generic
    (
    ...
    Port (
        ...
        yo  : out std_logic_vector(13-1 downto 0) --	sfix(3, -10)
    );
end IntMultiAdder_S_in3_m10_3_m10_out3_m10_wrapper;

architecture Behavioral of IntMultiAdder_S_in3_m10_3_m10_out3_m10_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in3_m10_3_m10_out3_m10
        port map
        (
            clk, rst, 
            yo_flopoco , 
