...
entity IntMultiAdder_S_in10_m4_15_m4_out15_m4_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(19-1 downto 0); --	sfix(15, -4)
        xi_2 : in std_logic_vector(19-1 downto 0); --	sfix(15, -4)
        yo  : out std_logic_vector(19-1 downto 0) --	sfix(15, -4)
    );
end IntMultiAdder_S_in10_m4_15_m4_out15_m4_wrapper;

architecture Behavioral of IntMultiAdder_S_in10_m4_15_m4_out15_m4_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in10_m4_15_m4_out15_m4
        port map
        (
            clk, rst, 
            yo_flopoco , 
