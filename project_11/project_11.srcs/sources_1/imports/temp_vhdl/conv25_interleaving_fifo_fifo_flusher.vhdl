...
entity conv25_interleaving_fifo_fifo_flusher is
    Port (
        clk    : in std_logic;
        rst    : in std_logic;
        enable : in std_logic;
...
end conv25_interleaving_fifo_fifo_flusher;

architecture Behavioral of conv25_interleaving_fifo_fifo_flusher is
    constant AMOUNT_OF_INPUTS : natural := 4;
    constant XI_WIDTH : natural := 7;
    constant FIFO_SIZE : natural := 482;
    constant AMOUNT_OF_FLUSH_STEPS : natural := 8;
