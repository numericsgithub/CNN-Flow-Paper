...
END conv1_core1_KPU29;

ARCHITECTURE structural OF conv1_core1_KPU29 IS

    -- All all_additional_output_int_bits are:         [0, 2, 3, 3, 2, 2, 2, 2, 2]
    -- All all_additional_output_int_bits_weights are: [[-53.0], [-41.0], [30.0], [38.0], [5.0], [-2.0], [21.0], [32.0], [-25.0]]
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in3_m12_3_m12_out5_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU29_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_3: entity work.IntMultiAdder_S_in2_m12_5_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU29_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_4: entity work.IntMultiAdder_S_in3_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU29_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_4_input_xi, adder_4_input_sum, small_undelayed_out_3);
	adder_4_output <= small_delayed_in_3;
	adder_5: entity work.IntMultiAdder_S_in0_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU29_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_6: entity work.IntMultiAdder_S_inm2_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU29_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_7: entity work.IntMultiAdder_S_in2_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU29_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_7_input_xi, adder_7_input_sum, small_undelayed_out_5);
	adder_7_output <= small_delayed_in_5;
	adder_8: entity work.IntMultiAdder_S_in3_m12_6_m12_out6_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU29_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    last_stage: entity work.IntMultiAdder_S_in2_m12_6_m12_out6_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core1_KPU29_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
