...
entity FixMultiAdder_S_33_lsbOut_m7_uid42_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_2 : in std_logic_vector(10-1 downto 0); --	sfix(3, -7)
        xi_3 : in std_logic_vector(12-1 downto 0); --	sfix(5, -7)
        xi_4 : in std_logic_vector(8-1 downto 0); --	sfix(1, -7)
        xi_5 : in std_logic_vector(12-1 downto 0); --	sfix(5, -7)
        ...
        xi_12 : in std_logic_vector(14-1 downto 0); --	sfix(7, -7)
        xi_13 : in std_logic_vector(12-1 downto 0); --	sfix(5, -7)
        xi_14 : in std_logic_vector(11-1 downto 0); --	sfix(4, -7)
        ...
        xi_19 : in std_logic_vector(11-1 downto 0); --	sfix(4, -7)
        ...
        xi_24 : in std_logic_vector(11-1 downto 0); --	sfix(4, -7)
        xi_25 : in std_logic_vector(11-1 downto 0); --	sfix(4, -7)
        xi_26 : in std_logic_vector(10-1 downto 0); --	sfix(3, -7)
        xi_27 : in std_logic_vector(11-1 downto 0); --	sfix(4, -7)
        xi_28 : in std_logic_vector(8-1 downto 0); --	sfix(1, -7)
        xi_29 : in std_logic_vector(12-1 downto 0); --	sfix(5, -7)
        xi_30 : in std_logic_vector(12-1 downto 0); --	sfix(5, -7)
        xi_31 : in std_logic_vector(8-1 downto 0); --	sfix(1, -7)
        xi_32 : in std_logic_vector(12-1 downto 0); --	sfix(5, -7)
        xi_33 : in std_logic_vector(17-1 downto 0); --	sfix(10, -7)
        yo : out std_logic_vector(17-1 downto 0) --	sfix(10, -7)
    );
end FixMultiAdder_S_33_lsbOut_m7_uid42_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid42_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m7_uid42_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(17-1 downto 0); --	sfix(10, -7)
    signal xi_1_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(1, -7)
    signal xi_2_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    signal xi_3_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(5, -7)
    signal xi_4_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(1, -7)
    signal xi_5_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(5, -7)
    signal xi_6_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(6, -7)
    ...
    signal xi_12_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(7, -7)
    signal xi_13_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(5, -7)
    signal xi_14_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    ...
    signal xi_19_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    signal xi_20_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(6, -7)
    ...
    signal xi_24_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    signal xi_25_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    signal xi_26_reshaped :  std_logic_vector(10-1 downto 0); --	sfix(3, -7)
    signal xi_27_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    signal xi_28_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(1, -7)
    signal xi_29_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(5, -7)
    ...
    signal xi_32_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(5, -7)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m7_uid42_wrapper
        generic map
        (
