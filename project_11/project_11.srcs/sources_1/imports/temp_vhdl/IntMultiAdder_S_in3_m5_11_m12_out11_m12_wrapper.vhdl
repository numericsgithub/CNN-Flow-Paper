...
entity IntMultiAdder_S_in3_m5_11_m12_out11_m12_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(23-1 downto 0); --	sfix(11, -12)
        xi_2 : in std_logic_vector(23-1 downto 0); --	sfix(11, -12)
        yo  : out std_logic_vector(23-1 downto 0) --	sfix(11, -12)
    );
end IntMultiAdder_S_in3_m5_11_m12_out11_m12_wrapper;

architecture Behavioral of IntMultiAdder_S_in3_m5_11_m12_out11_m12_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in3_m5_11_m12_out11_m12
        port map
        (
            clk, rst, 
            yo_flopoco , 
