...
-- 	sfix(3, -11)
-- 	sfix(10, -11)
-- Output is: sfix(10, -11)

entity FixMultiAdder_S_17_lsbOut_m11_uid242_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_17 : in std_logic_vector(21-1 downto 0); --	sfix(10, -11)
        yo : out std_logic_vector(21-1 downto 0) --	sfix(10, -11)
    );
end FixMultiAdder_S_17_lsbOut_m11_uid242_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m11_uid242_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m11_uid242_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(21-1 downto 0); --	sfix(10, -11)
    ...
    signal xi_17_reshaped :  std_logic_vector(21-1 downto 0); --	sfix(10, -11)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m11_uid242_wrapper
        generic map
        (
