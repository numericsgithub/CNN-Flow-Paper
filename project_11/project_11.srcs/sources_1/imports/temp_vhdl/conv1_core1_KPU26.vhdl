...
END conv1_core1_KPU26;

ARCHITECTURE structural OF conv1_core1_KPU26 IS

    -- All all_additional_output_int_bits are:         [0, 2, 3, 4, 4, 5, 4, 4, 4]
    -- All all_additional_output_int_bits_weights are: [[-2.0], [-2.0], [2.0], [2.0], [8.0], [4.0], [-1.0], [-4.0], [-4.0]]
    ...
    -- Unreshaped Adder would be: sfix(-2, -12) + sfix(-2, -12) = sfix(0, -12)
    -- Reshaped Adder would be:   sfix(-2, -12) + sfix(-2, -12) = sfix(0, -12)
    -- 
    ...
    -- Unreshaped Adder would be: sfix(-1, -12) + sfix(0, -12) = sfix(1, -12)
    ...
    -- Unreshaped Adder would be: sfix(-3, -12) + sfix(3, -12) = sfix(3, -12)
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_inm2_m12_m2_m12_out0_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU26_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_2_input_xi, adder_2_input_sum, small_undelayed_out_2);
	adder_2_output <= small_delayed_in_2;

    line_adder_3: entity work.IntMultiAdder_S_inm1_m12_0_m12_out1_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU26_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_3_input_xi, adder_3_input_sum, big_undelayed_out_1);
	adder_3_output <= big_delayed_in_1;
	adder_4: entity work.IntMultiAdder_S_inm1_m12_1_m12_out2_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU26_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_4_input_xi, adder_4_input_sum, small_undelayed_out_3);
	adder_4_output <= small_delayed_in_3;
	adder_5: entity work.IntMultiAdder_S_in1_m12_2_m12_out2_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU26_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_5_input_xi, adder_5_input_sum, small_undelayed_out_4);
	adder_5_output <= small_delayed_in_4;

    line_adder_6: entity work.IntMultiAdder_S_in0_m12_2_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU26_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_6_input_xi, adder_6_input_sum, big_undelayed_out_2);
	adder_6_output <= big_delayed_in_2;
	adder_7: entity work.IntMultiAdder_S_inm3_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU26_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_7_input_xi, adder_7_input_sum, small_undelayed_out_5);
	adder_7_output <= small_delayed_in_5;
	adder_8: entity work.IntMultiAdder_S_inm1_m12_3_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core1_KPU26_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_8_input_xi, adder_8_input_sum, small_undelayed_out_6);
	adder_8_output <= small_delayed_in_6;

    last_stage: entity work.IntMultiAdder_S_inm1_m12_3_m12_out3_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core1_KPU26_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
