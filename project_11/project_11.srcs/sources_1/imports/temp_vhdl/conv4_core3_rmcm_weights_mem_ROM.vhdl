...
entity conv4_core3_rmcm_weightsconstant_memoryROM is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv4_core3_rmcm_weightsconstant_memoryROM;

architecture Behavioral of conv4_core3_rmcm_weightsconstant_memoryROM is
	...
	constant data_ROM : ROM_TYPE := (
	    ...
	    0 => w(1,1,0,1,1,1,0,1,0),
	    1 => w(1,1,0,0,0,0,0,0,0),
	    2 => w(-22,-32,-17,-2,-21,-1,-20,-18,-27),
	    3 => w(0,1,0,0,0,0,0,0,0)
        );
