...
END conv1_core2_KPU30;

ARCHITECTURE structural OF conv1_core2_KPU30 IS

    -- All all_additional_output_int_bits are:         [0, 2, 4, 5, 6, 6, 6, 5, 5]
    -- All all_additional_output_int_bits_weights are: [[-2.0], [3.0], [-5.0], [7.0], [8.0], [2.0], [9.0], [15.0], [12.0]]
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_inm1_m12_m2_m12_out0_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU30_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_2_input_xi, adder_2_input_sum, small_undelayed_out_2);
	adder_2_output <= small_delayed_in_2;

    line_adder_3: entity work.IntMultiAdder_S_in0_m12_0_m12_out2_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU30_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_4: entity work.IntMultiAdder_S_in0_m12_2_m12_out3_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU30_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_5: entity work.IntMultiAdder_S_in1_m12_3_m12_out4_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU30_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    line_adder_6: entity work.IntMultiAdder_S_inm1_m12_4_m12_out4_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU30_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_7: entity work.IntMultiAdder_S_in1_m12_4_m12_out4_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU30_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_in1_m12_4_m12_out4_m12_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv1_core2_KPU30_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    last_stage: entity work.IntMultiAdder_S_in1_m12_4_m12_out4_m12_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv1_core2_KPU30_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
