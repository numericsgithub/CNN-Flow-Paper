...
entity IntMultiAdder_S_in6_m4_6_m4_out6_m4_wrapper is
    generic
    (
    ...
    Port (
        ...
        yo  : out std_logic_vector(10-1 downto 0) --	sfix(6, -4)
    );
end IntMultiAdder_S_in6_m4_6_m4_out6_m4_wrapper;

architecture Behavioral of IntMultiAdder_S_in6_m4_6_m4_out6_m4_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in6_m4_6_m4_out6_m4
        port map
        (
            clk, rst, 
            yo_flopoco , 
