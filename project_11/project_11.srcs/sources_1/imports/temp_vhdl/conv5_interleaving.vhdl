...
end conv5_interleaving;

architecture Behavioral of conv5_interleaving is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of conv5_interleaving : entity is "yes";
    ...
    signal data_aggregator_output          : conv5_interleaving_Data_Aggregator_output;
...
begin
    ...
    Data_Aggregator_for_FIFO: entity work.conv5_interleaving_Data_Aggregator
        ...
        (
            ...
            input_8 => layer_xi_8,
            input_9 => layer_xi_9,
            input_10 => layer_xi_10,
            input_11 => layer_xi_11,
            input_12 => layer_xi_12,
            input_13 => layer_xi_13,
            input_14 => layer_xi_14,
            input_15 => layer_xi_15,
            input_16 => layer_xi_16,
    ...
    begin
        if rising_edge(clk) then
            if fifo_data_counter >= FIFO_SIZE then
                assert false
                report "Interleaving layer conv5_interleaving: FIFO Overflow!"
                severity warning;
            end if;
        end if;
    end process;
