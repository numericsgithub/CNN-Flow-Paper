...
entity IntMultiAdder_S_in4_m4_10_m10_out10_m10_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(20-1 downto 0); --	sfix(10, -10)
        xi_2 : in std_logic_vector(20-1 downto 0); --	sfix(10, -10)
        yo  : out std_logic_vector(20-1 downto 0) --	sfix(10, -10)
    );
end IntMultiAdder_S_in4_m4_10_m10_out10_m10_wrapper;

architecture Behavioral of IntMultiAdder_S_in4_m4_10_m10_out10_m10_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in4_m4_10_m10_out10_m10
        port map
        (
            clk, rst, 
            yo_flopoco , 
