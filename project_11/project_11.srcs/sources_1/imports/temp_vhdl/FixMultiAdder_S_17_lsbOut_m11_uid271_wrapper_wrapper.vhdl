...
entity FixMultiAdder_S_17_lsbOut_m11_uid271_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        rst    : in std_logic;
        enable : in std_logic;
        xi_1 : in std_logic_vector(15-1 downto 0); --	sfix(4, -11)
        xi_2 : in std_logic_vector(15-1 downto 0); --	sfix(4, -11)
        ...
        xi_11 : in std_logic_vector(15-1 downto 0); --	sfix(4, -11)
        ...
        xi_16 : in std_logic_vector(15-1 downto 0); --	sfix(4, -11)
        xi_17 : in std_logic_vector(20-1 downto 0); --	sfix(9, -11)
        yo : out std_logic_vector(20-1 downto 0) --	sfix(9, -11)
    );
end FixMultiAdder_S_17_lsbOut_m11_uid271_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m11_uid271_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m11_uid271_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(20-1 downto 0); --	sfix(9, -11)
    signal xi_1_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(4, -11)
    signal xi_2_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(4, -11)
    ...
    signal xi_10_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_11_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(4, -11)
    ...
    signal xi_15_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_16_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(4, -11)
    signal xi_17_reshaped :  std_logic_vector(20-1 downto 0); --	sfix(9, -11)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m11_uid271_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(4, -11)
            xi_2_reshaped, --	sfix(4, -11)
            ...
            xi_10_reshaped, --	sfix(3, -11)
            xi_11_reshaped, --	sfix(4, -11)
            xi_12_reshaped, --	sfix(3, -11)
            xi_13_reshaped, --	sfix(3, -11)
            xi_14_reshaped, --	sfix(3, -11)
            xi_15_reshaped, --	sfix(3, -11)
            xi_16_reshaped, --	sfix(4, -11)
            xi_17_reshaped, --	sfix(9, -11)
            yo_signal
        );
