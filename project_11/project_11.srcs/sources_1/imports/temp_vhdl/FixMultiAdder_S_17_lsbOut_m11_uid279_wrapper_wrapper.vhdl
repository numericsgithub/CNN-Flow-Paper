...
entity FixMultiAdder_S_17_lsbOut_m11_uid279_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_7 : in std_logic_vector(15-1 downto 0); --	sfix(4, -11)
...
end FixMultiAdder_S_17_lsbOut_m11_uid279_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m11_uid279_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m11_uid279_wrapper_wrapper : entity is "yes";
    ...
    signal xi_5_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(4, -11)
    signal xi_6_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(3, -11)
    signal xi_7_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(4, -11)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m11_uid279_wrapper
        generic map
        (
        ...
        (
            ...
            xi_5_reshaped, --	sfix(4, -11)
            xi_6_reshaped, --	sfix(3, -11)
            xi_7_reshaped, --	sfix(4, -11)
