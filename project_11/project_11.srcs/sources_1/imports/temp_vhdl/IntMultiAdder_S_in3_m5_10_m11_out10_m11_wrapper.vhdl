...
entity IntMultiAdder_S_in3_m5_10_m11_out10_m11_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(21-1 downto 0); --	sfix(10, -11)
        xi_2 : in std_logic_vector(21-1 downto 0); --	sfix(10, -11)
        yo  : out std_logic_vector(21-1 downto 0) --	sfix(10, -11)
    );
end IntMultiAdder_S_in3_m5_10_m11_out10_m11_wrapper;

architecture Behavioral of IntMultiAdder_S_in3_m5_10_m11_out10_m11_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in3_m5_10_m11_out10_m11
        port map
        (
            clk, rst, 
            yo_flopoco , 
