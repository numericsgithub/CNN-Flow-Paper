...
end conv6_interleaving;

architecture Behavioral of conv6_interleaving is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of conv6_interleaving : entity is "yes";
    ...
    begin
        if rising_edge(clk) then
            if fifo_data_counter >= FIFO_SIZE then
                assert false
                report "Interleaving layer conv6_interleaving: FIFO Overflow!"
                severity warning;
            end if;
        end if;
    end process;
