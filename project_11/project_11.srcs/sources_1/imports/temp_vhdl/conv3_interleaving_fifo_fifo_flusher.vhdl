...
entity conv3_interleaving_fifo_fifo_flusher is
    Port (
        clk    : in std_logic;
        rst    : in std_logic;
        enable : in std_logic;
...
end conv3_interleaving_fifo_fifo_flusher;

architecture Behavioral of conv3_interleaving_fifo_fifo_flusher is
...
begin
    ...
    fifo_input_signal    <= data_in_1 & data_in_2 & data_in_3 & data_in_4 & data_in_5 & data_in_6 & data_in_7 & data_in_8 & data_in_9 & data_in_10 & data_in_11 & data_in_12 & data_in_13 & data_in_14 & data_in_15 & data_in_16 & data_in_17 & data_in_18 & data_in_19 & data_in_20 & data_in_21 & data_in_22 & data_in_23 & data_in_24 & data_in_25 & data_in_26 & data_in_27 & data_in_28 & data_in_29 & data_in_30 & data_in_31 & data_in_32 ;

    data_out_1 <= fifo_output_signal((XI_WIDTH*32)-1 downto (XI_WIDTH*31));
    data_out_2 <= fifo_output_signal((XI_WIDTH*31)-1 downto (XI_WIDTH*30));
    data_out_3 <= fifo_output_signal((XI_WIDTH*30)-1 downto (XI_WIDTH*29));
    data_out_4 <= fifo_output_signal((XI_WIDTH*29)-1 downto (XI_WIDTH*28));
    data_out_5 <= fifo_output_signal((XI_WIDTH*28)-1 downto (XI_WIDTH*27));
    data_out_6 <= fifo_output_signal((XI_WIDTH*27)-1 downto (XI_WIDTH*26));
    data_out_7 <= fifo_output_signal((XI_WIDTH*26)-1 downto (XI_WIDTH*25));
    data_out_8 <= fifo_output_signal((XI_WIDTH*25)-1 downto (XI_WIDTH*24));
    data_out_9 <= fifo_output_signal((XI_WIDTH*24)-1 downto (XI_WIDTH*23));
    data_out_10 <= fifo_output_signal((XI_WIDTH*23)-1 downto (XI_WIDTH*22));
    data_out_11 <= fifo_output_signal((XI_WIDTH*22)-1 downto (XI_WIDTH*21));
    data_out_12 <= fifo_output_signal((XI_WIDTH*21)-1 downto (XI_WIDTH*20));
    data_out_13 <= fifo_output_signal((XI_WIDTH*20)-1 downto (XI_WIDTH*19));
    data_out_14 <= fifo_output_signal((XI_WIDTH*19)-1 downto (XI_WIDTH*18));
    data_out_15 <= fifo_output_signal((XI_WIDTH*18)-1 downto (XI_WIDTH*17));
    data_out_16 <= fifo_output_signal((XI_WIDTH*17)-1 downto (XI_WIDTH*16));
    data_out_17 <= fifo_output_signal((XI_WIDTH*16)-1 downto (XI_WIDTH*15));
    data_out_18 <= fifo_output_signal((XI_WIDTH*15)-1 downto (XI_WIDTH*14));
    data_out_19 <= fifo_output_signal((XI_WIDTH*14)-1 downto (XI_WIDTH*13));
    data_out_20 <= fifo_output_signal((XI_WIDTH*13)-1 downto (XI_WIDTH*12));
    data_out_21 <= fifo_output_signal((XI_WIDTH*12)-1 downto (XI_WIDTH*11));
    data_out_22 <= fifo_output_signal((XI_WIDTH*11)-1 downto (XI_WIDTH*10));
    data_out_23 <= fifo_output_signal((XI_WIDTH*10)-1 downto (XI_WIDTH*9));
    data_out_24 <= fifo_output_signal((XI_WIDTH*9)-1 downto (XI_WIDTH*8));
    data_out_25 <= fifo_output_signal((XI_WIDTH*8)-1 downto (XI_WIDTH*7));
    data_out_26 <= fifo_output_signal((XI_WIDTH*7)-1 downto (XI_WIDTH*6));
    data_out_27 <= fifo_output_signal((XI_WIDTH*6)-1 downto (XI_WIDTH*5));
    data_out_28 <= fifo_output_signal((XI_WIDTH*5)-1 downto (XI_WIDTH*4));
    data_out_29 <= fifo_output_signal((XI_WIDTH*4)-1 downto (XI_WIDTH*3));
    data_out_30 <= fifo_output_signal((XI_WIDTH*3)-1 downto (XI_WIDTH*2));
    data_out_31 <= fifo_output_signal((XI_WIDTH*2)-1 downto (XI_WIDTH*1));
    data_out_32 <= fifo_output_signal((XI_WIDTH*1)-1 downto (XI_WIDTH*0));
