...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=950 name=entity_place_holder_name IntMultiAdder signedIn=True n=2 wIn=15 wOut=17

entity IntMultiAdder_S_in10_m4_11_m4_out13_m4_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(15-1 downto 0); --	sfix(11, -4)
        xi_2 : in std_logic_vector(15-1 downto 0); --	sfix(11, -4)
        yo  : out std_logic_vector(17-1 downto 0) --	sfix(13, -4)
    );
end IntMultiAdder_S_in10_m4_11_m4_out13_m4_wrapper;

architecture Behavioral of IntMultiAdder_S_in10_m4_11_m4_out13_m4_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in10_m4_11_m4_out13_m4
        port map
        (
            clk, rst, 
            yo_flopoco , 
