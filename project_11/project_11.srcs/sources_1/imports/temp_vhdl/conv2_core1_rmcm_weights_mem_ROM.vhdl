...
entity conv2_core1_rmcm_weightsconstant_memoryROM is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv2_core1_rmcm_weightsconstant_memoryROM;

architecture Behavioral of conv2_core1_rmcm_weightsconstant_memoryROM is
	...
	constant data_ROM : ROM_TYPE := (
	    ...
	    0 => w(-2,-2,-3,-1,-1,-2,-2,-1,-2),
	    1 => w(4,5,5,6,4,6,1,3,4),
	    2 => w(0,0,0,0,1,0,0,1,0),
	    3 => w(-36,-35,-28,18,37,-2,45,39,-15)
        );
