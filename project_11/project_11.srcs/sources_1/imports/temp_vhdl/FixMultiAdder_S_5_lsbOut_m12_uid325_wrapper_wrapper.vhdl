...
entity FixMultiAdder_S_5_lsbOut_m12_uid325_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(20-1 downto 0); --	sfix(8, -12)
        yo : out std_logic_vector(20-1 downto 0) --	sfix(8, -12)
    );
end FixMultiAdder_S_5_lsbOut_m12_uid325_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m12_uid325_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_5_lsbOut_m12_uid325_wrapper_wrapper : entity is "yes";
    ...
    signal xi_5_reshaped :  std_logic_vector(20-1 downto 0); --	sfix(8, -12)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_5_lsbOut_m12_uid325_wrapper
        generic map
        (
