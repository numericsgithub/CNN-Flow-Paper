...
entity FixMultiAdder_S_5_lsbOut_m9_uid1259_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(24-1 downto 0); --	sfix(15, -9)
        yo : out std_logic_vector(24-1 downto 0) --	sfix(15, -9)
    );
end FixMultiAdder_S_5_lsbOut_m9_uid1259_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m9_uid1259_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_5_lsbOut_m9_uid1259_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(24-1 downto 0); --	sfix(15, -9)
    signal xi_1_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(6, -9)
    signal xi_2_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(5, -9)
    signal xi_3_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(6, -9)
    signal xi_4_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(5, -9)
    signal xi_5_reshaped :  std_logic_vector(24-1 downto 0); --	sfix(15, -9)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_5_lsbOut_m9_uid1259_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(6, -9)
            xi_2_reshaped, --	sfix(5, -9)
            xi_3_reshaped, --	sfix(6, -9)
            xi_4_reshaped, --	sfix(5, -9)
            xi_5_reshaped, --	sfix(15, -9)
            yo_signal
        );
