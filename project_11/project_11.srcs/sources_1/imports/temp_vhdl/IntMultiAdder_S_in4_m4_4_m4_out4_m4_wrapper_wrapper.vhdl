...
entity IntMultiAdder_S_in4_m4_4_m4_out4_m4_wrapper_wrapper is
    generic
    (
...
end IntMultiAdder_S_in4_m4_4_m4_out4_m4_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in4_m4_4_m4_out4_m4_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in4_m4_4_m4_out4_m4_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(8-1 downto 0); --	sfix(4, -4)
    signal xi_1_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(4, -4)
    signal xi_2_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(4, -4)
    ...
    subtype DEBUG_TYPE is std_logic_vector(10 downto 0);
    constant allowed_min : integer := -128;
    constant allowed_max : integer := 127;
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in4_m4_4_m4_out4_m4_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(4, -4)
            xi_2_reshaped, --	sfix(4, -4)
            yo_signal
        );
