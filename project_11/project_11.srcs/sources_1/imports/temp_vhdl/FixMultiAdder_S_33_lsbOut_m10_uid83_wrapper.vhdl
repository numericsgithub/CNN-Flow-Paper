...
-- Flopoco wrapper for: ./flopoco writeEnable=1 ilpTimeout=300 compression=optimal_minStages tiling=optimalTilingAndCompression allRegistersWithAsyncReset=1 target=VirtexUltrascalePlus useTargetOpt=1 frequency=750 name=entity_place_holder_name FixMultiAdder signedIn=1 n=33 msbIn=2:2:2:1:4:1:2:2:3:2:2:2:1:2:2:4:4:2:3:3:1:0:3:3:1:1:2:3:1:2:0:1:7 lsbIn=-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10:-10 lsbOut=-10

entity FixMultiAdder_S_33_lsbOut_m10_uid83_wrapper is
    generic
    (
...
end FixMultiAdder_S_33_lsbOut_m10_uid83_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m10_uid83_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_4_PL              is array(0 to 1) of std_logic_vector(12-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_XI_17_PL             is array(0 to 1) of std_logic_vector(15-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_XI_21_PL             is array(0 to 1) of std_logic_vector(12-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_XI_24_PL             is array(0 to 1) of std_logic_vector(14-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_XI_28_PL             is array(0 to 1) of std_logic_vector(14-1 downto 0);
    ...
    type PIPELINE_TYPE_FOR_XI_31_PL             is array(0 to 1) of std_logic_vector(11-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_33_lsbOut_m10_uid83
        port map
        (
