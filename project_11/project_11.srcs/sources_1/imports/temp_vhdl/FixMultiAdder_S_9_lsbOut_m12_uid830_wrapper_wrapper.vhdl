...
-- 	sfix(2, -12)
-- 	sfix(11, -12)
-- Output is: sfix(11, -12)

entity FixMultiAdder_S_9_lsbOut_m12_uid830_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_9 : in std_logic_vector(23-1 downto 0); --	sfix(11, -12)
        yo : out std_logic_vector(23-1 downto 0) --	sfix(11, -12)
    );
end FixMultiAdder_S_9_lsbOut_m12_uid830_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_9_lsbOut_m12_uid830_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_9_lsbOut_m12_uid830_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(23-1 downto 0); --	sfix(11, -12)
    ...
    signal xi_3_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(3, -12)
    signal xi_4_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(2, -12)
    signal xi_5_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(3, -12)
    signal xi_6_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(2, -12)
    signal xi_7_reshaped :  std_logic_vector(15-1 downto 0); --	sfix(3, -12)
    signal xi_8_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(2, -12)
    signal xi_9_reshaped :  std_logic_vector(23-1 downto 0); --	sfix(11, -12)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_9_lsbOut_m12_uid830_wrapper
        generic map
        (
        ...
        (
            ...
            xi_3_reshaped, --	sfix(3, -12)
            xi_4_reshaped, --	sfix(2, -12)
            xi_5_reshaped, --	sfix(3, -12)
            xi_6_reshaped, --	sfix(2, -12)
            xi_7_reshaped, --	sfix(3, -12)
            xi_8_reshaped, --	sfix(2, -12)
            xi_9_reshaped, --	sfix(11, -12)
            yo_signal
        );
