...
entity IntMultiAdder_S_in10_m4_10_m4_out12_m4_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_2 : in std_logic_vector(14-1 downto 0); --	sfix(10, -4)
        yo : out std_logic_vector(16-1 downto 0) --	sfix(12, -4)
    );
end IntMultiAdder_S_in10_m4_10_m4_out12_m4_wrapper_wrapper;

architecture Behavioral of IntMultiAdder_S_in10_m4_10_m4_out12_m4_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of IntMultiAdder_S_in10_m4_10_m4_out12_m4_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(16-1 downto 0); --	sfix(12, -4)
    signal xi_1_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(10, -4)
    signal xi_2_reshaped :  std_logic_vector(14-1 downto 0); --	sfix(10, -4)
...
begin
    ...
    adder : entity work.IntMultiAdder_S_in10_m4_10_m4_out12_m4_wrapper
        generic map
        (
        ...
        (
            clk, rst, enable,
            xi_1_reshaped, --	sfix(10, -4)
            xi_2_reshaped, --	sfix(10, -4)
            yo_signal
        );
