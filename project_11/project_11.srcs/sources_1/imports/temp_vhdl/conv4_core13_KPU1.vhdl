...
ENTITY conv4_core13_KPU1 IS
	...
	PORT (
        ...
        kpu_xi_4 : in std_logic_vector(14-1 downto 0); --	sfix(10, -4)
        kpu_xi_5 : in std_logic_vector(13-1 downto 0); --	sfix(9, -4)
        kpu_xi_6 : in std_logic_vector(15-1 downto 0); --	sfix(11, -4)
...
END conv4_core13_KPU1;

ARCHITECTURE structural OF conv4_core13_KPU1 IS

    -- All all_additional_output_int_bits are:         [0, 2, 2, 3, 3, 4, 4, 4, 3]
    -- All all_additional_output_int_bits_weights are: [[0.0, -1.0, 39.0, -46.0], [1.0, -1.0, 4.0, -4.0], [0.0, 0.0, 36.0, 15.0], [1.0, -1.0, 21.0, 46.0], [1.0, -1.0, -6.0, 31.0], [1.0, -1.0, 101.0, 59.0], [0.0, -1.0, 4.0, 34.0], [1.0, -1.0, -25.0, 63.0], [0.0, 0.0, 22.0, -1.0]]
    ...
    signal adder_4_input_xi  : std_logic_vector(14-1 downto 0); --	sfix(10, -4)
    signal adder_5_input_xi  : std_logic_vector(13-1 downto 0); --	sfix(9, -4)
    signal adder_6_input_xi  : std_logic_vector(15-1 downto 0); --	sfix(11, -4)
    ...
    -- Unreshaped Adder would be: sfix(7, -4) + sfix(10, -4) = sfix(12, -4)
    ...
    -- Unreshaped Adder would be: sfix(10, -4) + sfix(12, -4) = sfix(12, -4)
...
BEGIN
	...
	adder_2: entity work.IntMultiAdder_S_in7_m4_10_m4_out12_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv4_core13_KPU1_adder2", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_2_input_xi, adder_2_input_sum, small_undelayed_out_2);
	adder_2_output <= small_delayed_in_2;

    line_adder_3: entity work.IntMultiAdder_S_in10_m4_12_m4_out12_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv4_core13_KPU1_adder3", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_3_input_xi, adder_3_input_sum, big_undelayed_out_1);
	adder_3_output <= big_delayed_in_1;
	adder_4: entity work.IntMultiAdder_S_in10_m4_12_m4_out13_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv4_core13_KPU1_adder4", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_5: entity work.IntMultiAdder_S_in9_m4_13_m4_out13_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv4_core13_KPU1_adder5", PIPELINE_STEPS => PIPELINE_STEPS) 
        PORT MAP(clk, '0', x_is_valid, adder_5_input_xi, adder_5_input_sum, small_undelayed_out_4);
	adder_5_output <= small_delayed_in_4;

    line_adder_6: entity work.IntMultiAdder_S_in11_m4_13_m4_out14_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv4_core13_KPU1_adder6", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_7: entity work.IntMultiAdder_S_in10_m4_14_m4_out14_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv4_core13_KPU1_adder7", PIPELINE_STEPS => PIPELINE_STEPS) 
	...
	adder_8: entity work.IntMultiAdder_S_in10_m4_14_m4_out14_m4_wrapper_wrapper 
        generic map(ADDER_LOCATION => "conv4_core13_KPU1_adder8", PIPELINE_STEPS => PIPELINE_STEPS) 
    ...
    last_stage: entity work.IntMultiAdder_S_in9_m4_14_m4_out14_m4_wrapper_wrapper
        generic map(ADDER_LOCATION => "conv4_core13_KPU1_adder9", PIPELINE_STEPS => PIPELINE_STEPS) 
