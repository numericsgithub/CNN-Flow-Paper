...
entity FixMultiAdder_S_4_lsbOut_m12_uid1_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_4 : in std_logic_vector(17-1 downto 0); --	sfix(5, -12)
        yo : out std_logic_vector(17-1 downto 0) --	sfix(5, -12)
    );
end FixMultiAdder_S_4_lsbOut_m12_uid1_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_4_lsbOut_m12_uid1_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_4_lsbOut_m12_uid1_wrapper_wrapper : entity is "yes";
    ...
    signal xi_4_reshaped :  std_logic_vector(17-1 downto 0); --	sfix(5, -12)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_4_lsbOut_m12_uid1_wrapper
        generic map
        (
