...
entity FixMultiAdder_S_5_lsbOut_m9_uid1267_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(22-1 downto 0); --	sfix(13, -9)
        yo : out std_logic_vector(22-1 downto 0) --	sfix(13, -9)
    );
end FixMultiAdder_S_5_lsbOut_m9_uid1267_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m9_uid1267_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_5_lsbOut_m9_uid1267_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(22-1 downto 0); --	sfix(13, -9)
    ...
    signal xi_5_reshaped :  std_logic_vector(22-1 downto 0); --	sfix(13, -9)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_5_lsbOut_m9_uid1267_wrapper
        generic map
        (
