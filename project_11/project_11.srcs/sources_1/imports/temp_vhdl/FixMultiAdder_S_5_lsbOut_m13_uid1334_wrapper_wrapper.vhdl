...
-- 	sfix(3, -13)
-- 	sfix(16, -13)
-- Output is: sfix(16, -13)

entity FixMultiAdder_S_5_lsbOut_m13_uid1334_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        xi_5 : in std_logic_vector(29-1 downto 0); --	sfix(16, -13)
        yo : out std_logic_vector(29-1 downto 0) --	sfix(16, -13)
    );
end FixMultiAdder_S_5_lsbOut_m13_uid1334_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_5_lsbOut_m13_uid1334_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_5_lsbOut_m13_uid1334_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(29-1 downto 0); --	sfix(16, -13)
    ...
    signal xi_5_reshaped :  std_logic_vector(29-1 downto 0); --	sfix(16, -13)
    ...
    subtype DEBUG_TYPE is std_logic_vector(33 downto 0);
    constant allowed_min : integer := -268435456;
    constant allowed_max : integer := 268435455;
...
begin
    ...
    adder : entity work.FixMultiAdder_S_5_lsbOut_m13_uid1334_wrapper
        generic map
        (
