...
entity IntMultiAdder_S_in5_m9_9_m9_out9_m9_wrapper is
    generic
    (
    ...
    Port (
        ...
        xi_1 : in std_logic_vector(18-1 downto 0); --	sfix(9, -9)
        xi_2 : in std_logic_vector(18-1 downto 0); --	sfix(9, -9)
        yo  : out std_logic_vector(18-1 downto 0) --	sfix(9, -9)
    );
end IntMultiAdder_S_in5_m9_9_m9_out9_m9_wrapper;

architecture Behavioral of IntMultiAdder_S_in5_m9_9_m9_out9_m9_wrapper is
...
begin
    ...
    FLOPOCO_ENTITY: entity work.IntMultiAdder_S_in5_m9_9_m9_out9_m9
        port map
        (
            clk, rst, 
            yo_flopoco , 
