...
entity conv2_core5_rmcm_weightsconstant_memoryROM is
    generic
    (
        XI_WIDTH        	          : natural := 8;
...
end conv2_core5_rmcm_weightsconstant_memoryROM;

architecture Behavioral of conv2_core5_rmcm_weightsconstant_memoryROM is
	...
	constant data_ROM : ROM_TYPE := (
	    ...
	    0 => w(-3,1,0,3,-1,0,0,0,0),
	    1 => w(0,0,0,0,-1,0,0,0,0),
	    2 => w(-15,-46,-64,-16,-11,-25,32,2,5),
	    3 => w(0,0,0,-1,2,0,0,0,0)
        );
