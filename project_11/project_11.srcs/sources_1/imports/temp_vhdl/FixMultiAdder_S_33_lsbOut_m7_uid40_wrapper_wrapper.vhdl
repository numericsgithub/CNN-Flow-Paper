...
entity FixMultiAdder_S_33_lsbOut_m7_uid40_wrapper_wrapper is
    generic
    (
...
end FixMultiAdder_S_33_lsbOut_m7_uid40_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid40_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_33_lsbOut_m7_uid40_wrapper_wrapper : entity is "yes";
    ...
    signal xi_18_reshaped :  std_logic_vector(11-1 downto 0); --	sfix(4, -7)
    signal xi_19_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(6, -7)
    ...
    signal xi_22_reshaped :  std_logic_vector(13-1 downto 0); --	sfix(6, -7)
    signal xi_23_reshaped :  std_logic_vector(8-1 downto 0); --	sfix(1, -7)
    signal xi_24_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(5, -7)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_33_lsbOut_m7_uid40_wrapper
        generic map
        (
        ...
        (
            ...
            xi_18_reshaped, --	sfix(4, -7)
            xi_19_reshaped, --	sfix(6, -7)
            xi_20_reshaped, --	sfix(6, -7)
            xi_21_reshaped, --	sfix(1, -7)
            xi_22_reshaped, --	sfix(6, -7)
            xi_23_reshaped, --	sfix(1, -7)
            xi_24_reshaped, --	sfix(5, -7)
