...
entity FixMultiAdder_S_17_lsbOut_m11_uid252_wrapper_wrapper is
    generic
    (
    ...
    (
        ...
        rst    : in std_logic;
        enable : in std_logic;
        xi_1 : in std_logic_vector(12-1 downto 0); --	sfix(1, -11)
...
end FixMultiAdder_S_17_lsbOut_m11_uid252_wrapper_wrapper;

architecture Behavioral of FixMultiAdder_S_17_lsbOut_m11_uid252_wrapper_wrapper is


    attribute KEEP_HIERARCHY : string;
    attribute KEEP_HIERARCHY of FixMultiAdder_S_17_lsbOut_m11_uid252_wrapper_wrapper : entity is "yes";

    signal yo_signal : std_logic_vector(18-1 downto 0); --	sfix(7, -11)
    signal xi_1_reshaped :  std_logic_vector(12-1 downto 0); --	sfix(1, -11)
...
begin
    ...
    adder : entity work.FixMultiAdder_S_17_lsbOut_m11_uid252_wrapper
        generic map
        (
