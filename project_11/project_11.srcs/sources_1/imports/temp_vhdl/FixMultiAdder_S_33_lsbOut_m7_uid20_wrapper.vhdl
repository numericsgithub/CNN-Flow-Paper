...
end FixMultiAdder_S_33_lsbOut_m7_uid20_wrapper;

architecture Behavioral of FixMultiAdder_S_33_lsbOut_m7_uid20_wrapper is
    ...
    type PIPELINE_TYPE_FOR_XI_33_PL             is array(0 to 1) of std_logic_vector(19-1 downto 0);
    type PIPELINE_TYPE_FOR_YO_PL                is array(0 to 1) of std_logic_vector(19-1 downto 0);
...
begin
    ...
    FLOPOCO_ENTITY: entity work.FixMultiAdder_S_33_lsbOut_m7_uid20
        port map
        (
